...
- `/substacks [window]` — sweep ~33 tracked newsletter/Substack sources for new posts (default 48h); delegates per-post ingestion to `/ingest`. See `.claude/skills/substacks/SKILL.md`.
