...
- `[[wikilinks]]` preserved in body — explainers are printable per AGENTS.md printing rule.
...
- **Dropping wikilinks.** `[[NVIDIA]]` stays as `[[NVIDIA]]` in the output. AGENTS.md printing rule applies.
