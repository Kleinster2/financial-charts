---
aliases: [Iran war market impact 2026, Operation Epic Fury market impact]
tags: [event, geopolitics, defense, oil, markets, iran]
---

# 2026 Iran conflict market impact

Market reaction to [[Operation Epic Fury|2026 Iran conflict]] — joint US-Israeli strikes on [[Iran]] starting February 28, 2026 that killed Supreme Leader [[Ali Khamenei]], triggered Iranian retaliation across the [[Persian Gulf]], and allegedly closed the [[Strait of Hormuz]]. This note is the hub; deep dives are linked below.
...
## Macro snapshot (March 2, 2026 — Day 3)

| Asset | Move | Level | Notes |
|-------|------|-------|-------|
| WTI crude | +7.3% | ~$72/bbl | Was $65 pre-strike |
| Brent crude | +8% | ~$79/bbl | Barclays sees $100 if prolonged |
| Gold | — | $5,400/oz | +23% past month; safe-haven bid |
| S&P 500 (SPY) | +0.06% | $686.38 | Massive intraday comeback from lows |
| BTC | — | ~$66,000 | Held better than equities; $300M long liquidations Sat |
| 10Y yield | +7.6bp | 4.038% | Energy-driven inflation repricing |

Oil initially spiked 13% in early trading before pulling back to +7-9%. European gas prices surged +23%. Key variable: duration of [[Strait of Hormuz]] closure (~20M+ bbl/day of oil, >20% of global supply).

---

## Pre-strike scenario scorecard

The [[US-Iran nuclear escalation February 2026|Feb 18 scenario analysis]] predicted:

| Scenario | Feb 18 call | Outcome |
|----------|-------------|---------|
| Oil spike $80-100+ if Hormuz disrupted | ✅ | Brent at $79, Barclays targeting $100 |
| Gold break $5,000 | ✅ | $5,400 |
| Defense upside, especially munitions | ✅ | Primes +2-6%, drones mixed |
| Airlines negative | ✅ | DAL -2.2%, AAL -4.2% |
| Shipping disruption | ✅ | 150 ships stalled at Hormuz |

---

## Deep dives

| Theme | Note | Key takeaway |
|-------|------|-------------|
...
## Travel — sell-off (March 2 verified closes)

| Company | Move | Notes |
|---------|------|-------|
| [[Delta Air Lines]] (DAL) | **-2.2%** | Fuel cost + route disruption |
| [[United Airlines]] (UAL) | **-2.9%** | |
...
- Gold $5,400 — confirmed breakout above $5,000 called in Feb 18 note. +23% past month.
- BTC ~$66K — held better than equities but didn't act as pure safe haven.
- US Treasuries — flight-to-quality bid expected but yields rose on inflation repricing from energy shock.
...
Key variable is duration. A resolved conflict (days) = mean-reversion in oil/defense. A prolonged campaign (weeks, as Trump warned 4+) = sustained repricing across all of these.
...
## Day 19 — March 17 (CFR geoeconomic panel — structural framing)

### CFR panel: "The Geoeconomic Ripple Effects of the Iran War"

[[Council on Foreign Relations|CFR]] convened a 72-minute expert panel (March 17, 2026) that produced the most comprehensive structural framing of the crisis to date. Panelists: [[Megan O'Sullivan]] ([[Belfer Center]]/[[Harvard]], former Deputy NSA), [[Ed Morse]] ([[Hartree Partners]], commodity strategist), [[Brad Setser]] ([[Council on Foreign Relations|CFR]], former Treasury), [[Karen Young]] ([[Columbia Center on Global Energy Policy|Columbia CGEP]], Gulf political economy). Moderated by [[Eddie Fishman]] (CFR Greenberg Center director).

**Key analytical contributions:**

**1. Iran went existential — and Washington didn't see it coming.** O'Sullivan's core argument: the Trump administration's calculation was based on two prior precedents (Soleimani assassination, nuclear strikes) where Iran didn't escalate. But once the operation killed both the supreme leader *and* military leadership, it became an existential war. Iran reached for its ultimate leverage — [[Strait of Hormuz]] closure — in a way Washington apparently didn't anticipate. The overconfidence was the miscalculation.

**2. There is no assured way to reopen the strait.** Morse was blunt: military escorts, subsidized insurance, and SPR releases are all insufficient. The drone threat (proven effective by the Ukraine-Russia conflict) means that even degraded Iranian capabilities can still threaten tanker transit. The economics: a $100M tanker earning $20M per voyage won't risk destruction when the crew's lives and 2+ years of replacement time are at stake. Insurance pricing is irrelevant when the asset itself is irreplaceable. **Only Iran deciding to stop — or being worn down sufficiently — reopens the strait.**

**3. The $30/bbl oil move understates the real risk.** Setser's macro arithmetic: $10/bbl = ~10bp off US GDP. At $30 up, that's ~0.3pp — noticeable but manageable. But if 10M bbl/day is actually lost for sustained period, supply-demand elasticity math implies oil at **$170+** — which would mean ~1pp+ hit to US GDP, probably more with non-linear effects. Current prices reflect a probability-weighted average between "quick resolution" and "multi-month blockade." If the latter materializes, prices haven't moved enough.

**4. Gulf damage is radically uneven.** [[Karen Young]]'s data from [[Goldman Sachs]] (assuming hostilities end by early May, gradual Hormuz resumption):

| Country | GDP contraction (2026E) | Driver |
|---------|------------------------|--------|
| [[Qatar]] | **-14%** | LNG exports 100% Hormuz-dependent |
| [[Kuwait]] | **-14%** | No pipeline bypass |
| [[UAE]] | **-5%** | Fujairah pipeline partially operational, but hit by drone debris; foreign investor outflows |
| [[Saudi Arabia]] | **-3%** | East-west pipeline to Red Sea functional; Aramco anchor |
| [[Oman]] | **-1%** | Outside Hormuz, but still targeted |
| [[Iraq]] | **Severe** (unquantified) | 90% of government revenue from oil; KRG pipeline dispute blocking alternative |

**5. US energy independence is a myth — the US is "six countries."** Morse's framework: Alaska (exporter), Gulf Coast (exporter), East Coast (importer), West Coast (importer), Canadian border (two-way), Pacific NW interior (self-sufficient). The coasts experience global supply shocks like any net importing country regardless of aggregate US production. The [[Jones Act]] makes it worse — it has failed every time the government tried to lift it except small emergencies. See [[US Energy Independence Six Countries]] for full concept note.

**6. Russia is the clear geopolitical winner.** Setser: Russian Urals crude went from $50 to ~$100. Sanctions effectively lifted (two US licenses — first India-only, then universal). Russia's break-even is $30-40/bbl vs Saudi's ~$90. Financial pressure on Russia to limit Ukraine operations has disappeared. The panel saw no realistic scenario where the Trump administration reimposed sanctions.

**7. China is relatively insulated but not immune.** O'Sullivan: China has more tools — 1.2B barrel stockpile (~80-104 days), fuel switching ability (back to coal, freeing LNG cargoes for Asia), demand management capacity. But 70%+ of China's oil is imported, and Iran/Russia suppliers are both strategically compromised. Setser added: this "ratifies China's decision to stockpile oil rather than US Treasuries" and validates China's electrification strategy.

**8. Gulf states will demand more from the US — or diversify away.** O'Sullivan: Gulf states housed US bases without defense treaties. They'll now demand formal defense agreements or diversify weapons procurement. Young: expect more defense spending (taking away from Vision 2030 diversification), more supply chain diversification toward China (renewables manufacturing), and a fundamental reassessment of the US security umbrella that's been fraying since the 2019 [[Saudi Aramco|Abqaiq]] attack.

**9. Even a short war leaves a permanent Hormuz risk premium.** Morse explicitly stated the change won't be structural like 1973 (OPEC empowerment, nationalization of oil majors). But the demonstrated ability to close Hormuz with drones means oil, shipping, and insurance markets will price a structural risk premium indefinitely. Future crises will be priced differently. This is bearish for any asset whose valuation assumes stable, cheap Middle Eastern energy supply.

**10. The AI / data center Gulf nexus is at risk.** Fishman raised the point that US AI leadership depends on Gulf data center buildout (access to cheap power). Young responded that Gulf sovereign funds will continue deploying capital into tech globally — but with "a lot more caution," and the physical buildout in-region faces obvious security concerns after drone strikes on UAE infrastructure.
...
- [[Iran conflict economic disruption]] — energy/oil/LNG deep dive
...
- [[US Energy Independence Six Countries]] — concept (Ed Morse's "six countries" framework from CFR panel)
- [[Eddie Fishman]] — actor (CFR Greenberg Center director, panel moderator)
- [[Megan O'Sullivan]] — actor (Belfer Center/Harvard, former Deputy NSA)
- [[Ed Morse]] — actor (Hartree Partners, commodity strategist)
...
## MEI panel — $200B Pentagon request, sanctions paradox, investor confidence (March 20, 2026)

[[Mick Mulroy]] (fmr Deputy Assistant Secretary of Defense for Middle East, ex-CIA, ex-Marine, [[Middle East Institute|MEI]] Distinguished Military Fellow) and [[Colby Connelly]] (MEI Senior Fellow, energy expert) provided the most comprehensive structural assessment of the war's economic trajectory.

### Pentagon $200B supplemental request

The Pentagon is requesting $200B more — roughly 1/4 of current defense budget, roughly 1/4 of entire [[Iraq]] war cost ($800B over 8 years). The war is not even a month old. Mulroy: this signals the Pentagon's own plan is NOT for 2-3 weeks. Bluster won't work — [[Iran]] understands asymmetric pain tolerance. Iran endured maximum pressure campaign for 6-7 years. Iran knows the US has a democracy — midterms coming. They don't.

### Sanctions paradox — unprecedented in wartime history

The US is discussing lifting sanctions on [[Russia]]n AND [[Iran]]ian oil mid-war. Neither Mulroy nor the moderator (Ken, ex-CIA) could think of another war in history where you lifted sanctions on the enemy during combat. 100-140 million barrels of Iranian oil in floating storage — waivers would apply to these. This emboldens hardliners who think they're winning. Russia benefits enormously: sanctions removed + oil prices soaring. Mulroy: "We should be going the other direction with sanctioning Russia." [[Ukraine]] is making military gains while world attention is diverted to [[Iran]]. See [[Iran conflict sanctions paradox]].

### Investor confidence collapse

Connelly: [[Kuwait]] was opening its oil sector to international investment for the first time — lost a major investor. [[Occidental Petroleum]] involved in [[UAE]] assets that were attacked. [[Exxon]]'s portfolio includes liquefaction capacity at [[Ras Laffan]] — enormous potential losses. Restoring confidence requires assurance "this doesn't happen again" — very far from that. The above-ground risk landscape has fundamentally changed.

### Gulf basing recalculation

Gulf countries hosted US bases believing it made them safer. Now reconsidering: hosting bases made them targets — not just military bases but civilian economy (hotels, highrises, energy infrastructure). Some may view US presence as liability. Mulroy: need to address why it's advantageous for them to house [[CENTCOM]] ([[Al Udeid]]), [[Fifth Fleet]] ([[Bahrain]]). Even if not saying it publicly, they're thinking: "If we didn't have US military assets here, would we be on the target list?" Since regime change won't happen, this might just be "a pause" before it happens again.

### Gulf tech/AI investment at risk

Connelly: the Gulf was attracting tech/AI investment because of cheap energy (natural gas for power, low-cost solar, wind). The war doesn't change the resource advantage — but the above-ground risk landscape affects investment decisions. The resource base that made the Gulf appealing for AI/data centers isn't going away, but the risk premium on physical presence has permanently increased.
...
- Bloomberg Odd Lots: "What War in Iran Means for Teapot Oil Refineries of China" (March 13, 2026, recorded Mar 4) — [[Erica Downs]] ([[Columbia Center on Global Energy Policy]]) on China energy vulnerability, teapot refineries, SPR, LNG exposure

---

*Created 2026-03-02. Refactored into hub + concept notes 2026-03-03.*
