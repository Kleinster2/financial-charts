...
| Note | Scope |
|------|-------|
| [[Iran conflict oil price timeline]] | Chronological oil/gas price action, IEA release, CME intervention, analyst calls, demand destruction |
| [[Iran conflict supply chain cascade]] | Fertilizer, petrochemicals, container shipping, SE Asia emergency measures, consumer/industrial ripple |
...
## Day 1 market moves (March 2, verified closes)
...
Refined products outpacing crude (Mar 3, CNBC): European diesel surged 20% on Monday alone vs crude's 9%. The Strait isn't just a crude chokepoint; it's critical for refined products too.

---

## Strait of Hormuz — de facto closure

IRGC declared Hormuz closed. ~150 ships stalled by Day 3, ~700 by Day 8, ~3,200 by Week 3. Traffic effectively halted except Iranian/Chinese-flagged vessels. The closure is de facto, not physical — insurance withdrawal is doing the work that physical blockade has not ([[Kpler]], Mar 1). For full traffic data, bypass analysis, and Iran-to-China flow details, see [[Strait of Hormuz]].
...
European gas +23% on March 2. ~25% of global [[LNG]] transits Hormuz. Qatar LNG production halted after direct Iranian strikes. [[QatarEnergy]] declared force majeure March 4. [[Saad Al-Kaabi]] warned (March 20) force majeure could last up to five years on some contracts. See [[Ras Laffan]].

### UK gas exposure

UK rapidly increasing Qatari LNG dependency:
...
UK gas prices surged 50% in a single day on Mar 2 — the biggest one-day move since Russia's invasion of Ukraine (Feb 2022).
...
|---|---|---|
| Deploy forces for freedom of navigation | Failed — 22+ vessels attacked, no escort ops, Navy decommissioned minesweepers in Jan 2026 | Blockade persists; no credible reopening timeline |
...
Robin Mills (Qamar Energy, The National, March 15): the US response is "becoming a farce" — decommissioning minesweepers weeks before the war, dispatching drones and Marines 2 weeks late, calling on adversaries ([[China]]) to send warships.
...
| Sovereign credit actions | Rating agencies reassessing oil-import-dependent sovereigns (Pakistan, Bangladesh, Sri Lanka) | Tracked — see [[Iran conflict sovereign credit risk]]. [[S&P Global]] head of sovereign analysis Roberto Sifon-Arevalo (Mar 12, 2026): "We don't want to jump the gun"; Asia second-most-exposed (PA/BD/SL heavily-indebted, IN/TH/ID lower-reserve), [[Bahrain]] "only clear exception" in GCC, [[Qatar]] banking-sector risk noted but no current strain. Duration is the binding variable; no formal action through May 17 |
...
| SPR drawdown pace vs. refill | IEA 400M bbl release — how fast are buffers actually depleting? | Tracked in [[Iran conflict oil price timeline]] |
| Container shipping rates | Gulf-bound rates ~4x, blanket surcharges, containers dumped at alternative ports | Tracked — see [[Iran conflict supply chain cascade]] |
| Insurance market pricing | War-risk premiums making Gulf shipping permanently uneconomic | Tracked — see [[Iran conflict insurance impact]] |
...
| Developing nation remittance flows | Gulf expat populations contracting → weaker remittance flows to South Asia, Africa, SE Asia. Combined with food shortages from fertilizer disruption | Tracked — see [[Iran conflict remittance flows]]. Times of Oman / NPR / Manila Times (Mar-May 2026): ~5M [[Bangladesh]] + ~5M [[Pakistan]] + 9M [[India]] + 2.4M [[Philippines]] workers in Gulf. Remittance share of GDP: ~3-5% PA/BD/SL, ~10% [[Nepal]] (most exposed), ~1% India. [[Rajiv Biswas]] scenario: 3+ months conflict = 30% remittance reduction = 10-15% GDP drag for the cohort. Through May 17: 1 Bangladeshi worker fatality (Mar 8 Saudi missile strike), 40K BD workers stuck, 300K+ Indian jobs delayed. Data still doesn't reflect the hit due to settlement-lag + lump-sum repatriation distortion |
...
- [[QatarEnergy]] — force majeure, Ras Laffan shutdown
- [[Ras Laffan]] — world's largest LNG facility
- [[IEA]] — coordinating body for reserve release
- [[Hormuz Permanent Risk Premium]] — structural thesis
- [[Shell]], [[Exxon]], [[Chevron]], [[ConocoPhillips]] — oil majors
