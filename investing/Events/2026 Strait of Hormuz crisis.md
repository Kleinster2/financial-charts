...
The 2026 Strait of Hormuz crisis is an ongoing disruption to global oil and LNG shipping through the [[Strait of Hormuz]], triggered by coordinated US-Israeli strikes on [[Iran]] (Operation Epic Fury / Operation Roaring Lion) on February 28, 2026. [[Iran]] retaliated by closing the strait to Western-allied shipping, attacking merchant vessels, and laying naval mines. The disruption removed ~20 mb/d of crude from seaborne markets — the largest energy supply shock since the [[1973 oil crisis]]. [[Brent]] peaked at $126/bbl, [[Dubai crude]] hit an all-time record of $166/bbl (March 19), and EU natural gas doubled to ~60/MWh within days. By late March, Iran shifted from blanket closure to a selective transit regime, granting passage to [[China]], [[Russia]], [[India]], [[Iraq]], [[Pakistan]], [[Malaysia]], [[Thailand]], and [[Philippines]] while blocking US/Israeli-allied vessels and charging up to $2M per transit.

---

## Timeline

### Phase 1: Closure and retaliation (Feb 28 - Mar 4)

- Feb 28: US-Israel strikes kill Supreme Leader [[Ali Khamenei]]. Iran retaliates with missiles/drones on Israeli cities and US bases in [[UAE]], [[Qatar]], [[Bahrain]]. At least 3 tankers struck near the strait.
- Mar 1: MT Skylight struck north of Khasab, [[Oman]] (2 crew killed, 3 injured). MKD VYOM hit by drone boat (1 Indian sailor killed). LCT Ayeh: 1 Indian critically wounded.
- Mar 2: [[IRGC]] officially confirms strait closure. By midnight, zero tankers broadcasting AIS signals. P&I clubs remove war-risk coverage effective March 5. EU natural gas spikes 53% to 46/MWh.
- Mar 3: [[Trump]] announces US Navy will escort tankers. [[Iraq]] begins shutting [[Rumaila]] oil field (storage full). Natural gas peaks at 60/MWh (100% weekly increase).
- Mar 4: IRGC claims complete strait control. Reports emerge that Iran is allowing only Chinese vessels through. [[QatarEnergy]] stops gas production, later declares force majeure.

### Phase 2: Escalation and oil price surge (Mar 5 - Mar 12)

- Mar 5: Turkish LPG tanker Bogazici broadcasts Muslim/Turkish ownership, passes successfully. Bulker Iron Maiden transits signaling "CHINA OWNER."
- Mar 6: Tugboat Mussafah 2 struck by missiles, sinks (4 crew dead). War-risk insurance premiums increase 4-6x.
- Mar 7: [[Kuwait Petroleum Corporation]] declares force majeure, cuts production.
- Mar 8: [[Brent]] surpasses $100/bbl for the first time in 4 years, peaks at $126/bbl. Southern [[Iraq]] production drops 70%: 4.3M to 1.3M bbl/day.
- Mar 9: Trump expresses intent to seize the strait. [[France]] announces Operation Aspides (defensive escort), sends 2 frigates + dozen ships.
- Mar 10: Bulk carrier explosion 36 nm off [[Abu Dhabi]]. US reports Iran planting naval mines; destroys 16 Iranian minelayers. [[Saudi Arabia]] diverts oil via [[East-West Pipeline]] to [[Yanbu]]; [[UAE]] diverts via [[ADCOP]] to [[Fujairah]].
- Mar 11: Coordinated attack wave damages 5+ vessels. Tankers Safesea Vishnu and Zefyros set ablaze, abandoned (1 crew killed). Two tankers attacked at Port of Basra (38 crew rescued, 1+ killed). [[G7]] agrees to release 400M barrels of emergency reserves.
- Mar 12: [[UKMTO]] reports 21 confirmed attacks total. Gulf Arab states have cut production by 10M+ bbl/day. 150+ ships anchored outside the strait.

### Phase 3: Military campaign and diplomatic maneuvering (Mar 13 - Mar 26)

- Mar 13: [[Saudi Arabia]] cuts production 20% (10M to 8M bbl/day), shuts Safaniya offshore field.
- Mar 15-24: [[India]] evacuates 5 LPG carriers in 3 operations under Operation Sankalp, escorted by Indian Navy through [[Gulf of Oman]].
- Mar 19: US Armed Forces begin 2026 Strait of Hormuz military campaign. Dubai crude hits all-time record of $166/bbl. Joint statement from [[France]], [[Germany]], [[Italy]], [[Netherlands]], [[UK]], [[Japan]] pledging assistance.
- Mar 21: One ship pays $2M for passage through Iran's alternate channel north of Larak Island. 16+ nations sign UN statement calling for strait opening.
- Mar 22: Trump threatens to "obliterate" Iranian power plants if strait not opened within 48 hours. Iranian defense council threatens to mine the entire Persian Gulf.
- Mar 23: Oil falls from $114 to $102 on negotiation signals. Iranian lawmaker [[Alaeddin Boroujerdi]] confirms $2M transit fees: "Collecting $2M as transit fees reflects Iran's strength." [[Bloomberg]] confirms ad hoc charging of commercial vessels.
- Mar 26: Israeli Defense Minister [[Israel Katz]] announces IRGC Navy Commander [[Alireza Tangsiri]] killed in airstrike. FM [[Abbas Araghchi]] announces selective passage: [[China]], [[Russia]], [[India]], [[Iraq]], [[Pakistan]] vessels allowed. [[Malaysia]], [[Thailand]] granted access.

### Phase 4: Selective regime and ongoing standoff (Mar 27 - present)

- Mar 27: IRGC turns away 3 container ships; formally announces vessels to/from US, Israel, and allies prohibited. UN humanitarian/fertilizer shipments approved. Brent back to $114.
- Mar 30: Trump threatens strikes on Iranian energy infrastructure. US Treasury announces plan to "gradually take control" of the strait.
- Mar 31: Kuwaiti VLCC Al Salmi struck at [[Dubai]] port (fire contained, no spill). US suspends Russian oil embargo until Apr 11 (30 tankers, 19M barrels).
- Apr 1: [[QatarEnergy]] tanker Aqua 1 attacked north of [[Doha]] (fire extinguished).
...
| Apr 25-26 | [[Trump]] calls off [[Steven Witkoff]] / [[Jared Kushner]] trip to [[Pakistan]] mid-flight; tells reporters Iran instead delivered a "new proposal" through Pakistani mediators that he characterizes as "offering a lot but not doing enough" |
| Apr 25 (Friday) | US sanctions a [[Hengli Petrochem]] unit for alleged Iranian crude purchases — first private Chinese refiner sanctioned in this enforcement wave; Hengli denies importing Iranian oil; stock limit-down 10% on Apr 27 open |
| Apr 25-27 | [[CENTCOM]] / US Navy disclosure: 36+ Iranian-flagged tankers turned back into Persian Gulf since dual-blockade phase began |
| Apr 27 (Monday) | Axios reports Iran has formally tabled a new strait-reopening proposal via Pakistani mediators. Brent dips intraday to ~$106.58 from ~$127 area on the headline. [[Trump]] convenes Situation Room session with senior officials. White House Correspondents' Dinner shooting (Apr 25 night) and a planned state visit by [[King Charles III]] and [[Xi Jinping]] meeting (May) compete for executive attention |
...
#### Apr 27 supply-balance mechanics ([[Stephen Stapczynski]] / Bloomberg)

Three months into closure, [[Stephen Stapczynski]] (Asia energy lead, Bloomberg) maps the lever set the market still has and what each one buys in time:

- Cumulative seaborne loss is approaching ~1 billion barrels; G7 strategic-reserve releases plus [[Japan]]-led national stockpile draws have offset roughly half. The other half is being absorbed by working-capital tightening, demand rationing, and floating-storage destocking (e.g., India tapping previously sanctioned Russian barrels under US waivers).
- The forward shortfall, if Hormuz stays at the current trickle, projects to ~5 mb/d — roughly 5% of global supply. That is the gap demand-destruction has to close.
- Demand destruction has already begun in poorer Asia (Sri Lanka school week shortened, Thailand elevator restrictions, [[Pakistan]] and [[Philippines]] fuel rationing). Developed-market rationing — Europe, US, Northeast Asia — is the next leg if the strait stays shut another few weeks.
- The strain is now showing first in product markets, not crude:
  - Jet fuel: airlines globally cutting flights and raising fares; European [[Iran conflict airline disruption|carriers worst hit]].
  - Diesel: Indian truckers preparing for fuel rationing and price step-ups.
  - Naphtha: South Korean petrochem complex flagging supply squeeze (was 80% Middle East-sourced; see [[South Korea]] and [[Naphtha]]).
- Sanction tightening on the [[Shadow fleet]] — including the Apr 25 [[Hengli Petrochem]] unit designation — is reducing the pool of "unofficial" barrels that some buyers had been quietly drawing. Each tightening removes one more lever and accelerates the slide toward demand-side rationing.

Stapczynski's framing: every passing day at the current throughput strips one more buffer. The reserves are a bandage, not a substitute supply source. Price is the eventual rationing tool once the buffers are exhausted — which is why the Hormuz forward curve and the [[Hormuz Permanent Risk Premium]] structural repricing thesis cannot be fully unwound by headline reopening signals alone.

*Source: Bloomberg "The China Show," Apr 27 2026 — Stephen Stapczynski interview with David Ingles and Avril Hong.*
...
### Apr 28 — Iran proposes Strait reopening for blockade end; US redlines unchanged

The [[White House]] confirmed [[Donald Trump|Trump]] is discussing Iran's latest peace proposal with his team. The proposal terms — as reported and surfaced in the Bloomberg "The China Show" 4/28/2026 broadcast — pair a [[Strait of Hormuz]] reopening on Iran's side with a US end to the blockade of Iranian ports, while explicitly postponing more complex negotiations over Iran's nuclear program. US officials maintained their redlines, including preventing Iran from getting nuclear weapons. The structural read: Iran is offering the maritime concession (which it cannot indefinitely sustain given the Stapczynski Apr 27 supply-balance math showing demand destruction propagating to developed markets) in exchange for restoring port access and discounting the harder nuclear question to a separate, later track.

Brent crude held above $108 — up 8-9 straight days — through the proposal news. The market read the proposal as not yet binding (no White House acceptance signal; redlines maintained on nuclear) but as the cleanest pre-resolution configuration since the conflict opened in late February. Pakistan-mediated channel architecture (per [[Pakistan as US-Iran Mediator]]) remains the working diplomatic track.

*Sources: Bloomberg "The China Show" 4/28/2026 broadcast (White House confirmation, US redline framing); [[2026 Iran conflict]] timeline; [[Pakistan as US-Iran Mediator]] concept note.*

The same day Bloomberg "The Asia Trade" 4/28/2026 added three operational threads. First, [[Laura Davison]] (Bloomberg politics) reported the contour of the talks has narrowed: the proposal is now structurally a Strait-for-blockade swap, with the harder nuclear program "siphoned off" to a later track — explicitly "in line with what European allies were thinking, that this process could take months." [[Marco Rubio]] characterized the latest Iranian offer as "more than the U.S. thought it might" be, while [[Donald Trump|Trump]] is reported skeptical. Iranian-flagged or Iran-bound vessels boarded by US forces in the [[Gulf of Oman]] / Indian Ocean approach have been turned around mid-route, with AIS signals indicating they are heading back to original Asian destination ports — the cleanest sign the blockade is biting on the supply side. Traffic *through* the strait is "essentially complete stoppage."

Second, German Chancellor [[Friedrich Merz]] said publicly that the [[Trump administration]] is "being humiliated" by the [[IRGC]]-led Iranian negotiation posture: "I can't tell what strategic exit the Americans are pursuing, especially since the Iranians are negotiating very skillfully, or perhaps skillfully refusing to negotiate." This is the first NATO-leader-level alliance-credibility attack on the war's conduct since the conflict opened — significant for [[Alliance Credibility Crisis]] tracking and consistent with the [[Hormuz Permanent Risk Premium]] thesis that the US-led security architecture is structurally weaker than headline naval force projection suggests.

Third, [[Paul Dobson]] (Bloomberg executive editor, Asian equities) framed the market disconnect bluntly: "two very diverging narratives" — the digital-transformation rally pulling Asian equities to within 1% of records vs. an ongoing "slow-motion train wreck" on oil where physical scarcity compounds daily even as price action looks contained. Bond yields remain "tethered to where energy prices move" while equity markets have decoupled. The implication: if Hormuz physical shortages emerge before resolution, the equity market faces a sharper repricing than the orderly bond move would currently suggest.

*Sources: Bloomberg "The Asia Trade" 4/28/2026 broadcast — Laura Davison (politics), Paul Dobson (markets); Friedrich Merz Bundestag statement.*

#### Apr 28 — UAE leaves OPEC under Hormuz cover

Same broadcast surfaced the [[2026 UAE OPEC exit|UAE's announcement]] of full exit from OPEC and OPEC+ effective May 1, 2026 — the third major OPEC departure in seven years (after [[Qatar]] 2019 and Angola 2024) and the first by a major exporter leaving at the peak of capacity (~4.8 mb/d today, 5 mb/d 2027 target via [[ADNOC]]) rather than the trough. Energy Minister [[Suhail Al Mazrouei]] explicitly tied the timing to the strait closure in his Bloomberg interview with Jumana Versace: "the decision is taken at the right time, in our view, because it's not going to hugely impact the market. The market is undersupplied... because of the unfortunate closure of the Strait of Hormuz." With the strait closed and inventories drawing toward the [[Natasha Kaneva]] / [[JPMorgan]] operational-minimum estimate of ~842M bbl OECD floor, the OPEC exit doesn't immediately add barrels and so doesn't shock the market today. The forward question is post-normalization: whether the UAE coordinates informally on production pace or whether unconstrained ramp toward 5 mb/d triggers a market-share reset. [[Jorge Leon]] of [[Rystad Energy]]: Saudi Arabia must now do "more of the heavy lifting on price stability" with OPEC+ losing a key "shock absorber." Versace's framing in the interview itself: "It is a blow for their cohesion that they have decided to leave today."
...
- [[QatarEnergy]] (Mar 4)
- [[Kuwait Petroleum Corporation]] (Mar 7)
- [[Bahrain]] Bapco
- [[Iraq]] — all oilfields (Mar 17)

## Selective transit regime
...
## Bypass infrastructure activated

- [[East-West Pipeline]] (Petroline): [[Saudi Arabia]], 5M bbl/d capacity, Abqaiq to [[Yanbu]] (Red Sea)
- [[ADCOP]]: [[UAE]], 1.5M bbl/d, Habshan to [[Fujairah]] (Indian Ocean, outside strait)
- [[Kirkuk-Ceyhan Pipeline]]: [[Iraq]]-[[Turkey]], ~450K bbl/d operational

Combined bypass capacity (~7M bbl/d) covers roughly a third of the 20 mb/d that normally transits the strait.

## Key analytical frameworks

- [[Hormuz Permanent Risk Premium]] — why the risk premium persists even after the crisis resolves: demonstrated capability, insurance market memory, mine warfare residue, precedent effect
- [[Hormuz Transit Regime]] — Iran's monetization of the chokepoint: transit fees, bilateral access, yuan settlement condition, de-dollarization vector
...
| Trigger | US-Israeli Operation Epic Fury / Operation Roaring Lion strikes on [[Iran]] |
| Core disruption | ~20 mb/d seaborne oil removed from market |
| Peak oil price | $166/bbl (Dubai crude, Mar 19 — all-time high) |
...
[[Robin J. Brooks]] (Apr 5): UN Comtrade data mapping Asian economies' Gulf oil dependency.

| Country | Oil imports (% GDP) | Gulf share (%) |
|---------|-------------------|----------------|
| [[Pakistan]] | ~1.7% | ~99% |
| [[Philippines]] | ~0.7% | ~97% |
| [[Japan]] | ~2.0% | ~93% |
...
Most vulnerable quadrant (high GDP exposure + high Gulf share): [[Japan]], [[South Korea]], [[Pakistan]]. See [[Robin J. Brooks]] for full analysis.

## Inventory trajectory

[[Natasha Kaneva]]/[[JPMorgan]] (Apr 3): "Largest oil supply shock in history."

- Effective loss: ~14 mb/d from Hormuz closure
- OECD commercial crude draw: ~166M bbl in April, ~67M bbl additional in early May
...
## Jun. 4, 2026 - RBC/Croft: deal tape vs reopening clock

[[Helima Croft]]'s Jun. 4 [[RBC Capital]] interview is the analyst version of the same late-May reopening trap. The market is still selling oil on imminent-deal headlines, but Croft puts the live physical gap at 10-12.5 mb/d depending on how many ships Iran lets through the [[Strait of Hormuz]]. That is smaller than the first-week "near total" shock, but still historically huge, and it remains inconsistent with a clean return-to-neutrality narrative.

The new hard datapoint is the [[ADNOC]] reopening clock: Dr. Sultan Ahmed Al Jaber told RBC that restoring strait flows to 80% of pre-war levels would take at least four months, and the clock does not start until the war has ended. That pushes the event note from "deal binary" to a sequence test:

| Reopening layer | Jun. 4 Croft read | Vault implication |
|---|---|---|
| Diplomatic headline | White House and media deal signals keep producing oil selloffs | Paper oil can price the peace dividend before commercial operators move |
| Physical transit | 10-12.5 mb/d still off market depending on Iranian permissions | The flow deficit remains large even below $100 Brent |
| Commercial confidence | Western shippers/insurers may not accept IRGC-controlled coordination or payments | Permissioned transit is not the same as neutral passage |
| Full normalization | At least four months to 80% of pre-war flow after war end | "War ends" is the start of normalization, not the endpoint |

This aligns the Croft/RBC read with the existing [[Hormuz Transit Regime]] and [[Hormuz Permanent Risk Premium]] notes: the acute war premium can compress on deal headlines while the commercial-confidence premium persists until mine risk, sanctions/payment risk, insurance terms, and IRGC veto risk all clear together.
...
- [[2026 Iran conflict market impact]] — broader market consequences
- [[Iran conflict insurance impact]] — insurance mechanics
