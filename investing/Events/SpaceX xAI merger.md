...
**SpaceX xAI merger** — Feb 2, 2026. Largest M&A transaction in history ($1.25T combined valuation). SpaceX acquires xAI to build space-based AI data centers.
...
| Share price | ~$527/share |
| Exchange ratio | 0.1433 xAI → 1 SpaceX |
| Cash option | $75.46/share (for xAI execs) |
| Record | **Largest M&A ever** (beat Vodafone/Mannesmann $203B, 2000) |

**Legal counsel:**
- SpaceX: Sullivan & Cromwell
- xAI: Gibson Dunn & Crutcher

---

## Strategic rationale

**Official thesis: Space-based AI compute**
...
**The physics case:**
- Solar panels in orbit generate 5x more power (no night, weather, atmosphere)
- Space provides efficient cooling (radiator pointed away from sun)
- Musk predicts: "Within 2-3 years, the lowest cost to generate AI compute will be in space"
...
## Real story: The 12-year arc

| Year | Event |
|------|-------|
| 2012 | Demis Hassabis warns Musk: AI could follow humans to Mars, destroy colony |
| 2014 | Google acquires DeepMind; Musk tried to block (offered 5% of Tesla) |
| 2015 | Musk + Altman found OpenAI as Google counterweight |
| 2017-18 | Musk demands 50-60% equity, children to control AGI; rejected |
| Feb 2018 | Musk leaves OpenAI board |
| Mar 2023 | Signs letter calling for 6-month AI moratorium |
| Jul 2023 | Launches xAI (4 months after signing moratorium) |
| Mar 2025 | xAI acquires X (Twitter) via share swap |
...
- Wrote: "Deepmind is causing me extreme mental stress"
...
**Translation:** xAI's valuation only makes sense with exit strategy. Merger + IPO provides that.

---

## Grok regulatory exposure

**Under investigation in jurisdictions representing 2B+ people:**

| Regulator | Issue |
|-----------|-------|
| California AG (Bonta) | Non-consensual sexual imagery, CSAM |
| Internet Watch Foundation | "Criminal imagery of children" found |
| 35 US state AGs | Joint letter demanding action |
| EU Commission | Digital Services Act proceeding |

**Conflict:** SpaceX holds ~$22B in government contracts (NASA, DoD, intelligence). Merging with AI company under investigation creates unprecedented regulatory questions.
...
- 2025: xAI acquires X (share swap)
- 2016: Tesla acquires SolarCity (stock deal)
- Now: SpaceX acquires xAI

**Tesla excluded:** Creates fiduciary concerns. Tesla shareholders' $2B xAI investment now sits in SpaceX subsidiary.
...
> "We might have AI smarter than any human by the end of this year... probably by 2030-31, AI will be smarter than all of humanity collectively."

**Musk on reconciling the risk (Jul 2025):**
> "Will this be bad or good for humanity? Even if it wasn't going to be good, I'd at least like to be alive to see it happen."
...
**Winners:**
- SpaceX employees/investors (IPO liquidity)
- xAI investors (0.1433 exchange → SpaceX stock)
- Starlink (V3 satellites add 20x capacity)

**Risks:**
- Grok investigations could taint SpaceX
- xAI burn continues (~$1B/mo)
- Musk conflict-of-interest concerns
- Regulatory scrutiny on defense + AI combo

**Watch:**
- April 2026: Musk v. OpenAI trial (Oakland)
- H2 2026: SpaceX IPO
- DOGE/government contract exposure
...
- [[Power constraints]] — problem merger aims to solve
- [[AI hyperscalers]] — competitive context

### Theses
- [[AI capex arms race]] — SpaceX IPO funding AI infrastructure
