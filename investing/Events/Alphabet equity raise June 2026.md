...
tags:
  ...
  - hyperscaler
---
#event #ai #infrastructure #financing #hyperscaler
...
| Component | Amount | Timing / status | Read |
|---|---:|---|---|
| Common stock offering | $15B | Jun 2 2026 424B5 supplement | Split evenly between Class A and Class C shares; underwriters have 30-day over-allotment options |
...
Same-day regular-session close was not yet available as of 12:31 ET on Jun 2, 2026. The only tape available from the source during this ingestion was FT's report that Alphabet fell more than 2% after hours after the announcement. That is a preliminary after-hours reaction, not a verified closing move; the daily note logs the after-close follow-up.

| Instrument / actor | Status as of ingestion | Read |
|---|---|---|
| [[Alphabet]] / GOOGL / GOOG | FT-reported after-hours decline; Jun 2 regular-session close unavailable | Tape is treating dilution and funding intensity as the first-order issue, even though AI capacity demand remains strong |
| [[Berkshire Hathaway]] / BRK.A / BRK.B | No completed Jun 2 close available during ingestion | $10B is small relative to Berkshire's cash pile, but large enough to confirm Abel's narrowed Big Tech bet |
| [[Goldman Sachs]], [[JPMorgan Chase]], [[Morgan Stanley]] | Underwriter/adviser exposure; no meaningful listed-bank tape available yet | Fee opportunity is secondary; the important bank read is that mega-cap AI issuance is becoming an equity-capital-markets product, not only debt/project finance |
| [[QQQ]] / [[XLC]] / [[XLK]] | No completed Jun 2 close available during ingestion | Peer/benchmark attribution requires the Jun 2 close before writing exact moves |

---

## Physical bottleneck check

The FT report does not disclose a new data-center site, power plant, [[Power purchase agreement]], utility interconnection, grid region, or capacity target beyond the broader AI infrastructure funding need. The physical-constraint filing therefore stays in [[Hyperscaler capex]], [[AI infrastructure financing]], [[AI infrastructure financing risk]], and [[AI infrastructure deals]] rather than a new power-asset note.
...
| Watch item | Trigger | Why it matters |
|---|---|---|
...
- [[Alphabet]] - issuer and AI infrastructure sponsor
- [[Google]] - operating company / AI infrastructure user
- [[Google securities note]] - stock and market-facing read-through
- [[Berkshire Hathaway]] - $10B private-placement buyer
- [[Greg Abel]] - Berkshire CEO and capital allocator
- [[Hyperscaler capex]] - capex envelope and cash-flow pressure
- [[AI infrastructure financing]] - funding-structure taxonomy
- [[AI infrastructure financing risk]] - dilution, credit, and circularity risk
- [[AI infrastructure deals]] - capital-stack ledger
- [[Google-Blackstone TPU cloud venture 2026]] - prior off-balance-sheet [[TPU]] funding structure
