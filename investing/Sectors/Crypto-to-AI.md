---
aliases: [Crypto to AI, Bitcoin miners to AI, Crypto pivots]
---
...
| Range | 0.53 - 0.70 | CORZ-IREN to HUT-IREN |
| vs [[DC REITs]] | 0.08-0.20 | Separate clusters |
...
CORZ slightly less correlated — further along in AI pivot (CoreWeave deal).

---

## Key actors

| Company | Ticker | AI Strategy | Key Deal |
|---------|--------|-------------|----------|
...
- Former/current Bitcoin miners
- Existing power infrastructure (stranded/cheap energy)
- Pivoting to AI/HPC hosting for higher margins
...
- Different investor base (growth/spec vs REIT funds)
...
| Margins | Variable | 60-70% gross |
| Capital intensity | Very high | High |
| Customer concentration | Often high | Diversified |
...
Bull case:
- Existing power infrastructure is scarce asset
- AI demand exceeds hyperscaler capacity
- Higher margins than Bitcoin mining
- First-mover advantage in AI hosting
...
- [[TeraWulf]] — zero-carbon focus
- [[Cipher Mining]] — also pivoting
- [[Bitdeer]] — NVIDIA partnership

### Adjacent
- [[CoreWeave]] — GPU cloud (customer/partner)
- [[Bitcoin]] — legacy business

### Concepts
- [[Crypto-to-AI pivot]] — thesis note
- [[Power constraints]] — key asset (existing power)
...
| 2Y | 147 | 0.715 | 0.55-0.85 | 76.3% | 7.9% | 0.671 | +0.044 |
| 3Y | 147 | 0.715 | 0.55-0.85 | 76.3% | 7.9% | 0.671 | +0.044 |
...
Tightest pairs: RIOT-CLSK (0.84), MARA-CLSK (0.83), RIOT-HUT (0.82). All three are pure-miner-to-pure-miner pairings. Loosest pairs: MARA-IREN (0.48 — the cohort's most distant pair, capturing the pure-mining-vs-AI-pivot divide).

### PC2 sub-structure — pure miners vs AI-pivot names

PC2 captures 8.6% of variance and produces the cleanest cohort sub-structure split I've seen in any vault cluster:
...
Regressing the equal-weighted basket against various benchmark combinations:
...
Best 2-name expressions by tracking correlation to the 7-name basket:

| Pair | Intra-corr | Tracking corr to basket | Sharpe | Cum % |
|---|---|---|---|---|
| HUT + CLSK | 0.775 | 0.967 | 1.12 | +74.9% |
| CORZ + CLSK | 0.635 | 0.964 | 1.04 | +48.4% |
| CLSK + WULF | 0.727 | 0.954 | 1.01 | +56.4% |
| RIOT + WULF | 0.720 | 0.952 | 1.51 | +97.0% |
| RIOT + HUT | 0.819 | 0.952 | 1.54 | +120.2% |

Best Sharpe pairs (different objective):

| Pair | Sharpe | Cum % |
|---|---|---|
| RIOT + IREN | 1.78 | +135.8% |
| CORZ + IREN | 1.74 | +108.8% |
| IREN + HUT | 1.71 | +146.2% |
| IREN + WULF | 1.66 | +120.1% |
| CORZ + RIOT | 1.60 | +86.8% |

IREN appears in all top-Sharpe pairs (4 of top 5) — same pattern as PL in [[Space pure-plays]] and PL in [[Mag 7 cluster|Mag 7]]. The "Swiss Army knife" name for Sharpe optimization is consistently the cohort's highest-return name combined with the factor-clean tracker. Multi-objective subset selection produces different answers from factor-tracking optimization — same lesson as the [[Space pure-plays#Best Sharpe 2-name pair — diversification beats factor-tracking|Space pure-plays analysis]].

### Complement test surprise

Top tracking pair (HUT + CLSK) vs full 7-name basket vs 5-name complement:

| Metric | Top 2 (HUT+CLSK) | Full 7 | Complement 5 |
|---|---|---|---|
| Cum return % | +74.9% | +79.4% | +81.3% |
...
*Created 2026-01-30; expanded 2026-05-11 with 7-name validation + advanced patterns.*
