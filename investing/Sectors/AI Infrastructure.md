...
Power (utilities, nuclear, renewables)
        ↓
Cooling (liquid cooling, Vertiv, Modine)
```
...
| [[Digital Realty]] | Wholesale data centers |
| [[Vertiv]] | Power/cooling equipment |
...
| Player | Angle |
|--------|-------|
| [[Constellation Energy]] | Nuclear PPAs |
| [[Vistra]] | Gas + nuclear |
| [[NextEra Energy]] | Renewables |
| [[Oklo]], [[NuScale]] | SMRs (future) |
...
| Driver | Impact |
|--------|--------|
| LLM training | Massive GPU clusters |
| Inference scaling | Growing faster than training |
| [[Agentic AI]] | Always-on compute |
| Enterprise adoption | Broadening demand |
| Sovereign AI | Government buildouts |
...
| Risk | Impact |
|------|--------|
| AI winter / demand slowdown | Overcapacity |
| Power constraints | Buildout delays |
| Regulation | Compute restrictions |
| Competition to NVIDIA | Margin compression |
| Hyperscaler insourcing | Chip vendor displacement |
