...
|------|------------|----------|
| [[Goldman Sachs]] | ~$180B | Trading, advisory |
| [[Morgan Stanley]] | ~$180B | Wealth management |
...
|---------|-------------|------------|
| **Consumer banking** | Deposits, mortgages, cards | NII, deposit costs |
| **Commercial banking** | Middle market, CRE | Loan growth, credit quality |
...
| Driver | Impact |
|--------|--------|
| **Interest rates** | NII expansion/compression |
| **Credit cycle** | Loan losses, provisions |
| **Capital markets activity** | IB fees, trading |
| **Regulation** | Capital requirements, stress tests |
| **Competition** | Fintech, neobanks |
...
|-------|---------|--------|
| Higher rates | Banks with deposit franchises | Rate-sensitive borrowers |
| CRE stress | Well-reserved banks | Regional CRE lenders |
| IB rebound | Goldman, JPMorgan | — |
| Wealth growth | Morgan Stanley | — |
| Asset cap removal | Wells Fargo (catalyst) | — |
...
**Typical ranges:**
- P/TBV: 1.0-2.0x (JPM premium, C discount)
- ROTCE: 12-20% (JPM best-in-class)
...
| Regulation | Impact |
|------------|--------|
| Basel III Endgame | Higher capital requirements |
| CCAR stress tests | Annual capital planning |
| FDIC deposit insurance | Systemic stability |
| Volcker Rule | Proprietary trading limits |
...
| [[Wells Fargo]] | Asset cap removal catalyst | Regulatory uncertainty |
| [[Citigroup]] | Turnaround, discount | Execution risk |
