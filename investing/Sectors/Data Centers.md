...
|---------|------------|-------|--------------|
| [[Equinix]] | ~$80B | Interconnection | Moderate (enterprise) |
...
**Thesis:** Fill GPU demand hyperscalers can't meet. See [[Neocloud financing]].

### Crypto-to-AI pivots

| Company | Ticker | Pivot status |
|---------|--------|--------------|
| [[Core Scientific]] | CORZ | $3.5B CoreWeave deal |
...
| Hyperscaler | 2025 capex | Focus |
|-------------|------------|-------|
| [[Microsoft]] Azure | ~$80B | AI/cloud |
| [[Amazon]] AWS | ~$75B | AI/cloud |
| [[Google]] GCP | ~$50B | AI/cloud |
| [[Meta]] | ~$60B | AI training |
| [[Oracle]] | ~$16B | Catching up |

**Trend:** Hyperscalers building own vs leasing. See [[AI hyperscalers]].
