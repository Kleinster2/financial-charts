...
[[xAI]]'s LLM family. Integrated with X (Twitter). Grok 4 (Jul 2025) uses multi-agent reasoning. Grok 5 (Q1 2026) targeting 6T parameters. Tesla integration.

## Quick stats

| Metric | Value |
|--------|-------|
| Current version | Grok 4 (Jul 2025) |
| Next version | Grok 5 (Q1 2026, 6T params) |
| Training | 200,000 GPUs (Colossus) |
| Access | X Premium, SuperGrok, API |
| Key strength | Real-time X data, multimodal |
...
| Grok-1.5 | Mar 2024 | Vision, 128K context |
| Grok-2 | Aug 2024 | Major upgrade |
| **Grok 3** | Feb 2025 | 10x compute, "Think" mode |
| Grok 3 mini | Feb 2025 | Efficient variant |
| **Grok 4** | Jul 2025 | Multi-agent, Heavy tier |
| Grok 4 Heavy | Jul 2025 | Top-tier reasoning |
| Grok Imagine | Jul 2025 | Video generation ("AI Vine") |
| **Grok 5** | Q1 2026 | 6T params (announced) |
...
| Tier | Price | Access |
|------|-------|--------|
| X Premium | $8/mo | Basic Grok |
| X Premium+ | $16/mo | Full Grok |
| SuperGrok | $30/mo | Advanced features |
| SuperGrok Heavy | $300/mo | Grok 4 Heavy (enterprise) |
| API | Per-token | Developer access |
...
| Feature | Details |
|---------|---------|
| Multi-agent | Agents model each other's goals |
| Think mode | Extended reasoning |
| Big Brain mode | Complex problem-solving |
| Grok 4 Heavy | Outperforms Claude, Gemini, GPT-4 (claimed) |
...
| Release | Q1 2026 |
| Speed | "Extremely intelligent and fast" |
| AGI chance | ~10% human-level (Musk claim) |
...
| Feature | Details |
|---------|---------|
| X integration | Real-time posts, trends |
| Grok Vision | Camera analysis |
| Voice mode | Multilingual audio |
| Grok Imagine | 6-second video clips |
| Tesla | In-vehicle AI (Jul 2025) |
...
| Aspect | Details |
|---------|---------|
| Data center | Colossus (Memphis) |
| GPUs | 200,000 (Grok 3 training) |
| xAI acquisition | Merged into SpaceX (Feb 2026) |
...
|----------|---------|
| DoD | $200M (Jul 2025) |
| GenAI.mil | Pentagon platform (2026) |
| Security | IL5 clearance for 3M personnel |

---

## Competitive position

| vs | Grok advantage | Grok weakness |
|----|---------------|---------------|
| [[GPT]] | X data, real-time | Ecosystem maturity |
| [[Claude]] | Speed, integration | Safety reputation |
| [[Gemini]] | Independence | Google scale |

Unique access to real-time social data.
