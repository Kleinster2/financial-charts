...
| Modalities | Text, audio, images, video, code |
...
| vs | Gemini advantage | Disadvantage |
|----|-----------------|--------------|
| [[ChatGPT]] | Distribution (Android, Search) | Brand, consumer mindshare |
| [[Claude]] | Multimodal, scale | Reasoning depth |
| [[Grok]] | Enterprise, distribution | Less edgy personality |
| [[Qwen]] | Global reach, resources | Open source traction |
