...
The reported trigger has widened beyond the [[Amazon]]-researcher jailbreak. Reporting has since named the firm: [[SK Telecom]], South Korea's largest carrier and an [[Anthropic]] investor, one of [[Project Glasswing]]'s roughly 150 [[Claude Mythos|Mythos]]-access partners. US officials flagged it over suspected [[China]] ties — historical and thin (parent [[SK Group]]'s China Unicom stake until 2009) — and pressed Anthropic to revoke its access days before the blanket directive; SK Telecom denies any China ties (Washington Post, June 15; WIRED). Korea is now at the center of the dispute. Anthropic has held its line: "we disagree that the finding of a narrow potential jailbreak should be cause for recalling a commercial model deployed to hundreds of millions of people." Prediction markets ([[Kalshi]]) price roughly a 57% chance access returns before July 1. Full event detail and the policy read-through in [[Anthropic#Jun 12 — Commerce export ban; Fable 5 / Mythos 5 taken offline|Anthropic]] and [[Export controls#First deployed-model export control — Anthropic Fable 5 / Mythos 5 (Jun 12, 2026)|Export controls]].
