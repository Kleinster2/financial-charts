...
| Product | Description |
|---------|-------------|
| **Pay in 4** | 4 biweekly payments, 0% APR |
| **Monthly payments** | 6-60 months, 0-36% APR |
| **Affirm Card** | Debit card with pay-over-time |
| **B2B** | Merchant integration |

Revenue from merchant fees + consumer interest.
...
|--------|-------|
| GMV | $25B+ |
| Active consumers | 18M+ |
| Active merchants | 300K+ |
| Revenue | ~$2.3B |
| Take rate | ~8-9% |
...
| Credit losses | Managed, below peers |
...
| Fact | Detail |
|------|--------|
| Background | PayPal co-founder (Mafia) |
| Role | CEO |
| Philosophy | Transparent lending, no late fees |
| Net worth | ~$1B |
