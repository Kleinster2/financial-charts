...
| Metric | Value |
|--------|-------|
| Ticker | GOOS (TSX, NYSE) |
| Market cap | ~C$4.5B (~$3.3B USD) |
| Revenue (FY25E, ends Mar 2025) | ~C$1.35B |
...
|--------|------|------|-------|
| Revenue (C$M) | 1,217 | 1,333 | ~1,350 |
| Revenue growth (CC) | +4% | +10% | +5% |
| Adj. EBIT (C$M) | ~180 | ~210 | ~200 |
| Adj. EBIT margin | ~15% | ~16% | ~15% |

Growth moderating after strong FY24. DTC transition largely complete.
...
|----------|--------|------|
| Parkas/outerwear | ~70% of revenue | Still core |
| Lightweight/rain | Growing | Spring/fall relevance |
| Knitwear | Launched 2021 | Year-round play |
...
**Bear:**
- Parka dependency — seasonal, weather-dependent
- Category expansion unproven (footwear struggles)
- Warm winters = demand risk (climate change)
- CEO transition risk (Reiss → Baker)
- Growth deceleration (+5% CC)
- Luxury consumers shifting to "quiet luxury" (away from branded outerwear)
...
- [[Moncler]] — direct luxury outerwear competitor
- [[Burberry]] — luxury outerwear heritage peer
