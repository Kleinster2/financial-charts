---
aliases: [India defense industry, Indian defence industry, Make in India defense]
---
#actor #industry #defense #india

**Indian Defense Industry** — World's largest arms importer transitioning to domestic production. "Make in India" push. Massive modernization needs.
...
|---------|--------|-------|
| Hindustan Aeronautics (HAL) | HAL.NS | Aircraft, helicopters, engines |
| Bharat Electronics (BEL) | BEL.NS | Electronics, radar, comms |
| Bharat Dynamics (BDL) | BDL.NS | Missiles, torpedoes |
| Mazagon Dock | MAZDOCK.NS | Warships, submarines |
| Cochin Shipyard | COCHINSHIP.NS | Naval vessels |
| Garden Reach (GRSE) | GRSE.NS | Naval vessels |
...
|--------|-------|
| FY25 budget | ~$75B |
| Global rank | 4th largest military spender |
| Import share | ~60% (declining) |
| Domestic target | 70% by 2030 |
...
| Initiative | Detail |
|------------|--------|
| Positive indigenization | 500+ items banned from import |
| Private sector entry | Opened to competition |
| FDI limits raised | Up to 74% (from 49%) |
| Defense corridors | Tamil Nadu, UP industrial zones |
| Export target | $5B by 2025 |
...
| Program | Lead | Status |
|---------|------|--------|
| Tejas Mk2 | HAL | Development (indigenous fighter) |
| AMCA (5th gen) | HAL/DRDO | Design phase |
...
| Factor | Detail |
|--------|--------|
| DPSUs dominant | 80% of domestic production |
...
**Bull:**
- Structural modernization needs
