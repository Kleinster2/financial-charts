...
---
#actor #enterprise #usa

**IBM** — Enterprise tech giant. Watsonx AI platform, hybrid cloud (Red Hat), semiconductor research. Legacy player pivoting to enterprise AI.
...
| Role | Details |
|------|---------|
| Enterprise AI | Watsonx platform |
| Hybrid cloud | Red Hat, OpenShift |
| Chip research | Still produces cutting-edge research (2nm) |
...
| Model | Purpose |
|-------|---------|
| Granite | Enterprise LLM family |
| Granite Code | Code generation |

Open-sourced some models. Targeting enterprise customers who want control.
...
AI angle: OpenShift AI for enterprise ML deployment.

---

## Semiconductor research

Still produces cutting-edge research:
...
- Sold fabs to [[GlobalFoundries]] (2014)
- Now fabless, partners with [[TSMC]], [[Samsung]]
- Research feeds back to foundry partners
...
| vs | IBM advantage | IBM disadvantage |
|----|---------------|------------------|
...
Tech pioneer:
- Invented DRAM (1966)
- Invented RISC architecture
- Invented relational databases
- Deep Blue beat Kasparov (1997)
- Watson won Jeopardy (2011)

Watson Jeopardy was early AI milestone but overhyped commercially.
...
## Q1 2026 earnings — beat but -4.75% on consulting deceleration and Z cycle maturity concerns (Apr 22, 2026)

IBM beat on revenue and EPS, maintained the full-year +5% cc revenue and ~$1B cash-flow-growth guide, yet the stock fell 4.75% after-hours. Three issues drove the reaction: (1) consulting growth of +4% (just +1% cc) against investor expectations of an AI-services inflection; (2) the +15% Infrastructure print was flattered by IBM Z mainframe cycle (+51% cc), which analysts are treating as a front-loaded benefit rather than a new run-rate; (3) Armonk maintained but did not raise 2026 guide despite the Z cycle strength.

| Metric | Q1 2026 | Q1 2025 | Growth |
|---|---|---|---|
| Revenue | $15.92B | $14.54B | +9.5% |
| Revenue vs consensus | $15.62B | — | Beat by $300M |
| GAAP diluted EPS (cont. ops) | $1.28 | $1.12 | +14% |
| Non-GAAP EPS | $1.91 | $1.60 | +19% |
| Non-GAAP EPS vs consensus | — | — | Beat by 5.5% |
| Non-GAAP gross margin | 57.7% | 56.6% | +110 bps |
| Non-GAAP pre-tax margin | 13.4% | 12.0% | +140 bps |

Segment mix:

| Segment | Q1 2026 revenue | Growth (reported / cc) |
|---|---|---|
| Software | $7.1B | +11% / +8% |
| Consulting | $5.27B | +4% / +1% |
| Infrastructure | $3.3B | +15% / +12% |
| — of which IBM Z | — | +51% cc |

The Z mainframe cycle. IBM Z refresh cycles drive material but short-lived infrastructure revenue pops. The +51% cc print reflects the [[z17]] cycle hitting its peak adoption quarter — historically, this is the best print in a four-quarter window. Analysts read the maintained (not raised) guide as management implicitly acknowledging that the Z tailwind fades into H2 2026 rather than compounds.

Consulting drag. +1% constant currency is the weakest print in several quarters and lands against peers ([[Accenture]], [[Capgemini]]) where the AI-services narrative is under pressure. Consulting is the segment that was supposed to monetize the [[watsonx]] / [[Red Hat]] / [[Confluent]] full stack via services revenue. The Q1 print says that monetization is slower than the three-year M&A build suggests.

Confluent integration (closed Mar 17) contributed marginally to Software growth; the full revenue contribution hits from Q2 onward. The real test is whether Confluent-attached deals lift the consulting segment into a re-rating later in 2026. If consulting stays at +1-2% cc through mid-2026, the "full-stack AI vendor" thesis loses the last supportive data point.

Dividend raised to $1.69/quarter — a routine bump, not a signal.

See also the [[February 2026 AI Disruption Cascade]] context for IBM's positioning — the stock is still -26% from its Feb highs, and the Apr 22 reaction suggests the market is re-entering that disruption-risk framing.

*Sources: [IBM Q1 earnings report (CNBC, Apr 22, 2026)](https://www.cnbc.com/2026/04/22/ibm-q1-earnings-report-2026.html); [IBM shares drop despite Q1 beat (Benzinga, Apr 22, 2026)](https://www.benzinga.com/markets/earnings/26/04/51985558/ibm-shares-drop-despite-q1-earnings-beat-details); [IBM Q1 press release (StockTitan, Apr 22, 2026)](https://www.stocktitan.net/news/IBM/ibm-releases-first-quarter-6qkrjbdcybv6.html); [IBM beats Q1 sales but stock drops (Yahoo Finance, Apr 22, 2026)](https://finance.yahoo.com/markets/stocks/articles/ibm-nyse-ibm-beats-q1-201747866.html).*
