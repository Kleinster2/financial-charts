...
| Founder | Background |
|---------|------------|
| Tang Xiao'ou | CUHK professor, [[MSR Asia]] alumnus |
...
|---------|---------------|-------------|
| Smart Business | ~45% | Enterprise AI, retail analytics |
| Smart City | ~30% | Surveillance, traffic, public safety |
...
| Capability | Status |
|------------|--------|
| Face recognition | Among world's best |
| Object detection | Top-tier |
...
Added to US Entity List in 2019:
...
| vs Competitor | SenseTime advantage | Disadvantage |
|---------------|---------------------|--------------|
...
| Concern | Details |
|---------|---------|
| Surveillance | Smart City used for monitoring |
| Xinjiang | Alleged use in region (denied) |
