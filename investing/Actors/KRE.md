...
**Rate sensitivity:** Regional banks more exposed to net interest margin compression/expansion. Rising rates = wider NIMs = outperformance.

**CRE exposure:** Higher concentration in commercial real estate lending than large banks. Office distress in 2023-2024 hit regionals hard.

**M&A targets:** Regionals are perennial acquisition targets by larger banks seeking deposits and branch networks.

---

## 2023 Banking Crisis Impact

KRE was ground zero for the March 2023 regional bank crisis:
...
*Equal-weighted so each regional gets similar exposure.*

---

## Use Case

Sector benchmark for **regional bank** analysis. When charting [[Western Alliance]], [[Zions]], [[Regions Financial]], include KRE to show relative performance.

For analysis that includes large banks ([[JPMorgan]], [[Bank of America]]), use [[KBE]] instead.

---

## Related

- [[KBE]] — broad US bank ETF (includes large banks)
- [[XLF]] — US financials ETF (includes insurance, asset managers)
- [[State Street]] — issuer
- [[2023 Banking Crisis]] — KRE epicenter
- [[Commercial Real Estate]] — key regional bank exposure
