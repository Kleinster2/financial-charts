...
Ayala and MUFG investment in 2024 valued GCash at $5B (up from $2B in 2021).
...
| Significance | Largest PH IPO ever |
...
| Issue | Detail |
|-------|--------|
| PSE minimum float | 20% required |
| GCash request | 10-15% float exemption |
| If approved | $800M - $1.2B raise |

GCash requesting smaller float to limit dilution while meeting listing requirements.
...
| Factor | Detail |
|--------|--------|
| Market conditions | PSEi down ~17% over past year |
| Global uncertainty | Tariff risks, volatility |
| Regulatory | Float exemption pending |

Originally targeted 2025, now pushed to H2 2026.
...
- [[Globe Telecom]] — 36% owner
- [[Ant Group]] — 34% owner, tech partner
- [[Ayala Corporation]] — 13% owner
- [[MUFG]] — 8% owner
