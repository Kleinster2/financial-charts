...
Status (Jun 17–19). A week on, both models remain offline — no access restored as of June 19. Anthropic and [[Donald Trump|Trump]]-administration officials are negotiating a path back, "working toward a deal" to reinstate Fable 5 and Mythos 5 (The Globe and Mail). At a June 17 press conference in Seoul, Anthropic Managing Director of International [[Chris Ciauri]] said the company is "very confident that in the coming days, the models will become available again," without setting a date. Reporting has also widened the trigger beyond the [[Amazon]] jailbreak: the Washington Post (June 15) and WIRED named the trigger as [[SK Telecom]] — an Anthropic investor and [[Project Glasswing]] [[Claude Mythos|Mythos]]-access partner — flagged over suspected [[China]] ties that are thin and historical (parent [[SK Group]]'s China Unicom stake until 2009) and that SK Telecom denies; US officials pressed Anthropic to revoke its access days before the blanket directive, putting Korea at the center of the dispute (a Korean Glasswing partner's China exposure tripping a model-access control is the [[Export controls#First deployed-model export control — Anthropic Fable 5 / Mythos 5 (Jun 12, 2026)|full-stack containment]] thesis made literal). Anthropic's continued line: "we disagree that the finding of a narrow potential jailbreak should be cause for recalling a commercial model deployed to hundreds of millions of people." [[Kalshi]] prices ~57% odds of restoration before July 1, sharpening the [[Anthropic IPO 2026|IPO]] overhang — a regulatory shutdown of the flagship tier weeks after the June 1 confidential S-1.

*Sources: WSJ (Amrith Ramkumar), Jun 13 2026; [Anthropic statement, Jun 12 2026](https://www.anthropic.com/news/fable-mythos-access); [Axios, Jun 12](https://www.axios.com/2026/06/12/anthropic-trump-mythos-fable-national-security); [CNBC, Jun 12](https://www.cnbc.com/2026/06/12/anthropic-disables-access-to-fable-5-and-mythos-5-to-comply-with-government-directive.html); [Fortune, Jun 13](https://fortune.com/2026/06/13/anthropic-disables-fable-mythos-export-controls-national-security-threat/); [NBC News](https://www.nbcnews.com/tech/tech-news/anthropic-suspends-new-ai-models-fable-mythos-government-directive-rcna349901); [Korea JoongAng Daily (Park Eun-jee), Jun 18 2026](https://www.koreajoongangdaily.com/business/anthropic-confident-of-reenabling-mythos-fable-5-access-in-coming-days-executive/12727522); The Globe and Mail (Jun 2026); Washington Post (Korea-telecom / China-ties trigger, via Korea JoongAng Daily).*

### Jun 20 — did Anthropic talk its way into the ban?

A week into the [[Export controls#First deployed-model export control — Anthropic Fable 5 / Mythos 5 (Jun 12, 2026)|export ban]], the debate shifted from "what triggered it" to "did Anthropic's own safety messaging invite it." An FT analysis (Clara Murray, Jun 20 2026) quantified the company's risk-forward communications: in 2026, roughly 5 of every 1,000 words in Anthropic's official statements, social posts, and [[Dario Amodei]]'s writing related to risk, regulation, or restriction — eight times [[OpenAI]]/[[Sam Altman]]'s 0.6 per 1,000. The term "risk" appeared 336 times in Anthropic's 2026 communications (OpenAI: 30); "safeguard" 121 (33); "vulnerability" 128 (10). Anthropic's risk language has roughly halved since 2023 as its tools gained adoption, and its tone is positive overall — but less so than OpenAI's.

The causation argument, made by critics:
- [[Yann LeCun]] (ex-[[Meta]] chief AI scientist): the ban showed [[Dario Amodei|Amodei]]'s "fear-mongering" had "finally paid off" — "one reaps what one sows."
- [[Sam Altman]] (April podcast), mocking Mythos marketing: it is "incredible marketing to say, 'We have built a bomb. We are about to drop it on your head'."
- [[David Sacks]] (former AI czar): a "credible trusted partner" approached the administration with a way to circumvent Fable's guardrails; he claims Anthropic downplayed the concern, forcing a "reluctant" ban — a different framing of the trigger than the [[Anthropic#Jun 12 — Commerce export ban; Fable 5 / Mythos 5 taken offline|Amazon-jailbreak / SK Telecom]] accounts already on file.
- Days before the ban, [[Dario Amodei|Amodei]] published a personal blog post arguing regulators were moving too slowly and that [[Claude Mythos|Mythos]] posed "very real risks to cyber security."

The counter-read is that the policy is incoherent regardless of Anthropic's tone: Lennart Heim (AI-policy researcher, ex-Rand) noted the same administration "has pushed to export advanced AI chips to China" and criticised safety regulation, then "bans the most advanced US model" — the model-vs-chip contradiction already in [[Export controls]].

The stakes escalated to the G7. French President Emmanuel Macron said the dispute had "clarified the stakes" for the US and its allies, called for stronger AI regulation, and warned against "non-cooperation among democracies." The US and Europe opened talks on allied access to AI models, and FT columnist Agathe Demarais argued cutting Mythos access is "a gift to China." Downstream, [[JPMorgan Chase]] cut off Anthropic access for its Hong Kong staff to comply with the foreign-national restriction — an early sign the compliance burden lands on multinational customers, not just Anthropic.

For the investment read, the episode sharpens the safety-brand question central to this note: the $965B [[Anthropic#Funding history|Series H]] premium rests on safety differentiation, yet the same posture that wins enterprise trust is now blamed (by critics) for a regulatory shutdown of the flagship tier weeks before the [[Anthropic IPO 2026|IPO]]. Whether the safety brand is an asset or a liability is being tested in real time — the [[Pentagon AI access dispute 2026|Pentagon front]] and this export front are two tests of the same thesis. The [[Thesis lock-in|trap]] for observers is reading a clean "Anthropic self-sabotaged" narrative into what is also a genuinely incoherent policy; the FT word-count is evidence of messaging posture, not proof of causation.

*Source: [[Financial Times|FT]] (Clara Murray), "Did Anthropic talk its way into an AI export ban?", Jun 20 2026; companion FT View editorial, "The White House's capricious controls on Anthropic," Jun 2026.*

### Anthropic's formal US-government framework — the AISI / CAISI MOU

For context on what does and does not bind the two sides: the only standing memorandum of understanding between Anthropic and the US government is a model-evaluation pact, not an access-control one. In 2024 Anthropic (with [[OpenAI]]) signed an MOU with the US AI Safety Institute at [[Commerce Department|Commerce]]'s NIST, giving the government pre- and post-release access to major new models for capability and safety evaluation. The institute was renamed the [[CAISI|Center for AI Standards and Innovation]] (CAISI) in 2025, its remit shifted from "safety" toward "standards, innovation, and security," and it remains industry's primary evaluation contact inside the government; Anthropic's pre-deployment testing runs through it. Reportedly, days after a separate executive order requiring labs to hand new models to the government 30 days before release, officials told CAISI to stop publishing its model evaluations.

That framework does not govern the export ban. The June 12 suspension was imposed by unilateral [[Export controls|export-control]] directive and the restoration is a political negotiation — there is no bilateral MOU on access by nationality. On the military-use front the administration is likewise acting through its own instrument, the June 5 national-security presidential memorandum [[NSPM-11]] (ordering contract termination for AI vendors that restrict government use — see [[Pentagon AI access dispute 2026]] and [[AI regulation]]), not an agreement with Anthropic.
...
### EU code-of-practice talks + cyber-model review (Apr 17, 2026)

[[Reuters]] reported the [[EU]] Commission is in active discussions with Anthropic over its different models, including cybersecurity-oriented models that are not yet available in [[Europe]]. The Commission also said Anthropic has already committed to respect the EU's general-purpose AI code of practice.

Why it matters: European regulators are treating Anthropic as a frontier model provider whose compliance obligations apply even before some of its highest-risk products are broadly distributed in the region. For Anthropic, that means European expansion in cyber-capability products comes bundled with ex-ante risk-mitigation scrutiny, not just post-launch enforcement. That fits the broader 2026 pattern where Anthropic's most differentiated edge is increasingly tied to coding and cybersecurity capability.
...
### Security incidents (Mar-May 2026)

Two internal/security-process breaches in five days, followed by a brand-impersonation malware campaign in May:
...
Incident 3 — fake Claude installer / [[Beagle backdoor]] (May 7): BleepingComputer reported a fake `claude-pro[.]com` site distributing `Claude-Pro-windows-x64.zip`, a 505MB archive containing a trojanized Claude-looking installer. The app appeared to work, but deployed a PlugX-style chain in the background and ultimately injected Beagle into memory. The C2 used `license[.]claude-pro[.]com`; researchers noted related samples from February-April using different infection chains and impersonating multiple security-vendor update sites. This is not an Anthropic breach, but it is now part of the Anthropic security surface: the brand is valuable enough that attackers are using Claude demand as malware distribution infrastructure. *(BleepingComputer / Sophos / Malwarebytes, May 7)*
