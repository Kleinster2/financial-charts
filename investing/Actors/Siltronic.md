...
## Why Siltronic matters

European wafer supply + excellent market data:

| Metric | Value |
|--------|-------|
| Ticker | WAF.DE (Frankfurt) |
| Market cap | ~€3B |
...
**Siltronic publishes useful market data:**

From 2025-12-29 daily notes:
- Datacenter = 15% of wafer consumption but 50% of incremental 2025 demand
- Servers +23% y/y
- Smartphones = 22% share (still biggest)
- PC +8%, Auto +7%
...
- AI wafer demand
- Useful market data (transparency)
