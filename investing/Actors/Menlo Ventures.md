...
| Fund | Size | Focus |
|------|------|-------|
| Menlo XV | $500M | Early-stage |
| Inflection Fund | $500M | Early-growth |
...
**"All in on AI"** — firm positioning:
- $37B spent on generative AI in 2025 (3.2x YoY per Menlo data)
- Portfolio includes Anthropic, Lovable, AI infrastructure plays
- Active in AI coding tools wave
...
|---------|-------|--------|
| Zafran Security | Series C | $60M |
| Astrix Security | Series B | $45M |
| Mimic | Seed | $27M |
| Klutch AI | Seed | — |
...
Sources:
- [Menlo Ventures official site](https://menlovc.com/)
- [Wikipedia - Menlo Ventures](https://en.wikipedia.org/wiki/Menlo_Ventures)
- [Tracxn - Menlo Ventures](https://tracxn.com/d/venture-capital/menlo-ventures/)
