...
Meituan led and participated in initial financing rounds (Series A and earlier), investing several hundred million yuan. Total Meituan investment now exceeds ¥1B (~$140M).

### Cap table — key shareholders
...
### Quanta X1 — wheeled bimanual robot

| Spec | Value |
|------|-------|
| Form factor | Wheeled chassis + dual arms |
| Degrees of freedom | 20 |
| Working range | Up to 1m |
| Max speed | 2 m/s |
| AI | WALL-A embodied foundation model |

### Quanta X2 — successor

| Spec | Value |
|------|-------|
| Height | 5.5 ft (164 cm) |
| Dual-arm payload | 55 lbs (25 kg) |
| Degrees of freedom | 62 |
| AI | Full-stack WALL-A large operating model |
| Display | 4-inch interactive screen (real-time expressions) |
| Interaction | Chest microphone array, LLM-powered dialogue |

Both Quanta X1 and X2 perform autonomous real-world tasks.

### ArtiXon — dexterous hand

| Spec | Value |
|------|-------|
| Degrees of freedom | 20 |
| Actuators | 15 |
| Manipulation tasks | 31 (pinching, grasping, twisting) |
| Open/close speed | <1 second |

---

## Technology — WALL-A

X Square's proprietary embodied AI system:

| Component | Function |
|-----------|----------|
| **VLA model** | Vision-language-action |
| **World model** | Predicts actions, causal reasoning |
| **Integration** | VLA + world model architecture |

**Key capability:** Generalizes to new tasks without prior training. Improves mobile manipulation in complex, unstructured environments by using world models for action prediction and feedback interpretation.
...
**Claimed advantage:** Full-stack self-developed software and hardware reduces production costs, enabling mass commercialization.
...
X Square differentiates with wheeled design (stability, lower cost) vs legged humanoids.
...
- [[Robotics]] — sector (humanoids segment)
...
- [[1X Technologies]] — peer (wheeled humanoids)
