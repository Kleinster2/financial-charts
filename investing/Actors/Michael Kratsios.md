...
1. **Out-innovate competitors** — regulatory environment that allows development and commercialization in US
2. **Drive infrastructure build** — data centers, power, compute
3. **Export American technology** — share AI stack with the world ("American AI Export Program")

### Federal vs state regulation

- Core insight: regulatory environment must allow technology to be developed AND commercialized in US
- Patchwork of 50 state rules is most detrimental to early-stage companies — big companies navigate it, startups can't
- Working on legislative proposal for national framework
- Trump's December executive order listed areas states should keep: child safety, data center permitting
- Working "closely together" with Sacks on consensus for federal framework in 2026

### American AI Export Program (detailed)

- Commerce Department closed request for information (RFI) late 2025
- Request for proposals (RFP) coming out "very shortly" (as of Jan 2026)
- Want companies to form consortia — define what "a package" looks like
- Key insight: buyers of AI worldwide vary dramatically in sophistication
  - US Fortune 500: sophisticated CIO/CTO, evaluate clouds, models, fine-tuning options
  - Most countries: just trying to figure out a tool for healthcare, tax collection, services
- Solution: "turnkey" AI packages — manageable-sized, easy to deploy
...
- Third big AI shift beyond general knowledge and coding: scientific discovery
- Challenge: science data is extraordinarily fragmented, not formatted for LLM training
- Spread across disciplines (chemistry, math, materials science) in all types of formats
- Genesis Mission: government push for "big bold leaps in AI for scientific discovery"
- National labs at DOE have 50-60 years of research data ready to be used for model training
- Dream: AI labs where you input hypothesis, lab runs experiment itself
- Goal: US could "almost double our R&D output over the next 10 years because of AI"
...
- Easy to underestimate long-term impact across industries and domains
- Easy to think of AI as "just a sophisticated chatbot" — that's what most people touch and feel
- Fundamental shift in velocity/pace of scientific discovery
- "Huge repercussions for the way that we as a country innovate broadly speaking in the years ahead"
...
- [[India]] — AI Impact Summit (Feb 2026)
- [[AI regulation]] — federal preemption push
- [[Peter Thiel]] — mentor/former employer
