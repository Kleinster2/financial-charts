...
| Detail | Value |
|--------|-------|
| Issuing authority | Shilin District Prosecutors, Taiwan |
...
## Taiwan talent poaching allegations
...
| Factor | Detail |
|--------|--------|
| **Language** | Shared Mandarin |
| **Expertise** | World-class tech talent |
| **Proximity** | Geographic, cultural |
| **Cost** | Lower than poaching from US |
...
| Line | Position |
|------|----------|
| OnePlus numbered series | Flagship (OnePlus 12, 13) |
...
| Angle | Detail |
|-------|--------|
| **Private** | No direct equity access |
| **Taiwan risk** | Arrest warrant = escalation of cross-strait tech tensions |
| **Supply chain** | Uses Taiwan components (irony) |
| **Precedent** | Follows Luxshare Grace Wang warrant |

### Implications

| For | Implication |
|-----|-------------|
| **Chinese tech** | Taiwan cracking down on talent poaching |
| **Taiwan** | Using legal tools to protect tech ecosystem |
| **Executives** | Chinese tech leaders face personal legal risk |
...
### Concepts
- [[Taiwan tech protectionism]] — driving the crackdown
