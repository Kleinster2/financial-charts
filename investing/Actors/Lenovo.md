...
**CFO Winston Cheng:**
> Cost surge is "unprecedented"

**Response — hoarding strategy:**
- Memory inventory 50% above normal levels
- Anticipating further price increases
- Locking in supply now
...
|---------|-----------------|
| **IDG (PCs)** | ~70% of revenue, high exposure |
| **ISG (Servers)** | Growing, very high exposure |
| **SSG (Services)** | Lower exposure |

PC-heavy = memory-exposed.
...
## ThinkPad / Enterprise strength

**Enterprise advantage:**
- ThinkPad brand loyalty
- Enterprise can absorb price increases
- Stickier than consumer
- But still margin pressure
