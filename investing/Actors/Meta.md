...
- Meta framing: "always-on directory" for agent-to-agent discovery
- Comes after Meta failed to recruit [[Peter Steinberger]] (OpenClaw creator, went to [[OpenAI]])
...
See [[Wearable AI]] for competitive landscape.
...
|---------|-------------|-------|
| Q3 2022 | $23.6B | Included office facilities |
| Q3 2023 | $22.9B | First time DC/servers only |
...
|---------|----------|----------|--------|
| Prometheus | Ohio | $0.8-1.0B | Active, 1GW, H100/B200, 2026 |
| Cheyenne | Wyoming | ~$0.8B | Peak Build, 800k sq ft |
| Jeffersonville | Indiana | ~$0.8B | Liquid-cooled redesign |
| Kuna | Idaho | ~$0.9B | Active, ~960k sq ft |
| El Paso | Texas | $1.5B | Early, "Superintelligence" site |
...
- [[Power constraints]] - limiting Blackwell deployment
