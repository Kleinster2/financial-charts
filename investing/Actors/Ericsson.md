...
One of three global telecom equipment vendors.
...
|---------|-----------|-------------|
| Networks | ~70% | RAN, 5G equipment |
| Cloud Software | ~15% | BSS/OSS, cloud |
| Enterprise | ~10% | Private networks |
...
| Factor | Impact |
|--------|--------|
| Network densification | More equipment needed |
| Open RAN | Potential threat/opportunity |
| Private networks | Enterprise growth |
| Carrier capex | Cyclical dependency |
