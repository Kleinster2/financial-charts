...
aliases: [NVT, nVent]
---
#actor #datacenter #enclosures #cooling #usa #public

**nVent Electric** — Data center enclosures and liquid cooling pure-play. $10B market cap. Q3 2025 organic orders +65% YoY driven by AI DC buildout. 1GW+ liquid cooling already deployed.
...
*NVT +600% since 2020, outperforming [[Eaton|ETN]] (+400%) on DC pure-play positioning. Still lags [[Vertiv|VRT]] (+3100%) — VRT remains the dominant DC infrastructure name.*
...
| Metric | Value |
|--------|-------|
| Q3 2025 organic orders | +65% YoY |
| Liquid cooling deployed | 1GW+ |
| Liquid cooling experience | 10+ years |
| Revenue growth (2026E) | +15% |
...
| Product | Application |
|---------|-------------|
| Electrical enclosures | Mission-critical DC housing |
| Liquid cooling systems | Direct-to-chip cooling |
| CDUs | Coolant distribution units |
| Cable management | DC infrastructure |
...
- New Blaine, MN facility (early 2026) for liquid cooling production
...
| Segment | Focus |
|---------|-------|
| Enclosures | DC, industrial, networking |
| Electrical & Fastening | Connection, protection |
| Thermal Management | Liquid cooling, heat tracing |
...
Stock near 52-week highs (~$117 vs. $42 low).

---

## vs Competitors

| Competitor | Focus | nVent advantage |
|------------|-------|-----------------|
| [[Vertiv]] | Full DC stack | Enclosure focus |
| Rittal | Racks/enclosures | Public, US-focused |
| [[Legrand]] | PDUs, cable | Liquid cooling |
| [[Schneider Electric]] | Broad | Pure-play |
...
## Q1 2026 earnings — record print, $2.6B AI-DC backlog, ATH (May 1, 2026)

nVent reported Q1 2026 before the open on May 1. Record top- and bottom-line results, the data-center pure-play thesis playing out cleanly:

| Metric | Q1 2026 | Notes |
|--------|---------|-------|
| Revenue | $1.20B | beat $1.11B est |
| Sales growth | +53% reported, +34% organic | infrastructure-led |
| Adj EPS | $1.09 | beat $0.94 est by $0.15 |
| Organic orders | +40% YoY | data-center buildout-led; ex-DC orders +mid-teens |
| Backlog | $2.6B | provides visibility through 2026 |
| New products | 11 launched in Q1 | contributing 20+ pts to sales growth |
