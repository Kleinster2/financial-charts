...
| Mission | Location | Status |
|---------|----------|--------|
| AMISOM/ATMIS | Somalia | Ongoing |
| Various | Sudan, DRC, CAR | Various |

### Challenges

| Issue | Context |
|-------|---------|
| Coups | Sahel (Mali, Burkina, Niger) |
| Conflicts | Ethiopia, Sudan, DRC |
| Terrorism | Sahel, Mozambique |
...
### Limited direct investment impact

| Reality | Implication |
|---------|-------------|
| Political body | Less economic than AfCFTA |
| Weak enforcement | Aspirational |
| State-led | Limited private sector role |
