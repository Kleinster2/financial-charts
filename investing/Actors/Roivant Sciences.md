---
aliases: [Roivant, ROIV]
---
#actor #company #biotech #usa #public

**Roivant Sciences** — Biotech holding company with "vant" subsidiary model. Founded by Vivek Ramaswamy (2014). 20+ subsidiaries, 6 FDA approvals. NASDAQ: ROIV.
...
| Aspect | Description |
|--------|-------------|
| Strategy | Acquire underdeveloped drug patents, bring to market |
| Structure | Spin out focused subsidiaries ("vants") |
| Capital | Each vant separately funded, some go public |
| Exits | Sell successful vants to pharma |
...
|------------|-------|--------|
| Immunovant | Autoimmune | Public (majority-owned) |
...
| Year | Deal | Acquirer | Value |
|------|------|----------|-------|
| 2023 | Telavant | [[Roche]] | $7.1B (+$150M milestone) |
| 2020 | Portfolio (5 drugs + 10% stake) | Sumitomo Dainippon | $3B |

---

## Incubator function

Roivant incubates AI/biotech startups:
