---
aliases: [Sociedad Química y Minera]
---
...
**World's richest lithium brine:**

| Factor | Advantage |
|--------|-----------|
| Concentration | Highest lithium content globally |
| Cost | Lowest production cost |
| Scale | Massive reserves |
| Method | Solar evaporation (low energy) |

Atacama = Saudi Arabia of lithium.
...
| Segment | Description |
|---------|-------------|
| Lithium | Primary driver (~60% revenue) |
| Specialty Plant Nutrition | Fertilizers |
| Iodine | Industrial chemicals |
| Potassium | Fertilizers |

Diversified but lithium is the story.
...
| Factor | Impact |
|--------|--------|
| 2025 | Surplus narrowing |
| 2026 | Deficit expected |
| Demand | EV growth structural |
| Price | Rebounding from lows |

SQM benefits from any lithium price recovery.
...
- Atacama reserves unmatched
- Lithium deficit 2026
