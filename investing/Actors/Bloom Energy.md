...
aliases: [BE]
---
#actor #power #fuelcell #usa #public

**Bloom Energy** — Solid oxide fuel cells for on-site data center power. Stock up ~550% in 12 months as AI power demand creates grid bypass opportunity. Market cap surged from ~$5B to ~$31.5B.
...
| Ticker | BE (NYSE) |
| Market cap | ~$31.5B |
| Q3 2025 revenue | $519M (+57% YoY) |
| 2025E revenue | ~$1.9B |
| 2026E revenue | ~$2.46B |
| Deployed capacity | 1.5 GW globally |
| DC capacity | 400+ MW |
| Manufacturing target | 2 GW annual by end 2026 |
| IPO price (2018) | $15/share |
| Stock performance | +550% in 12 months |
...
|--------|---------|---------|--------|
| Revenue | $330M | $519M | +57% |
| Operating income | -$9.7M | +$7.8M | Turnaround |

| Year | Revenue | Net income |
|------|---------|------------|
| 2023 | — | ~-$300M loss |
| 2024 | — | -$29M loss (improving) |
| H1 2025 | — | -$66M loss |
...
- Grid-independent — no utility dependency
...
## 2026 Power Report (Jan 2026)

Bloom published research showing data centers plan to reduce reliance on grid — validates the on-site generation trend and Bloom's core value proposition.
...
- [[Power constraints]] — key thesis (Bloom solves the grid gap)
- [[BYOP]] — Bloom is the BYOP solution for data centers
- [[Dominion Energy]] — the grid utility Bloom bypasses
- [[NextEra Energy]] — peer (BYOG model, different approach)
- [[Constellation Energy]] — alternative (nuclear baseload)
- [[Vistra]] — peer (power for AI)
- [[NVIDIA]] — AI demand driver (GPU clusters need power)
