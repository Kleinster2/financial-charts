...
- TSMC relationship: Deepest co-design partnership, first access to new nodes
- Vertical integration: Hardware + software + silicon under one roof
- Volume: Highest volume customer at leading edge — locks capacity
...
## Design excellence evidence

A19 (Dec 2025):
- 10% die shrink on N3P vs A18 on N3E
- Node gave 4% — rest from design optimization
- 2x cache density, layout efficiency gains
- Years of co-optimization with TSMC

This is [[Customer lock-in via co-design]] in action — accumulated knowledge that competitors can't replicate.
...
- Forces [[AMD]], Google, others to alternatives like [[Samsung]]
- Demonstrates value of deep foundry relationships
- Sets the bar for silicon design at each node
...
[[Short TSMC long Korea]]: Apple locking capacity forces others to Samsung — bullish Korea demand
...
## April 7, 2026: Foldable iPhone delay + stock decline

AAPL -4.0% to $248.45 (2.5σ) on converging negatives:

1. [[Nikkei Asia]] reported engineering setbacks in "iPhone Fold" testing could push the foldable iPhone release from 2026 into 2027. Technical issues in the early testing phase — specific failures not disclosed.
2. [[Evercore ISI]] flagged App Store growth slowdown in March, particularly in the gaming category.
3. Broader geopolitical drag from escalating Iran-Hormuz tensions and oil price spike (pre-ceasefire).

The foldable delay matters because Apple is one of the last major OEMs to enter the category — [[Samsung]] has shipped foldables since 2019, and [[Huawei]] and [[Google]] have competitive entries. Each delay extends the window for competitors to define the form factor. The 2027 timeline would put Apple 8 years behind Samsung's first Galaxy Fold.

Volume: 61.4M shares, elevated.

*Sources: Motley Fool (Apr 7), Yahoo Finance (Apr 7), TradingKey (Apr 7)*
