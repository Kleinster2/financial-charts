---
aliases: [Ontario Municipal Employees Retirement System]
---
...
| Metric | Value |
|--------|-------|
| AUM | **C$138.2B** (Dec 2024) |
| 2024 return | **8.3%** |
| Members | 500K+ (active, deferred, retired) |
| Employers | 1,000+ |
| HQ | Toronto, Ontario |
| Founded | 1962 |
...
|-------------|------------|-------------|
| **Infrastructure** | 23% | 8.8% |
| Public equity | 20% | 18.8% |
...
**Alternatives allocation: 61%** — highest among Canadian pension funds.
...
OMERS owns 33 infrastructure assets representing 23% of total fund (C$36B).
...
Nov 2023: Acquired 5% of MLSE (Toronto Maple Leafs, Raptors) for C$400M.
...
| Date | Event |
|------|-------|
| Jun 2021 | **Co-led $2.75B round** alongside AP funds (1-4), [[Goldman Sachs]], [[Volkswagen]] |
| Nov 2024 | [[Northvolt]] files Chapter 11 |
| Mar 2025 | Northvolt Swedish bankruptcy; investment likely written off |

---

## Members

OMERS serves Ontario municipal employees:
- Municipalities
- School boards
- Transit systems
...
Defined benefit plan — members receive guaranteed retirement income.

---

## Canadian pension context

| Fund | AUM | Notes |
|------|-----|-------|
| CPP Investments | ~C$600B | National; largest |
| CDPQ | ~C$450B | Quebec |
| Ontario Teachers' | ~C$250B | Ontario teachers |
| **OMERS** | **C$138B** | Ontario municipal |
| PSP Investments | ~C$250B | Federal public service |

---

## Related

- [[Northvolt]] — co-led Jun 2021 round (bankrupt)
- [[Goldman Sachs]] — co-investor in Northvolt
- [[Volkswagen]] — co-investor in Northvolt
