...
|------------|------|--------|
| [[OpenAI]] | $40B+ (Stargate JV) | Largest AI bet |
| [[xAI]] | Participated | Dec 2024 round |
| ARM | 90% ownership | $64B IPO (2023) |
| [[Helion Energy]] | $425M round | Fusion play |
| Various AI startups | $100B+ Vision Fund | Mixed results |
...
- Learning from VF1 mistakes

**Pattern:** Masa swings big, sometimes misses badly.
...
- Willing to lose money to be positioned
- "I'm not a genius, but I can see where the puck is going"
- Compared current moment to "Big Bang of AI"
...
| Risk | Details |
|------|---------|
| ARM concentration | 54.6% of NAV |
| Margin call trigger | -40% ARM decline |
...
- No margin call event

**Risk:** Concentrated, leveraged bet on AI future.
