---
aliases: [MELI, MercadoLivre]
---
#actor #company #latam #public

MercadoLibre — Latin America's largest e-commerce and fintech platform. Operates marketplace (Mercado Libre), payments (Mercado Pago), logistics (Mercado Envios), and credit. Listed on [[Nasdaq]] (MELI).
...
| HQ | Montevideo, Uruguay (operationally Buenos Aires) |
| Key markets | [[Brazil]], [[Mexico]], [[Argentina]] |
| Price (May 8 2026) | $1,632.52 |
| Single-day move (May 8) | -12.7% (-6.7σ) |

---

## Q1 2026 print — revenue beat, EPS miss (May 7-8, 2026)

MELI reported Q1 2026 after the close on May 7. Revenue grew strongly but earnings came in below expectations, sending the stock -11.7% to -12.7% (-6.7σ beta-adjusted) on May 8 from $1,870.01 to $1,632.52 — among the largest single-day declines in the company's public history.

Two structural threads to track:
...
2. Cross-name read on the May 8 SaaS / e-commerce derate cluster. MELI's -12.7% landed alongside [[Cloudflare]] -23.6%, [[HubSpot]] -19.0%, [[CoreWeave]] -11.4%, and [[Toast]] -14.7% — five growth-software / fintech names down on the same session, all at large sigma magnitudes, all on different fundamentals. That is a sector-level repricing event, not five idiosyncratic stories. For LATAM specifically, MELI's -12.7% read against [[Nubank]] (separate sympathy/idiosyncratic to monitor), [[PagSeguro]], and [[Stone]] tells whether the sell-off is region-specific or part of the global growth-software derate.
...
The structural read: MELI is now operating as a multi-front compete-and-defend operation — Mercado Libre vs Shein/Temu/Amazon in commerce, Mercado Pago vs [[Nubank|Nu]] / [[PicPay]] / [[Stone]] in payments, Mercado Crédito vs Brazil's incumbent banks in lending. Each front absorbs investment that drags GAAP margins. The Q1 print is the first quarter where the Street stopped giving MELI the benefit of "growth and margins are both possible" — and the multiple compressed accordingly.
...
- [[Scottish Mortgage]] — holder (4.8% weight)
- [[Nubank]] — fintech competitor in Brazil
- [[PagSeguro]] — fintech peer
- [[Stone]] — fintech peer
...
*Created 2026-02-23. Updated 2026-05-08 (Q1 2026 print).*
