---
aliases: [Shin-Etsu Chemical, 4063.T]
---
...
## Why Shin-Etsu matters

Every chip starts with a silicon wafer. Shin-Etsu makes more than anyone:

| Metric | Value |
|--------|-------|
| Ticker | 4063.T (Tokyo) |
| Market cap | ~¥10T (~$65B) |
| Wafer share | ~30% global |
| Revenue | ~¥2.5T |
| Founded | 1926 |
...
| Type | Application |
|------|-------------|
| 300mm polished | Leading-edge logic, memory |
| 300mm epitaxial | High-performance |
| SOI (Silicon-on-Insulator) | RF, automotive |
| 200mm | Mature nodes, analog |
...
- AI chip demand = wafer demand
- Pricing power (shortage)
- Diversified (PVC hedge)
