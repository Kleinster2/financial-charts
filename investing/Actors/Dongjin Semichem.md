...
aliases: [005290.KS]
---
#actor #semiconductor #materials #korea #public #photoresist

**Dongjin Semichem** — Korea's leading photoresist supplier. First Korean company to produce photoresist (4th globally). Critical supplier to [[Samsung]] and [[SK Hynix]].
...
|---------|----------|-------|
| **KrF photoresist** | Strong | 3D NAND focus, 80% global share (with JSR, TOK) |
| **ArF photoresist** | Growing | Immersion lithography |
| **V-NAND thick PR** | World-class | 2025 government recognition |
| **Display materials** | Significant | LCD/OLED |

---

## 3D NAND KrF photoresist

Dongjin is particularly strong in KrF photoresists for 3D NAND memory:

| Company | Position |
|---------|----------|
| Dongjin Semichem | Top 3 |
| [[Tokyo Ohka Kogyo]] | Top 3 |
| [[JSR Corporation]] | Top 3 |

**Combined 80% share** of 3D NAND KrF photoresist market.
...
**Domestic focus:** Korea's fab expansion = Dongjin growth.

---

## Capacity expansion

- **+30% capacity since 2022** to meet domestic demand
- Targeting further expansion as Korean fabs grow
...
**Bull:**
- Korea photoresist independence play
