...
**Growth:** From 52,552 homes (Dec 2019) to 61,000+ (Sep 2025).
...
- More build-to-rent focus
- Slightly smaller portfolio
...
**Stock reaction:** Down with sector on Trump announcement.

| Risk | Detail |
|------|--------|
| Direct exposure | 61,000+ homes at risk |
| Policy uncertainty | Definition of "large" unclear |
| Existing portfolio | Grandfathered or forced sales? |
...
| Metric | Value |
|--------|-------|
| Total US SFR units | 15 million |
| Institutional ownership | ~3% (400K homes) |
| AMH share of institutional | ~15% |
| Occupancy (sector) | 94.4% (Sep 2025) |
| Rent growth (sector) | 2-3% |

**Key dynamic:** Mortgage payment now $1,091/month more expensive than rent for starter homes — supports rental demand.
...
**Bear case:**
- Regulatory overhang (Trump ban)
- Rent growth moderating
- Rate cuts could shift buyers back to ownership
- Political target ("corporate landlords")
