---
aliases: [LBRT, Liberty Oilfield Services]
---
...
## Why Liberty Energy matters

| Metric | Value |
|--------|-------|
| Ticker | LBRT (NYSE) |
| Market cap | ~$3B |
| Position | Top 3 pressure pumper |
| Focus | Completion services |

---

## Business focus

**Pressure pumping (hydraulic fracturing):**

| Service | Description |
|---------|-------------|
| Frac fleets | Hydraulic fracturing |
| Wireline | Perforating, logging |
| Proppant | Sand logistics |
| Data | Real-time monitoring |

Pure-play completions, no drilling.

---

## Digi-frac technology

**Next-gen frac fleets:**
...
- Frac expertise critical for Orinoco heavy oil
- Would need massive frac capacity
- Could be multi-year opportunity
...
- [[Patterson-UTI]] — competitor (post-NexTier)
- [[Halliburton]] — competitor (integrated)
- [[ProPetro]] — peer (pressure pumping)
