---
aliases: [BOSS, Hugo Boss AG, BOSS.DE]
---
#actor #fashion #luxury #germany #public

# Hugo Boss

**German premium fashion house** — BOSS (premium, 77% of revenue) and HUGO (contemporary, 23%). €4.31B revenue (2024, +3% CC) — record level but growth slowing sharply. Missed €5B 2025 target. EBIT €361M (margin 8.4%, down from 9.8%). Stock -40% from 2023 highs. Key Coty fragrance license makes it relevant to both fashion and beauty. CEO Daniel Grieder's "CLAIM 5" growth strategy running into macro headwinds.
...
| Metric | Value |
|--------|-------|
| Ticker | BOSS (Frankfurt) |
| Market cap | ~€4B |
| Revenue (FY24) | €4,307M (+3% CC) |
| EBIT (FY24) | €361M (8.4% margin) |
| EBITDA (FY24) | €775M (18.0% margin) |
| Net income (FY24) | €213.5M (down 17%) |
| CEO | Daniel Grieder |
...
|-------|-----------|---------------|-------------|
| **BOSS** | ~77% | +3% | Premium ($200-$2,000) |
| BOSS Menswear | ~60% | +3% | Core |
| BOSS Womenswear | ~10% | +3% | Growing |
| **HUGO** | ~23% | +5% | Contemporary ($80-$400) |
...
|--------|---------|
| Revenue | €1.25B (+6% CC) |
| Trend | Sequential improvement |

Q4 was notably stronger than Q1-Q3, suggesting potential recovery trajectory. Full-year result masked by weak first half.
...
| Metric | 2025E |
|--------|-------|
| Revenue range | €4.2B - €4.4B (-2% to +2%) |
| EBIT range | €380M - €440M |
| EBIT margin | 9.0% - 10.0% |

**Flat revenue, improving margins.** Company pivoting from growth at all costs to profitability focus.
...
**Bull:**
- Stock -40% from highs, ~11x PE — cheap for branded fashion
- Q4 acceleration (+6% CC) shows potential recovery
- FCF of €497M — strong cash generation
- Americas growing +8%
- Fragrance license with [[Coty]] growing strongly
- HUGO brand gaining with younger consumers
- Margin recovery guided (9-10% vs 8.4%)
