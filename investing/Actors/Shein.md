#actor #retail #china #ecommerce

**Shein** — Singapore-based fast fashion giant. Hong Kong IPO filed (confidential). Needs Beijing approval.

---

## Why Shein matters

World's largest fast fashion e-commerce:

| Metric | Value |
|--------|-------|
| HQ | Singapore (Chinese origins) |
| Business | Fast fashion e-commerce |
| IPO target | Hong Kong |
| Filing | Confidential |
| Key hurdle | **Beijing approval required** |
...
| Challenge | Status |
|-----------|--------|
| US listing | Abandoned (regulatory) |
| London listing | Abandoned |
| HK listing | Filed, pending Beijing |
...
|------|-----------|
| 2022 peak | ~$100B |
| 2023-2024 | Marked down |
| Current | TBD (IPO pricing) |

Valuation has compressed from peak amid regulatory uncertainty.
...
**Bull:**
- Dominant fast fashion position
- Gen Z brand loyalty
- Massive scale
- HK listing = eventual liquidity
