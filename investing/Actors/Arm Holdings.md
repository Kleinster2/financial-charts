...
**IP licensing:**
- Arm designs CPU architectures
- Licenses to chip makers (Apple, Qualcomm, NVIDIA, etc.)
- Charges upfront license fee + per-chip royalty
- Asset-light, high margin

**Customers (everyone):**
- [[Apple]] (M-series, A-series)
- Qualcomm (Snapdragon)
- [[NVIDIA]] (Grace CPU)
- [[Amazon]] (Graviton)
- [[Google]] (Axion)
...
**The growth story:**
- Mobile saturated — growth in servers/AI
...
**Grace CPU:**
- NVIDIA's Arm-based data center CPU
- Paired with GPUs in Grace Hopper
- Arm collects royalties
- NVIDIA tried to acquire Arm (2020) — blocked by regulators

**Irony:** NVIDIA acquisition blocked, now NVIDIA is major Arm customer.
...
**Bull:**
- Near-monopoly in mobile IP
- AI server expansion = new TAM
- Asset-light, high margin
- Every chip trend benefits Arm
- Hyperscaler custom silicon = Arm
