...
**Latin America's first sovereign large language model.**

### Technical specs

| Metric | Value |
|--------|-------|
| Parameters | **50 billion** (GPT-3.5 equivalent) |
| Training data | 8+ TB regionally sourced text |
| Languages | Spanish, Portuguese, Indigenous (Rapa Nui, others) |
| Architecture | Open-source |
| Partners | 33 strategic alliances across 12 countries |
...
| Beta release (academic review) | October 2025 |
| Official launch | December 2025 |
| 1B+ documents processed | Pre-launch |
...
| CENIA | ~$300K |
| [[CAF]] | ~$250K |
| Univ. of Tarapacá | $5M (supercomputer with GPU) |
| **Total** | ~$550K direct + $5M compute |

Remarkably lean budget vs US AI labs spending billions.
...
- Local legal/regulatory frameworks

**CENIA's pitch:**

> "It won't necessarily be better at topics like biochemistry or business models—unless they are Latin American—but its great strength will lie in knowledge of local contexts. Latam-GPT will know more, and better, about Latin America than any other model."
...
**33 strategic alliances** including:

| Type | Partners |
|------|----------|
| Academic | Universities across 12 countries |
| Government | National AI agencies |
...
## Latin American AI Index (ILIA)

CENIA publishes the **Índice Latinoamericano de Inteligencia Artificial**—annual benchmarking of AI progress across the region.
...
Referenced in WEF/McKinsey "Latin America in the Intelligent Age" report.

---

## Competitive positioning

| Model | Parameters | Focus | Open source |
|-------|------------|-------|-------------|
...
**CENIA not directly investable** (research center), but Latam-GPT signals:

| Trend | Beneficiaries |
|-------|---------------|
| Sovereign AI movement | Regional cloud providers |
| Specialized LLMs | Fine-tuning service providers |
| LatAm AI adoption | [[Mercado Libre]], [[Nubank]] (potential users) |
| Chilean AI ecosystem | [[Santiago Data Hub]], local tech |
