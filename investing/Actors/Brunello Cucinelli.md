...
| Factor | Detail |
|--------|--------|
| Category | Ultra-luxury casualwear, cashmere, quiet luxury |
| Price point | $2,000-$10,000+ per piece |
| Customer | Ultra-high-net-worth, "stealth wealth" |
| Distribution | 122 monobrand boutiques (2024) |
| Competitors | Loro Piana (LVMH), Zegna, Kiton |

**"Quiet luxury" thesis:** Cucinelli epitomizes the post-logo luxury trend — no visible branding, finest materials, artisanal production. The brand gained cultural momentum from shows like *Succession* and broader backlash against logomania.
...
| Pillar | Detail |
|--------|--------|
| Philosophy | "Dignified profit" — 10-11% margins, not maximizing |
| Wages | 20%+ above industry average for artisans |
| Solomeo | Restored medieval village as company HQ |
| Work hours | No emails after 5:30pm policy |
| Succession | Daughter Carolina + son-in-law Riccardo Stefanelli |

Cucinelli's philosophy creates brand equity that's difficult to replicate — the company *is* the founder's worldview.
