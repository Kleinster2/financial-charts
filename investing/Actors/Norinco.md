...
## Cargo drone: Tianma-1000 (天马-1000)

**First flight:** January 11, 2026

Developed by Xi'an ASN Technology Group (西安爱生技术集团), Norinco subsidiary.
...
**Features:**
- High-altitude complex terrain adaptation (Tibet supply runs)
- Ultra-short takeoff/landing
- Modular cargo bay — quick cargo/airdrop mode switch

**Dual-use positioning:** Marketed for civilian logistics (remote resupply, emergency rescue) but specs clearly military-applicable. 1-ton payload, 8km ceiling, short-field ops = battlefield logistics.
...
- [[China defense]] — sector context, one of "Five Sisters"
- [[Drones]] — Tianma-1000 cargo drone
- [[US Sanctions]] — Norinco on Entity List
