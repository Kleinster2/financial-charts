---
aliases: [Motorola Mobility, Moto]
---
#actor #smartphones #usa #subsidiary

**Motorola** — Smartphone brand. Lenovo subsidiary since 2014. Razr foldables.

---

## Why Motorola matters
...
|--------|-------|
| Owner | [[Lenovo]] (100%) |
| Acquired | 2014 from Google |
| Price | ~$2.9B |
| Brands | Moto G, Moto Edge, Razr |
| HQ | Chicago, IL |
...
| Owner | Period | Price |
|-------|--------|-------|
| Motorola Inc | Original | — |
| Google | 2012-2014 | $12.5B |
| **Lenovo** | 2014-present | $2.9B |

Google kept the patents, sold hardware to Lenovo.

---

## CES 2026

Major announcements at Lenovo Tech World @ CES:
...
**First book-style foldable from Motorola:**
- 6.6" external + 8.1" internal display
- Moto Pen Ultra stylus support (Samsung dropped this)
- 50MP quad camera system
- Dolby Vision recording
- Pantone colors (Blackened Blue, Lily White)
- Competes with Samsung Z Fold, Google Pixel Fold

### Motorola Signature

**New ultra-premium line:**
- 6.99mm thickness ("thinnest quad-curved")
...
Part of [[Lenovo]]'s cross-device AI:
- Syncs with Lenovo PCs and tablets
...
| Line | Segment | Price |
|------|---------|-------|
| **Razr** | Foldables (flip + fold) | $700-1200 |
| **Signature** | Ultra-premium | €999+ |
| **Edge** | Flagship | $500-800 |
| **Moto G** | Mid-range | $200-400 |
| **Moto E** | Budget | <$200 |
...
**Not directly investable** — subsidiary of [[Lenovo]] (0992.HK, LNVGY).

**Bull:**
- Foldable differentiation
- Lenovo synergy (Qira)
...
**Bear:**
- Samsung dominance
- Apple premium lock-in
- Margin pressure
- Small % of Lenovo revenue
...
| Owner | Lenovo |
| HQ | Chicago |
| Key products | Razr, Signature, Moto G |
| Status | Subsidiary |
