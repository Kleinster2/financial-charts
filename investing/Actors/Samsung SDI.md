...
|-----------|-------------|
| **NCA** | High energy density |
| **NCM** | Mainstream EV |
| **Prismatic cells** | Primary format |
| **Solid-state** | Heavy R&D investment |

**Solid-state leadership:** Targeting 2027 commercialization.
...
| Detail | Value |
|--------|-------|
| Name | StarPlus Energy |
| Location | Kokomo, Indiana |
| Investment | $3.2B |
| Capacity | 33 GWh (Phase 1) |
| Start | 2025 |

Second plant announced for ~$3B additional investment.
...
| Revenue (2024) | ~$15B |
| Operating margin | ~5% |
| R&D spend | Heavy (solid-state focus) |
| Dividend | Modest |
...
| Milestone | Timeline |
|-----------|----------|
| Pilot production | 2025 |
| Commercial samples | 2026 |
| Mass production | 2027 target |

**Claim:** 900 km range, 9-minute charging (20-80%).
