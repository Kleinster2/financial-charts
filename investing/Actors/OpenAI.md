...
**OpenAI** — Frontier AI lab, creator of GPT series, ChatGPT. Microsoft partner.
...
Largest private funding round in history (~90% strategic). Key investors: [[Amazon]] (up to $50B), [[SoftBank]] (~$30B), [[NVIDIA]] (up to $30B). $730B pre-money / $850B+ post-money. See **[[OpenAI Infrastructure Spend]]** for details.
...
- For-profit transition ongoing (from capped-profit)
- Sam Altman to receive equity (previously had none)
- Nonprofit board tension
- Employee equity concerns during transition
...
## Infrastructure & compute spend

Compute spend target revised from $1.4T → **~$600B by 2030** (Feb 2026). $10B+ [[Cerebras]] inference deal. [[Stargate]] sites in UAE (1GW) and Texas. Exploring alternatives to [[NVIDIA]] for inference (~10% of compute). $100B+ mega-round closing Feb 2026 (~90% strategic investors). See **[[OpenAI Infrastructure Spend]]** for full details.
...
- **Microsoft dependency** — Not independent
- **Commoditization** — Open source closing gap
...
**Bearish**: See [[Model lab economics]] — not investable until path to profitability clears.
...
- [[OpenAI Infrastructure Spend]] — compute spend reset, Stargate, Cerebras, mega-round
