...
**[[Brazil]] AI** — $4B AI plan (2024-2028). 93.6% renewable energy. Dual-track legislation: REDATA (DC incentives) + Marco Legal (AI governance).
...
| Metric | Value |
|--------|-------|
| AI Plan budget | $4B (2024-2028) |
| Renewable energy | 93.6% of grid |
| DC market 2029 | $5.96B projected |
| AWS investment | $1.8B (Sept 2024) |
...
| Tax | Type |
|-----|------|
| PIS/Cofins | Social contributions (suspended) |
| IPI | Excise tax (suspended) |
| Import duties | Fixed assets, if no domestic equivalent (up to 5 years) |
...
| Element | Description |
|---------|-------------|
| Risk classification | Tiered system (like EU AI Act) |
...
| Social inclusion | Unique LatAm emphasis on fairness |

### Other AI regulations already in force
...
| Project | Focus |
|---------|-------|
| Rio AI City | 3.2GW capacity |
| BNDES Garagem | Startup funding |
| Portuguese LLMs | Language models |
| Amazon monitoring | Environmental AI |
...
| Metric | Value |
|--------|-------|
| AI Plan (PBIA) | $4B (2024-2028) |
| REDATA budget | R$5.2B (2026) |
| REDATA investment potential | R$2T (10 years) |
| Renewable grid | 93.6% |
...
- [[Elea Data Centers]] — Rio AI City (3.2GW), REDATA beneficiary
...
- [[Green bonds]] — DC financing instrument
- [[AI regulation]] — global comparison framework
- [[EU AI Act]] — model for Marco Legal
- [[LGPD]] — Brazil data protection law (integrates with Marco Legal)
- [[OECD]] — AI Principles (Brazil signatory)
