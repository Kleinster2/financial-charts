...
Chile is the Saudi Arabia of copper:
...
**Increasing royalties and taxes:**

| Risk | Impact |
|------|--------|
| Royalty increases | Margin compression |
| Constitutional reform | Uncertainty (2022 rejected) |
| Water restrictions | Operational limits |
| Community opposition | Project delays |
| Nationalization risk | Low but non-zero |

---

## Codelco's struggles

**State producer declining:**
- Production falling (aging mines)
- Underinvestment for decades
- Profits extracted by government
- Transition costs (open-pit to underground)

**Implication:** Codelco struggles = tighter global supply = higher prices = good for others.
...
- [[Copper for AI]] — thesis (Chile is supply)
