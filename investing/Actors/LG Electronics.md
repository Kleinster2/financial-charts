...
## Why LG Electronics matters

Diversified Korean tech giant:
...
**Long-running OLED dominance:**
- Pioneered large-panel OLED TVs
- Samsung re-entered OLED in 2022 after years away
...
| Category | LG | Samsung |
|----------|-----|---------|
| OLED TVs | #1 (defending) | #2 (attacking) |
| LCD TVs | #2 | #1 |
...
- [[Samsung]] — competitor (TVs, appliances, Korea)
- [[SK Hynix]] — peer (Korean tech)
- [[Asia IPO pipeline 2026]] — context (Korean companies)
