---
aliases: [Japan defense industry, Japanese defence industry, JSDF industry]
---
...
| Company | Ticker | Defense focus | Notes |
|---------|--------|---------------|-------|
| Mitsubishi Heavy (MHI) | 7011.T | Aircraft, ships, missiles | Largest defense contractor |
| Kawasaki Heavy | 7012.T | Aircraft, submarines, ships | P-1 patrol, C-2 transport |
| IHI Corporation | 7013.T | Engines, space | F-35 engine components |
| Fujitsu | 6702.T | Electronics, cyber | C4ISR systems |
| NEC | 6701.T | Electronics, radar | Defense systems |
| Mitsubishi Electric | 6503.T | Missiles, radar | PAC-3, sensors |

**Mitsubishi Group** dominates (Heavy, Electric = 40%+ of defense contracts).

---

## Constitutional shift

Historic changes under Kishida/current government:

| Policy | Change |
|--------|--------|
| Defense budget | 1% → **2% GDP** target |
| Counterstrike | Now permitted (missiles) |
| Arms exports | Three principles relaxed |
| AUKUS | Pillar 2 technology sharing |
...
Largest peacetime military buildup since WWII.
...
New focus on long-range strike:

| System | Range | Status |
|--------|-------|--------|
| Type 12 (upgraded) | 1,000+ km | Development |
| Tomahawk (US) | 1,600 km | Purchasing 400+ |
...
**Bear:**
- Defense = small % of conglomerate revenue
- Pacifist culture resistance
...
- [[Defense]] — sector hub
- [[Japan]] — country actor
- [[Taiwan contingency]] — key driver
- [[AUKUS]] — technology partnership
