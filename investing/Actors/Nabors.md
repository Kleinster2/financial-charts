...
**Nabors** — Global land driller. US and international presence. Higher leverage than peers. Technology investments.
...
- Stable revenue base
- Counter-cyclical to US
- Expansion opportunities

Saudi provides international stability.
...
| Metric | Nabors | Peers |
|--------|--------|-------|
| Debt/EBITDA | High | Lower |
| Interest burden | Significant | Manageable |
| Equity value | Compressed | Healthier |

Leverage limits upside capture and strategic flexibility.
...
- Undervalued if cycle turns

**Bear:**
- High leverage
- Equity dilution risk
- US rig count soft
- Smaller market cap (illiquid)
