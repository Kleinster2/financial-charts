...
Led to name change and Och departure.
...
|----------|-------------|
| Multi-strategy | Credit, equity, macro |
| Credit | Large allocation |
| Real estate | Opportunistic |
| Event-driven | M&A, special situations |

---

## Rithm acquisition (2023)
...
- [[Millennium]] — peer (multi-strat)
- [[Citadel]] — peer (multi-strat)
- [[Point72]] — peer (multi-strat)
