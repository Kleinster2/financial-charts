...
| Component | Increase |
|-----------|----------|
| DRAM (12GB LPDDR5X) | +41% in 3 months |
| NAND (256GB) | +8% |
...
| Option | Problem |
|--------|---------|
| Raise prices | Already at $450, demand risk |
| Cut specs | Compromises product |
| Absorb costs | Destroys margins |
| Wait | Shortage persists through 2026 |
...
**Bear (current situation):**
- Memory costs structural headwind
- Margins compressed
- No pricing power vs memory makers
- Hardware may be loss leader

**Bull (contrarian):**
- Software margins unaffected
- Strong IP (Mario, Zelda, Pokemon)
- If memory normalizes post-2027
- Depressed valuation
