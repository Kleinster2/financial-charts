...
ByteDance is a stealth AI hyperscaler — spending rivals US big tech:
...
ByteDance's AI buildout drives memory demand:
- HBM3E for H200 GPUs → [[SK Hynix]], [[Samsung]]
- Server DRAM → all memory makers
- SSD/NAND for data storage

Contributes to [[Memory shortage 2025-2026]].
...
- Export controls limit GPU access
- Chinese regulatory risk (tech crackdowns)
- Private — can't invest directly
- Geopolitical pawn in US-China tensions
