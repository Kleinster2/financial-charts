...
### What /dev/agents builds

Infrastructure and tools for AI agent development:

| Focus area | Detail |
|------------|--------|
| Agent frameworks | Tools for building agents |
| Agent orchestration | Managing multi-agent systems |
| Agent deployment | Production infrastructure |

### Market context

AI agent startup funding in 2025:
- ~$2.8B in H1 2025
- Projected $6.7B full year
- 50% of YC S25 batch is agent companies

/dev/agents is infrastructure play — picks and shovels for agent builders.
...
**Risks:**
- Crowded space (many agent startups)
- Big Tech may build in-house
...
Sources:
- [PitchBook - /dev/agents profile](https://pitchbook.com/profiles/company/711753-13)
