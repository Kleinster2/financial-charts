...
### Globalstar acquisition (Apr 14, 2026)

Amazon announced a definitive agreement to acquire [[Globalstar]] (GSAT) for ~$11.6B in cash — $14/share, above the FT-reported $9B range from early April. Deal structure preserves the [[Apple]] capacity commitment (85% of Globalstar's network allocated to iPhone Emergency SOS; Apple's 20% equity stake converts to cash at the deal price). Regulatory timeline targets 2026-Q4 close, pending FCC approval and foreign spectrum authorities across 12 licensed jurisdictions.

| Term | Value |
|------|-------|
| Consideration | ~$11.6B cash |
| Per-share price | ~$14 |
| Apple capacity | 85% carries over |
| Apple 20% stake | Cash consideration at deal price |
| Regulatory close | Targeted 2026-Q4 |
| Primary value driver | Globally licensed L-band and S-band spectrum |

Strategic rationale: Globalstar's globally licensed spectrum plus operational LEO constellation compresses Amazon Leo's direct-to-device roadmap by multi-year margin vs building the regulatory/asset stack from scratch. Amazon now owns three distinct satellite stacks: Kuiper broadband LEO (in deployment), AST SpaceMobile-style direct-to-cell (via Apple + iPhone Emergency SOS infrastructure), and Globalstar's niche enterprise/IoT/Band 53 spectrum. Position relative to [[SpaceX]]/[[Starlink]] tightens on the regulatory moat, loosens on the satellite-count side (Kuiper still <300 vs Starlink's ~8,000+).

Complication open: whether [[Apple]] extends/renegotiates its capacity commitment before close, or lets it run off under Amazon ownership — Apple's reliance on a competitor-owned network for flagship iPhone safety features is a strategic vulnerability Apple is unlikely to accept long-term. Apple has the option to redirect Emergency SOS to AST SpaceMobile, SpaceX direct-to-cell, or build its own constellation.

Cross-vault: [[SpaceX IPO 2026]] positioning takes a hit (direct-to-cell moat narrows), [[AST SpaceMobile]] becomes the only remaining independent direct-to-cell pure-play.
...
The May 8 FT / [[Visible Alpha]] cash-flow pass pushes the same point into the full-year forecast: Amazon is expected to spend more cash than it generates in 2026, with roughly $10B of cash burn on consensus estimates. That makes AWS demand conversion the critical test: the buildout can be attractive if capacity monetizes quickly, but the first-year FCF profile is now explicitly negative.
...
*Sources: [CNBC](https://www.cnbc.com/2026/04/29/amazon-amzn-q1-earnings-report-2026.html), [Motley Fool transcript](https://www.fool.com/earnings/call-transcripts/2026/04/29/amazon-amzn-q1-2026-earnings-call-transcript/), [Sherwood News](https://sherwood.news/markets/amazon-q1-2026-earnings-report-guidance-aws-cloud-ai-boom/), [Investing.com transcript](https://www.investing.com/news/transcripts/earnings-call-transcript-amazons-q1-2026-results-exceed-expectations-93CH-4647388), Apr 29 2026; [Amazon Q1 2026 10-Q](https://www.sec.gov/Archives/edgar/data/1018724/000101872426000014/amzn-20260331.htm); [FT](https://www.ft.com/content/b3dfaba9-17a2-4fac-90fe-4ab3ca7c9494), May 8 2026.*
