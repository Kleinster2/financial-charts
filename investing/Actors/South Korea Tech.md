...
aliases: [Korea Tech]
---
#actor #sovereign #tech #korea #memory

**South Korea Tech** — Memory semiconductor powerhouse. Samsung + SK Hynix. Chaebol-driven.
...
| GDP | $1.7T |
| Memory market share | ~60% (Samsung + SK) |
| Tech strategy | Chaebol-led |
...
| Chaebol | Tech Focus |
|---------|------------|
| Samsung Group | Memory, foundry, displays |
| SK Group | Memory (SK Hynix), telecom |
| LG Group | Displays, batteries, EVs |
| Hyundai | EVs, robotics |

Samsung + SK = global memory duopoly.
...
- $19B+ subsidies
- Tax incentives
- Fab investment support
- National priority

Memory = national security.
