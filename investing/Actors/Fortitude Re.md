---
aliases: [Fortitude Reinsurance, FortitudeRe]
---
...
## Why Fortitude Re matters

| Metric | Value |
|--------|-------|
| Total assets | $106B (Dec 2024) |
| Reserves managed | $101B (general + separate account) |
| Policies administered | 4M+ |
| Carlyle AUM from Fortitude | ~$22B committed + ~$75B advisory |
| HQ | Bermuda |
| CEO | — |
...
**Closed-book reinsurance specialist:**
- Acquires in-force blocks of life and annuity liabilities from primary insurers
- Manages the run-off — optimizing assets against known liability profiles
- Carlyle manages the investment portfolio for spread income

**Advisory relationship with Carlyle:**
- ~$22B committed capital allocated across Carlyle funds
- ~$75B advisory mandate (Carlyle directs asset allocation)
- New advisory agreement (2025) expected to add $50B fee-earning AUM to Carlyle
...
Modeled on [[Athene]]'s ACRA — a [[Reinsurance sidecars|reinsurance sidecar]] that multiplies deployable capital using third-party investors.
...
| Date | Deal | Value |
|------|------|-------|
| 2025 | Taiyo Life annuity reinsurance | $4B |
| 2025 | Unum deal | Multi-billion (contributing >$20B new AUM) |
| 2025 | FCA Re launch | $700M+ capital |
