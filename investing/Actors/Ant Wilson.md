...
#actor #founder #uk #developer-tools

**Ant Wilson** — CTO & Co-founder of [[Supabase]], the $5B open-source Firebase alternative. From Liverpool. Tried startups for 10 years before Supabase clicked. Based in Singapore.
...
|--------|------|------------|
| [[Paul Copplestone]] | CEO | Product, full-stack |
| Ant Wilson | CTO | Distributed systems, infra |

Met living together in Singapore during Entrepreneur First accelerator.
...
### Company
- [[Supabase]] — CTO, co-founded

### Co-founder
- [[Paul Copplestone]] — CEO, pitched him on Supabase

### Accelerator
- Entrepreneur First — where co-founders met (Singapore)

### Context
- [[Vibe coding]] — Supabase infrastructure benefits from trend
