...
aliases: [ANTO]
---
#actor #mining #copper #chile #uk #public

**Antofagasta** — Chilean copper pure-play. Luksic family controlled. London-listed. Clean copper exposure.

---

## Why Antofagasta matters

Antofagasta is a quality pure-play:
...
**Cleanest copper pure-play** on London market.
...
| Asset | Notes |
|-------|-------|
| Los Pelambres | Flagship, expansion underway |
| Centinela | Two open-pits |
| Antucoya | Heap leach |
...
**Bull:**
- Pure-play copper (no distractions)
...
| Risk | Impact |
|------|--------|
| Higher royalties | Margin compression |
| Water restrictions | Operational constraints |
| Community opposition | Project delays |
| Constitutional reform | Uncertainty |

All Chilean miners face this — not unique to Antofagasta.
...
| Phase | Status |
|-------|--------|
| Desalination plant | Operating |
| Concentrator expansion | Construction |
| Capacity increase | +60K tons/year |
| Completion | 2025-2026 |

**Key growth driver** for next 2 years.
