...
Originally planned as 2026 spin-off IPO — SoftBank swooped in.

**Why SoftBank wants it:**
- Masayoshi Son's robotics vision
- Combines with Arm, Boston Dynamics investments
- AI + robotics convergence play
...
| Segment | Focus |
|---------|-------|
| Electrification | Power distribution, EV charging |
...
**Bull (core ABB ex-robotics):**
- Electrification growth (EV, grid)
- $5.4B cash from SoftBank deal
- Focused portfolio post-sale
