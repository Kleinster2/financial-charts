...
---
#actor #ai #search #usa #private

**Perplexity** — AI search engine. $20B valuation. 780M queries/month. Challenging Google.

---

## Why Perplexity matters

The AI-native Google challenger:
...
**Comet browser (Oct 2025):**
- AI-native web browser
- Async task delegation
- "Can boost productivity so companies won't have to hire more people" — CEO
...
**No ads** — different from Google model.
...
**Bull:**
- AI search paradigm shift
- 780M queries = traction
- NVIDIA/Bezos backing
...
- OpenAI competing
- $20B = high bar
- Revenue still small vs valuation
