---
aliases: [ULVR, UL, Unilever PLC]
---
#actor #consumer #beauty #food #uk #public
...
| Segment | Revenue | Growth | Key brands |
|---------|---------|--------|------------|
...
## Beauty & Wellbeing — the growth engine

| Component | Revenue | Growth | Notes |
|-----------|---------|--------|-------|
| Hair Care | ~€5B | Mid-single-digit | TRESemmé, Dove Hair |
| Skin Care | ~€3B | Mid-single-digit | Vaseline, Dove |
| **Prestige Beauty** | ~€2.5B | Mid-single-digit | Hourglass, Tatcha, Paula's Choice, K18 |
| Health & Wellbeing | ~€2.5B | — | Vitamins, supplements |

**Prestige Beauty + Wellbeing = ~30% of Beauty & Wellbeing revenue.**
...
| Metric | Value |
|--------|-------|
| Revenue | ~40% of Personal Care (~€5.8B) |
| Growth (2024) | High-single-digit |
| Categories | Body care, hair, deodorant, skin |
| Positioning | "Real Beauty" campaign, mass-market premium |

Dove is one of the world's largest beauty brands by revenue.
...
| Detail | Value |
|--------|-------|
| Transaction | Demerger (listing in Amsterdam, London, New York) |
| Timeline | By end of 2025 |
| Revenue | €7.9B |
| Brands | Ben & Jerry's, Magnum, Wall's, Talenti |
| Rationale | Focus remaining company, unlock value |

After separation, Unilever will be ~€53B revenue, more focused on beauty/personal care/home.
...
**Bull:**
- Beauty & Wellbeing +6.5% — above-market growth
- Prestige portfolio (Hourglass, Tatcha) growing double-digits
- Dove mega-brand with pricing power
- Ice Cream separation simplifies story
- ~3% dividend yield, defensive characteristics
- K18 acquisition adds biotech haircare growth

**Bear:**
- Conglomerate discount — too many categories
