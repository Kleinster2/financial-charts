...
**Complementary, not competing** — founders choose based on whether company is software-heavy or hardware-heavy.

---

## Why AI startups choose Hangzhou

### Talent pipeline
- Zhejiang University (ZJU) — top CS/AI program
- Alibaba alumni — product, engineering, data infrastructure
- Engineers who prefer Hangzhou lifestyle over Beijing/Shenzhen
...
### "Culture of patience"
- Investors tolerate longer development cycles
- Local officials accept experimentation
- Less pressure for short-term monetization
- Critical for AI/robotics where payoffs come years later
...
|---------|----------|--------|
| [[Alibaba]] | E-commerce, cloud | Public (HQ) |
...
## Liangzhu: The indie AI scene

Beyond frontier labs, Hangzhou has an indie AI hub in [[Liangzhu]] suburb:
...
**Business model:** Chinese dev costs + hardware supply chain → global consumer prices.

---

## Investment implications

**Not directly investable** as a geography, but:
- [[Alibaba]] — public, Hangzhou HQ
...
- [[Alibaba]] — anchor company (e-commerce, cloud)
- [[DeepSeek]] — AI models (R1)
- [[Unitree]] — robotics (quadruped)
- [[Liangzhu]] — indie AI suburb
- [[China AI clusters]] — context (compute infrastructure)
- [[China power advantage]] — context (power for AI)
- [[Shenzhen]] — peer hub (hardware focus)
