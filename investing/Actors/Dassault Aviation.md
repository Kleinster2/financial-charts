---
aliases: [Dassault, AM.PA]
---
#actor #defense #france #public

**Dassault Aviation** — French aerospace icon. Rafale fighter (export success), Falcon business jets. Family-controlled.
...
| Metric | Value |
|--------|-------|
| Ticker | AM.PA (Euronext Paris) |
| Market cap | ~€30B |
| Revenue | ~€6B |
| Employees | ~13,000 |

Dassault family controls ~60%. Also owns 26% of Thales.
...
|---------|---------------|-------|
| Defense | ~70% | Rafale fighter |
| Civil | ~30% | Falcon business jets |
...
- FCAS 6th gen lead
- Falcon recovery (post-COVID)
- Family ownership = long-term focus
- Thales stake value

**Bear:**
- Rafale cycle peaking?
- FCAS delays/cost overruns
...
| P/E | ~20x |
| Operating margin | ~12% |
| Net cash | Significant |
| Backlog | Multi-year Rafale orders |

Best margins among European defense (fighter economics).
...
Owns 26% of [[Thales]]:
- Defense electronics synergy
- Rafale systems integration
