...
Wang Xingxing — founder and CEO of [[Unitree]]. Net worth $2.15B (Bloomberg Billionaires Index, Feb 2, 2026) — #1 among [[China AI billionaires|China's AI machinery billionaires]].
...
## Origin story: the engineering obsession
...
- "We optimized everything from mechanical structure to control algorithms, and kept key hardware and supply chain under our control."
...
Wang's DNA is engineer-founder, not MBA-founder. The company reflects this: relentless cost optimization, vertical integration, fast iteration, and a "good enough at 1/10th the price" philosophy that mirrors [[DJI]]'s disruption of the drone market. He holds 34.76% of [[Unitree]] as controlling shareholder.

## Recognition

- TIME100 AI (2025).
- Front row at [[Xi Jinping]]'s business symposium (Jan 2025), youngest entrepreneur there, seated near [[Ren Zhengfei]].
- Met Xi weeks after [[Unitree]]'s 2025 Spring Festival Gala performance.
...
- [[Unitree]] — company
- [[China AI billionaires]] — Bloomberg ranking (#1 AI machinery)
- [[Shanghai University]] — education
- [[DJI]] — first job (quit after two months)
- [[Boston Dynamics]] — idol/competitor ([[Marc Raibert]])
