---
aliases: [CART, Maplebear]
---
#actor #delivery #grocery #usa #public

**Instacart** — Grocery delivery leader. 1,500+ retailers. Advertising platform. IPO Sep 2023.
...
| **Instacart+** | Subscription ($99/year) |
| **Advertising** | CPG brand ads |
...
|--------|-------|
| Ad revenue | $1B+ |
| Growth | High-margin segment |
| Advertisers | CPG brands |
| Model | Sponsored products, display |

**Thesis:** Advertising transforms unit economics.
...
- 1,500+ retailer relationships
- Instacart+ subscription stickiness
- Grocery delivery leader
...
|--------|-------|
| Ticker | CART |
| Partners | 1,500+ retailers |
| Key growth | Advertising |
| Focus | Grocery delivery |
