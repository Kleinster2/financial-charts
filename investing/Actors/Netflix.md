...
| Era | Model | Margin |
|-----|-------|--------|
| DVD (2000s) | Mail rental | Profitable |
| Streaming (2010s) | Subscription | Investing |
| Content (2015+) | Original production | Improving |
| Ads (2022+) | Hybrid model | Expanding |
| Live (2024+) | Events, sports | New |
...
| Metric | Status |
|--------|--------|
| Ad tier subs | 40M+ MAU |
| Ad ARPU | Higher than basic |
| Growth rate | Fastest tier |
| Advertisers | Premium brands |

Ad-supported tier driving subscriber and revenue growth.
...
| Category | Approach |
|----------|----------|
| Originals | $17B annual spend |
| Licensed | Selective |
| Local language | 50%+ non-English |
| Live events | NFL, WWE, boxing |
...
| Application | Impact |
|-------------|--------|
| Recommendations | 80%+ of viewing |
| Personalized thumbnails | Per-user artwork |
| Content analytics | Greenlight decisions |
| Encoding | Per-title optimization |

Netflix is fundamentally an AI recommendation company.
...
| Announced | 2022 |
| Rolled out | 2023 |
| Impact | Accelerated sub growth |
| Churn | Lower than feared |

Successful execution added millions of paying subscribers.
...
| Content | Status |
|---------|--------|
| NFL Christmas games | 2024 deal |
| WWE Raw | 2025 start |
| Boxing events | Ongoing |
| Comedy specials | Live events |

Expanding beyond on-demand to live programming.

---

## Competitive position

| vs. Competitor | Netflix advantage |
|----------------|-------------------|
| [[Disney]] | Scale, no legacy business |
| [[Amazon]] | Pure-play focus |
| [[Apple]] | Content volume |
| Max/Paramount | Financial stability |
