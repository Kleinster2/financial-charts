...
**ConocoPhillips** — Largest US independent E&P. Pure upstream focus. Permian, Alaska, international assets.
...
**No refining or retail** — spun off Phillips 66 (2012).

Pure exploration & production:
- Lower breakeven than integrated majors
...
**Alaska North Slope mega-project:**
- ~180,000 bpd peak production
- $8B+ development cost
- Approved 2023 (after legal battles)
- First oil expected ~2029

Controversial but significant growth driver.
...
| Priority | Approach |
|----------|----------|
| Returns | 30%+ CFO to shareholders |
| Buybacks | Multi-year program |
| Dividend | Growing, variable component |
| M&A | Bolt-on acquisitions |

Known for shareholder-friendly approach.
...
- Pure upstream leverage
- Willow growth optionality
