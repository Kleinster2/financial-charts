...
| Employees | ~950 |
| ARR | ~$340M |
| Last valuation | $6.1B (Nov 2025) |
| Acquirer | [[ServiceNow]] |
| Acquisition price | $7.75B cash |
| Deal multiple | 23x ARR |
...
Critical infrastructure focus — serves companies, governments, hospitals, and industrial environments where OT security is paramount.
...
|------|------|------------|
| CEO & Co-founder | Yevgeny Dibrov | Israeli cybersecurity veteran |
| CTO & Co-founder | Nadir Izrael | Israeli cybersecurity veteran |

Founded in 2015 in Israel, emerged as leader in agentless device security — particularly strong in OT environments where installing agents is impractical or impossible.
...
OT/IoT security is increasingly critical as:
- Industrial systems connect to networks
- Medical devices proliferate in healthcare
- Critical infrastructure faces nation-state threats
- AI agents need identity/access controls

Armis fills a gap [[ServiceNow]] couldn't build organically — real-time asset discovery across non-traditional IT environments.
...
- [[ServiceNow]] — acquirer
- [[Sequoia]] — investor
- [[CapitalG]] — investor ([[Google]] ventures)
- [[Insight Partners]] — investor
- [[Israel]] — HQ location
- [[Cybersecurity]] — category
- [[AI agents]] — context (autonomous security)
