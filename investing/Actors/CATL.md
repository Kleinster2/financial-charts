---
aliases: [Contemporary Amperex Technology]
---
...
| Year | Tesla % of CATL revenue |
|------|------------------------|
| 2021 | 10% |
| 2022 | 11.6% |

CATL seen as leader in LFP (lithium iron phosphate) technology — Tesla's preferred chemistry for standard range vehicles.
...
**2026 launches:**
- **[[Sodium-ion batteries]]** — large-scale availability by end of 2026
- Battery swapping, passenger vehicles, commercial vehicles, energy storage applications

**LFP dominance:**
- Lower cost vs NMC
- No cobalt/nickel dependency
- Tesla Model 3/Y standard range use CATL LFP
...
- Technology moat (LFP, sodium-ion)
- Tesla/VW/[[BMW]] locked in
- Energy storage growth (grid-scale)
- Vertical integration

**Bear:**
- [[China]] exposure (tariffs, geopolitics)
- Pricing pressure from BYD
- Western localization costs
