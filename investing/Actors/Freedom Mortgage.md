---
aliases: [Freedom Mortgage Corporation]
---
...
| Channel | Description |
|---------|-------------|
| **Retail** | Direct-to-consumer origination |
| **Wholesale** | Fund broker-originated loans |
| **Correspondent** | Buy closed loans from originators |
| **Bulk acquisition** | Buy loan portfolios |
| **Servicing** | Collect payments, manage escrow |

**Strategic focus:** Grow servicing portfolio through correspondent and bulk channels. Servicing provides stable income regardless of rate environment.
...
| Metric | Value |
|--------|-------|
| Production volume | $122B |
| Borrowers helped | 316,000+ |
| Loan modifications/partial claims | 50,000 |
| Servicing portfolio | $625B |
| Homeowners serviced | 2.5M |
...
| Role | Person |
|------|--------|
| Founder, President, CEO | Stanley C. Middleman |

Middleman founded Freedom Mortgage in 1990. Over 30 years in mortgage banking. Author of "Seeing Around Corners" (2024).
...
**Signals to watch:**
- VA/FHA market share trends
- Government loan policy changes
- MSR acquisition activity
- Non-bank regulatory environment
...
- [[Pennymac]] — correspondent competitor
- [[Navy Federal Credit Union]] — VA loan competitor
- [[Ginnie Mae]] — securitizes FHA/VA loans
- [[Fannie Mae]] — STAR performer award
