...
**Schlumberger (SLB)** — World's largest oil services company. Global footprint, technology leader. Venezuela rebuild beneficiary.
...
SLB trades as a core Energy name (XLE r = 0.79).

---

## Why Schlumberger matters
...
| Segment | Description |
|---------|-------------|
| Digital & Integration | Software, data, integrated projects |
| Reservoir Performance | Wireline, testing, stimulation |
| Well Construction | Drilling, completions |
| Production Systems | Subsea, surface, midstream |
...
- SLB has global project management expertise
- Can handle large-scale infrastructure rebuild
- Technology advantage in mature field revitalization
...
- International exposure (less US shale dependent)
- Digital/tech differentiation
- Venezuela + Middle East upside
