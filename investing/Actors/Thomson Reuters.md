...
aliases: [TRI]
---
#actor #finance #media #data #legal #canada #public

**Thomson Reuters** (NYSE/TSX: TRI) — Information and news company. Dominant in legal (Westlaw) and tax software. Sold financial data business to create [[Refinitiv]] (2018), retains stake in [[London Stock Exchange Group]].
...
| Revenue (2024) | $7.26B |
| Employees | ~26,000 |
| LSEG stake | ~15% (from Refinitiv sale) |

---

## Business segments ("Big 3")

| Segment | Description | Growth (2024) |
|---------|-------------|---------------|
| **Legal Professionals** | Westlaw, legal research | +8% organic |
| **Corporates** | Compliance, legal ops | +8% organic |
| **Tax & Accounting** | Tax software, audit | +8% organic |

**"Big 3" = 80%+ of revenue**, growing 8-9% organically.
...
- $1B share buyback authorized (Aug 2025)
- 10% dividend increase (2025)

---

## History

**2008: Thomson + Reuters merger**
Thomson Corporation (Canadian media) acquired Reuters Group (British news) for $17B, creating Thomson Reuters.

**2018: Refinitiv carve-out**
Sold 55% of Financial & Risk business to [[Blackstone]] for $17B, creating [[Refinitiv]]. Thomson Reuters retained 45%.

**2021: LSEG acquisition of Refinitiv**
[[London Stock Exchange Group]] acquired Refinitiv for $27B. Thomson Reuters received LSEG shares, now owns ~15% of LSEG.

**2025: AI pivot**
Investing heavily in AI for legal/tax:
- **CoCounsel** — AI legal assistant
- **CoCounsel for Tax** — AI tax/audit tool
- Acquired SafeSend ($600M) for tax automation
...
- [[RELX]] — competitor (LexisNexis)
- [[Financial data industry]] — former core business

*Sources: [Thomson Reuters IR](https://www.prnewswire.com/news-releases/thomson-reuters-reports-fourth-quarter-and-full-year-2024-results-302370057.html), [Stock Analysis](https://stockanalysis.com/stocks/tri/)*
