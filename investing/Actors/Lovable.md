...
| ARR | **$200M+** (Nov 2025) |
| Total raised | $500M+ |
| Projects created | 25M+ |
| GitHub stars | 50K+ (GPT Engineer) |
...
|--------|------|------------|
| **[[Anton Osika]]** | CEO | Created GPT Engineer |
| **[[Fabian Hedin]]** | CTO | Built Hawking's interface, KTH |

### Origin story

1. **June 2023:** Osika launches GPT Engineer (open source CLI)
2. Becomes one of GitHub's fastest-growing projects ever — 40K stars in 2 months
3. **Nov 2024:** Relaunches with GUI as commercial product
4. **Dec 2024:** Renames to "Lovable"
...
Users describe what they want in natural language → Lovable generates full working application using AI models (OpenAI, [[Anthropic]]).
...
## What makes Lovable work

### The GPT Engineer flywheel

```
Open source (50K stars) → Developer trust →
Commercial launch → Revenue →
Better product → More users
```

**Key insight:** Open source created massive awareness and credibility before commercial launch.
...
|-----------|----------------|
| Open source origins | Trust, community, awareness |
| European base | Less competition than US |
| Full-stack output | Not just code snippets — working apps |
| Supabase default | Backend friction removed |
...
### Ecosystem
- [[Supabase]] — default backend (auto-provisioned)
- [[Vercel]] — peer (v0 competitor)
...
### Concepts
- [[Vibe coding]] — category/trend (Karpathy coined term, $24B market by 2031)

---

Sources:
- [TechCrunch - Series B announcement](https://techcrunch.com/2025/12/18/vibe-coding-startup-lovable-raises-330m-at-a-6-6b-valuation/)
- [CNBC - $6.6B valuation](https://www.cnbc.com/2025/12/16/ai-startup-lovables-round-values-it-at-6point6-billion-sources.html)
- [Sacra - Lovable profile](https://sacra.com/c/lovable/)
