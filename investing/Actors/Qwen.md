---
aliases: [Tongyi Qianwen, 通义千问, Qwen3]
---
#actor #product #ai #china

**Qwen** (通义千问) — [[Alibaba]]'s AI model family. **100M+ MAU** (Jan 2026). Fastest-growing AI app globally (+149% Nov 2025). Open source leader — 30% of global AI usage from Chinese open models (Qwen + [[DeepSeek]]).
...
Alibaba's bet on open source paying off — fastest growth in the market.
...
Alibaba undercutting everyone on price while open-sourcing the models.
...
**Alibaba's thesis:** Sacrifice short-term API revenue for global adoption.
...
|----|---------------|--------------|
| [[Doubao]] | Open source, enterprise | Less consumer distribution |
| [[DeepSeek]] | Alibaba resources, multimodal | Less efficiency cred |
| [[ChatGPT]] | Price, open weights | Brand, global reach |
