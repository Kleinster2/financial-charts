...
| Metric | Value |
|--------|-------|
| Parent | [[Baidu]] (59% stake) |
| Valuation | ~$3B (21B CNY) |
| Revenue (2025) | $500M |
| Status | Break-even |
| IPO filing | Jan 2, 2026 (confidential) |
...
**2030 goal**: Million-chip cluster capability.
...
| Date | Milestone |
|------|-----------|
| 2012 | Founded as internal Baidu unit |
| 2018 | First Kunlun chip announced |
| 2020 | Kunlun 1 production |
| 2021 | Kunlun 2 (7nm) |
| 2024 | Independent operations |
| 2026 | HK IPO filing |

Started as Baidu's internal project to support search, cloud, and AI workloads.
...
**The trade-off**: Worse performance, but actually available.

---

## Export control beneficiary

Kunlunxin exists because of [[Export controls]]:
...
- HK IPO unlocks value
- JPMorgan: 6x revenue growth to 2026

**Bear:**
- Far behind NVIDIA performance
- Manufacturing constraints (SMIC process limits)
- Competition from Huawei Ascend
- Ecosystem development costs
- Geopolitical risk (further restrictions)
...
- [[Export controls]] — Creates demand
