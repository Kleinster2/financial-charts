...
BPTRX holds SpaceX across multiple series (Series H, I, N), purchased at split-adjusted ~$15-30/share, now marked at ~$135/share:

| Series | Shares (BPTRX) | Weight |
|--------|----------------|--------|
| SpaceX (largest tranche) | 2,216,310 | 9.63% |
| SpaceX | 311,111 | 13.52% |
| SpaceX | 131,657 | 5.72% |
| SpaceX | 302,210 | 1.31% |
| SpaceX | 44,146 | 1.92% |
| Total (BPTRX) | ~3,005,434 | ~32.10% |

### [[Tesla]]

| Metric | Value |
|--------|-------|
| Shares (BPTRX) | 6,455,000 |
| Weight (BPTRX) | 29.96% |
...
| Metric | Value |
|--------|-------|
| Shares (BPTRX) | 1,997,055 (across two tranches: 1,665,754 + 331,301) |
| Weight (BPTRX) | 1.56% |
| Firm-wide investment | ~$350M |
| Current value | ~$700M (2x) |
...
| Expense ratio                  | 2.00%                  |
| Annualized return (since 2003) | 17.7%                  |
| SpaceX + Tesla combined        | ~62% of net assets     |

Primary vehicle for retail [[SpaceX]] exposure. SpaceX weighting ballooned from ~4% (2017, ~$20B valuation) to ~32% as valuation grew to ~$800B. On Dec 4, 2025, an updated SpaceX valuation roughly doubled the position's mark — fund returned 19% in a single day.

Baron classifies SpaceX as "less-liquid" rather than illiquid under [[Rule 22e-4]], citing active secondary market trading and SpaceX's consistent share repurchasing. This skirts the [[SEC]]'s 15% cap on illiquid securities. The [[SEC]]'s 2022 proposed amendments would eliminate the "less liquid" category — if adopted, BPTRX would need to divest or seek exemptive relief.

#### BPTRX top holdings (Dec 31, 2025)
...
| IDXX | [[IDEXX Laboratories]] | 620,000 | 4.33% |
| FDS | [[FactSet]] | 1,300,000 | 3.89% |
| IT | [[Gartner]] | 1,230,000 | 3.20% |
...
| Tesla allocation | 7.6% |

#### BFGIX top holdings (Jan 31, 2026)
...
| Baron Technology | BCTK | Technology |
...
- [[SpaceX]] — largest holding (~$10B, ~3M shares in BPTRX)
- [[Tesla]] — 30x return, 6.5M shares in BPTRX
- [[xAI]] — $350M investment, ~2M shares in BPTRX
- [[Elon Musk]] — primary founder alignment (~65% of Ron Baron's personal wealth)
- [[Rule 22e-4]] — SEC liquidity rule; Baron's "less liquid" classification for SpaceX
- [[SEC]] — regulator
