---
aliases: [良渚, Langju, Liangzhu Village]
---
#actor #ecosystem #china #hangzhou

**Liangzhu (良渚)** — Hipster suburb of Hangzhou. Indie AI developer hub. "Villagers" building quirky consumer AI apps. Ground zero for AI's lifestyle side.
...
- Chinese big tech refugees
- Indie developers
- Aspiring entrepreneurs
- "Villagers" (self-identification)

**The appeal:**
- Low commercial pressure
- Creative, free lifestyle
- Sense of camaraderie
- Cheap to prototype ("1,000 RMB to demo")
- Inclusive — don't need unicorn ambitions
...
**The arbitrage:** Chinese development costs + hardware supply chain → global consumer prices.
...
- Now draws founders and backers from region
- Growing visibility
...
- [[Hangzhou]] — parent city
- [[DeepSeek]] — same city, different tier (frontier)
- [[Alibaba]] — same city, hyperscaler
- [[China AI Tigers]] — contrast (frontier vs indie)
- [[Consumer AI]] — product category
