...
| Metric | Value |
|--------|-------|
| Data centers | 8 complexes (5 São Paulo, 3 Rio) |
| Investment pace | R$1B+/year historically; R$1.5B+ committed in last 12 months |
| Expansion projects | 4 simultaneous (out of 52 globally) |
| President | Vitor Arnô |
| Key expansion | SP4 in Santana do Parnaíba (6th São Paulo facility) |

---

## Footprint

**São Paulo (5 → 6 facilities):**
- 5 existing data center complexes
- 6th inaugurating in **Santana do Parnaíba** (SP4 expansion — so large it's practically a new facility adjacent to the existing one)
- 3 São Paulo data centers being expanded simultaneously
...
## $74M São Paulo investment (Feb 2026)

Equinix announced a **$74 million** (~R$400 million) investment in one of its São Paulo data centers, part of a broader acceleration driven by AI demand.
...
**Water efficiency:**
- Modern Equinix data centers **do not use water for cooling**
- Water usage limited to bathrooms and administrative areas
- When water is used, it's **recycled treated wastewater**
- Important for sustainability narrative and community acceptance

---

## REDATA regulation

REDATA is a regulatory package critical to Brazil's data center and AI positioning. Created by the **Ministério da Fazenda** (Finance Ministry) and **Ministério de Desenvolvimento e Indústria** (Development & Industry Ministry) in collaboration with industry associations.

**The problem:**
- **40% of Brazilian enterprise workloads run in Brazil; 60% run abroad** (Fazenda stat)
- Primary reason: **high import taxes on data center equipment**
- Structural cost inefficiency makes Brazil uncompetitive vs. other markets
...
- **Urgency approved** (procedural step)
- Full approval still pending
...
## Data center economics (Brazil context)

| Parameter | Detail |
|-----------|--------|
| Construction time | 1-2 years (varies by site/terrain) |
| Time to fill (multi-tenant) | 5-10 years |
| Time to fill (single hyperscaler) | ~2 years |
| Architecture | Hybrid — edge + core, complementary |
...
- Example: you wouldn't send laptop data to a satellite for processing and back
...
- Key message: **regulatory stability** is the single biggest unlock for attracting long-term capital
- Equinix committed R$1.5B+ even without REDATA — imagine what happens with it
...
- [[Equinix]] — parent company (EQIX, largest DC REIT globally)
- [[REDATA]] — Brazilian regulatory package for data center competitiveness
- [[Auren Energia]] — renewable energy partner (wind PPA in Nordeste)
- [[Fortaleza]] — submarine cable hub, strategic connectivity node
