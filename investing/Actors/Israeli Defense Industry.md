---
aliases: [Israel defense industry, Israeli defence industry]
---
#actor #industry #defense #israel

**Israeli Defense Industry** — Battle-tested technology leader. Dominates missile defense, drones, cyber. Unique combat experience drives innovation.
...
|--------|--------------|-------|
| Hermes 900/450 | Elbit | Tactical/MALE |
| Heron | IAI | MALE |
| Harop | IAI | Loitering munition |

### Other

| Category | Key systems |
|----------|-------------|
| Tanks | Merkava (world-class protection) |
| Missiles | Spike (anti-tank), Delilah (cruise) |
| Cyber | Unit 8200 alumni startups |
| EW | Advanced jamming, SIGINT |
...
| Factor | Detail |
|--------|--------|
| Combat testing | Constant real-world validation |
| Innovation cycle | Battlefield → factory fast loop |
| Talent pipeline | IDF tech units → industry |
| US relationship | Joint development, funding |
| Existential focus | Defense = survival |
...
| Factor | Detail |
|--------|--------|
| State ownership | Rafael, IAI government-controlled |
...
- Global drone/EW leader
- Beneficiary of rearmament
...
- [[Defense]] — sector hub
- [[Israel]] — country actor
- [[Golden Dome]] — US adopting Israeli-style defense
