...
**Zoox** — Amazon's robotaxi. First purpose-built AV in public service. SF/Vegas live. Paid service 2026.
...
|--------|-------|
| Parent | [[Amazon]] |
| Acquired | 2020 for ~$1.3B |
| Fleet | **50 robotaxis** (SF + Vegas) |
| Status | **Public service** (free, paid 2026) |
| Milestone | **1M+ autonomous miles** |

**First in US:** Purpose-built autonomous vehicle in public service.
...
**SF neighborhoods:** SoMa, Mission District.

Currently **free rides** — commercial exemption pending.
...
| Passengers | 4 |
| Max speed | 75 mph |
| Battery | **130 kWh** (larger than competitors) |
| Direction | Bidirectional |
| Design | Symmetrical, no steering wheel |

**Advantage:** Bigger battery = fewer daily charges = more uptime vs retrofitted competitors.
...
| Las Vegas | **Public service** |
| Austin | Testing planned |
| Miami | Testing planned |
| Atlanta, LA, Seattle, DC | Highlander SUV testing |

**Co-founder vision:** "Most major US cities by end of decade."
...
| Issue | Detail |
|-------|--------|
| Software recall | Dec 2025 — vehicles stopping in traffic |
| Regulatory | Commercial exemption still pending |
| Scale | 50 vehicles vs Waymo's 700+ |
| Edge cases | Autonomous driving "long tail" |
...
|--------|-------|
| Price | ~$1.3B (2020) |
| Pre-acquisition funding | $990M (2014-2020) |
| Strategy | Kept independent |
| Synergy | TBD (logistics, delivery potential) |
...
- First paid ride (SF or Vegas)
- Fleet expansion beyond 50
- Additional city launches
- Commercial regulatory approval

**Bull case:** Amazon logistics integration, 10K vehicle production.
**Bear case:** Regulatory delays, Waymo/Tesla lead widens.

---

## vs Competition

| Competitor | Fleet | Vehicle | Status |
|------------|-------|---------|--------|
...
**Part of Amazon:**
- Tiny % of AMZN market cap
- Optionality on $450B+ TAM
- Watch for paid service launch
- Manufacturing scale = signal
...
| Acquired | ~$1.3B (2020) |
| Fleet | 50 robotaxis |
| Status | Public service (free) |
| Paid service | H2 2026 target |
...
- [TechCrunch: Vegas public launch](https://techcrunch.com/2025/09/10/zoox-opens-its-las-vegas-robotaxi-service-to-the-public/)
