...
**Merck** — Keytruda dominance. $25B+ cancer drug. Patent cliff 2028. Vaccines (Gardasil).
...
| Market position | #1 cancer drug globally |
| Patent expiry | 2028 (US) |

**The cliff:** Keytruda is ~40% of Merck revenue. 2028 expiry is existential.
...
| Approach | Detail |
|----------|--------|
| Subcutaneous Keytruda | New formulation for extended exclusivity |
| Label expansion | More indications |
| Combinations | ADCs, other modalities |
| M&A | Pipeline acquisition |
...
|-------|------------|--------|
| MK-2870 | ADC (HER2) | Phase 3 |
| V116 | Pneumococcal vaccine | FDA approved |
| Sotatercept | PAH | Approved |
...
**Bull:**
- Keytruda peak not reached
- Gardasil growth runway
- M&A filling pipeline
- Strong cash flow for deals

**Bear:**
- 2028 patent cliff looming
- 40% revenue concentration
- Biosimilar competition coming
- M&A execution risk
