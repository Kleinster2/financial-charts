...
| 3-year return | **+11%** (70pts below S&P 500) |
| Phase 3 pipeline | **80 treatments** |
...
**80 treatments in Phase 3** clinical trials (last step before approval).
...
|----------|-------------|
| **2026** | HIV, diabetic macular edema, ulcerative colitis |
| **2027** | Influenza, various cancers |
