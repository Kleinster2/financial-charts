...
aliases: []
---
#actor #sovereign #semiconductor #japan #government

**Japan Semiconductor Revival** — $50B+ government investment. Rapidus, TSMC fabs. National strategy.
...
| Metric | Value |
|--------|-------|
| Government investment | $50B+ planned |
| Key project | [[Rapidus]] |
| TSMC fab | Kumamoto |
| Goal | Regain semiconductor leadership |
...
| Challenge | Risk |
|-----------|------|
| Talent shortage | Engineers lacking |
| Rapidus timeline | Very aggressive |
| Cost overruns | Likely |
| Competition | TSMC/Samsung ahead |
...
**Japan revival = tailwinds for:**
- Tokyo Electron (equipment)
- Screen Holdings (equipment)
