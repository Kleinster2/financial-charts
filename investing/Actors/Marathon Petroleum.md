...
| Refinery | Capacity | Crude type |
|----------|----------|------------|
| Galveston Bay (TX) | ~600K bpd | Heavy capable |
...
| Segment | Description |
|---------|-------------|
| Refining | Largest US, 13 refineries |
| Midstream | MPLX partnership (pipelines, terminals) |
| Retail | Speedway sold to 7-Eleven (2021) |
...
Most diversified refiner geographically.
...
- [[Gulf Coast refiners]] — peer group
- [[Valero]] — peer (largest independent)
- [[Phillips 66]] — peer
