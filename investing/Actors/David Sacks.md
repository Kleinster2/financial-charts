...
First "czar" for both AI and crypto.
...
|--------|----------|
| 2016 | Anti-Trump |
| 2020-2022 | COVID skeptic, shifted right |
| 2024 | Trump donor, surrogate |
| 2025 | Administration role |

All-In Podcast = platform for political views.
...
| Fact | Detail |
|------|--------|
| Co-hosts | Chamath, Jason, Friedberg |
| Launch | 2020 |
| Audience | Tech/finance |
| Influence | Significant in tech circles |
...
Panel with [[Michael Kratsios]] (US CTO), moderated by Maria Bartiromo. Sacks's most detailed public articulation of Trump administration AI policy.

### US winning the AI race
...
- "No such thing as a dark GPU right now" — every GPU deployed is generating tokens
- Not a dot-com/dark fiber repeat — demand is real (chatbots, coding assistants)
- Infrastructure buildout added ~2% to US GDP growth rate in 2025 (helped reach 4-5%)
- Expects similar contribution in 2026
- [[Oracle]], [[Blackstone]] making huge investments — "very savvy market players" who see ROI
...
- Biden administration had made behind-the-meter generation impossible as policy — had to be part of larger grid
- Secretary Wright (DOE) + FERC reformed those regulations
- Trump's vision: "Let AI companies become power companies"
- Sacks argues DCs will actually BRING DOWN rates:
  ...
  - "The more scale you get in electricity, the price comes down"

### Regulatory philosophy

- Over 1,200 AI bills going through state legislatures — "knee-jerk reaction"
- Patchwork most detrimental to early-stage companies and entrepreneurs (big guys can navigate 50 different rules)
- Working on lightweight federal standard — needs 60 Senate votes (bipartisan)
- States would keep: child safety, data center permitting
- "Can't replace something with nothing" — pushback requires offering federal standard
- Rescinded 100-page Biden executive order + 200-page Biden diffusion rule in first week
- Silicon Valley's magic = "permissionless innovation" — since HP 85 years ago
- Biden regulations would have changed to "go to Washington to get approval for your idea"
...
- Phase 1: AI chatbots (better web search, research)
...
- Simple test: if in 5 years American chips and models are everywhere, we won; if Huawei chips and DeepSeek models, we lost
- Silicon Valley companies become huge by creating ecosystems (most apps in app store, most developers on API)
...
- About a year ago (early 2025), [[DeepSeek]] "put Chinese AI on the map"
- Before DeepSeek, complacency in the West about relative position
- Global competition wasn't even discussed 2 years ago
- After DeepSeek: realized we're in a competition, must win, must be careful about overregulation

### AI risks: Orwellian misuse by government
...
- Elon is a friend, slight disagreement
- Full Musk view includes abundance: everyone has what they want, no money (people leave out this part)
- Sacks: Elon "directionally correct" — heading toward greater abundance, rising living standards, productivity
- Will lead to rising wages, won't put everyone out of work
- Timelines matter — world with no money not in next 5 years
- Star Trek comparison (no money because abundance)
...
*Created 2026-01-16. Updated 2026-01-23.*
