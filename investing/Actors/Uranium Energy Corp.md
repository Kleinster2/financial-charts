...
|---------|----------|--------|
| Hobson | Texas | Operating |
| Palangana | Texas | Operating |
| Christensen Ranch | Wyoming | Restarting |
| Multiple others | US | Development |

ISL = environmentally preferred, lower cost.

---

## US uranium strategic value
...
US has near-zero uranium production historically. UEC is changing that.

---

## Competitive position

| vs Competitors | UEC position |
|----------------|--------------|
| vs [[Cameco]] | Smaller but US-based |
| vs [[Kazatomprom]] | Higher cost but no geopolitics |
| vs Ur-Energy | Similar size, competitor |
