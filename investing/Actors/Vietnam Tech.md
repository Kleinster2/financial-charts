...
aliases: []
---
#actor #sovereign #tech #vietnam #manufacturing

**Vietnam Tech** — Manufacturing relocation winner. Samsung's largest factory. Rising tech hub.
...
**Largest Samsung factory globally:**

| Metric | Value |
|--------|-------|
| Investment | $20B+ |
| Employment | 100,000+ |
| Production | 50%+ of Samsung phones |
| Facilities | Multiple provinces |

Samsung's most important production base.

---

## Electronics manufacturing

| Company | Vietnam Presence |
|---------|------------------|
...
**Test and assembly:**
- $1.5B+ investment
- Largest Intel test facility
- Chipset assembly
- Expanding capacity

Intel's strategic APAC site.
...
**Vietnamese EV maker:**
- VinGroup subsidiary
- Listed on NASDAQ (VFS)
- EV manufacturing
- Global ambitions

Vietnam's EV champion.
...
- FPT Semiconductor (chip design)
- NVIDIA partnership announced
- $2B+ government investment planned
- Targeting IC design
...
NVIDIA sees Vietnam opportunity.
...
| Initiative | Focus |
|------------|-------|
| Data centers | Growing capacity |
| Power grid | Expansion needed |
| Industrial parks | Electronics focus |
