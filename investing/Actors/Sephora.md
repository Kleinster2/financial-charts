---
aliases: [Sephora LVMH]
---
#actor #beauty #retail #france #private
...
| Metric | Value |
|--------|-------|
| Parent | [[LVMH]] (Selective Retailing) |
| Global retail sales (2023) | ~$16B |
| E-commerce (2024) | ~$3.4B |
...
## Financial performance (via LVMH reporting)

| Metric | 2022 | 2023 | 2024 |
|--------|------|------|------|
| Global retail sales | $14.5B | $16B | ~$17B+ |
| LVMH Selective Retailing revenue (€M) | — | ~16,700 | ~17,600 |
| Growth | — | — | +6% organic |
| Profitability | — | — | Double-digit profit growth |

**Sephora was the standout performer** within LVMH in 2024, driving Selective Retailing while luxury fashion/leather was flat.

---

## US expansion

| Channel | Scale | Performance |
|---------|-------|-------------|
...
| Factor | Detail |
|--------|--------|
| **LVMH ownership** | Access to Dior, Givenchy, Fenty first |
| **Exclusive brands** | Sephora Collection + exclusives |
| **Prestige positioning** | Pure prestige, no mass dilution |
| **Beauty Insider** | Loyalty program, personalization |
| **Experiential retail** | Services, classes, discovery |
| **Global scale** | 2,700+ stores, 35+ countries |
...
**Not directly investable** (LVMH subsidiary), but matters for:
- [[LVMH]] valuation — Sephora is a key growth driver, may be worth $30-40B standalone
- [[Ulta Beauty]] competitive pressure
- Beauty industry distribution dynamics
- Fragrance category growth (Sephora = key channel)
