...
| Book | Year | Subject | Awards |
|------|------|---------|--------|
| *Statistics and the German State* | 2001 | German economic knowledge | Philip Leverhulme Prize (2002) |
| *The Wages of Destruction* | 2006 | Nazi war economy | Wolfson History Prize, Longman History Today Prize |
| *The Deluge* | 2014 | WWI and global order 1916-1931 | LA Times Book Prize (History), Kirkus Prize finalist |
...
4. Environment (climate change blowing back)
...
| Factor | Impact |
|--------|--------|
| Shale gas | Fundamentally changed US electricity economics |
| QE / zero rates | "No one benefited more from that epic period of public intervention than the fossil block" |
| Gas vs oil | Gas stays domestic (pipelines), oil flows to global pool—gas remade US power generation |
...
| Metric | Figure |
|--------|--------|
| Coal consumption | Three phases of human history: prehistory, Western industrialism, then China in one generation |
| Air pollution deaths | 1.4 million/year (early 2010s) vs ~500K in US over 30 years |
| Ultra-supercritical plants | China: vast majority; US: one |
...
|---------|---------------|---------------|
| Solar panels | 1,200 GW/year production capacity | 250 GW total installed |

"China can increase America's total installed solar capacity five-fold in a single year."

### The IRA verdict

"Swiss Army knife politics"—a desperate emergency policy, dancing in a telephone booth.

| Aspect | Assessment |
|--------|------------|
| Scale | Needed to be much bigger for real effect |
| Design | Highly functional given constraints |
| PR | "Head-turning, mind-blowing demonstration"—both US ("America will save the planet") and EU ("we're so abject, we need a state like theirs") |
| Durability | Failed to future-proof like ACA; didn't change enough of society |
| Post-Trump | "May have burnt the boats" on this approach |

### AI convergence in the Gulf
...
### Actors
- [[Federal Reserve]] — frequent subject of analysis, especially independence debates
- [[Jerome Powell]] — Fed chair whose tenure Tooze has chronicled
- [[China]] — electrostate archetype, green manufacturing dominance
- [[EU]] — laboratory of green modernization (failed)
- [[NVIDIA]] — AI chips meeting Chinese solar in Gulf

### Concepts
- [[Fed independence]] — tracks politicization as assault on technocratic norms
- [[Inflation]] — core theme in post-COVID analysis
- [[De-dollarization]] — structural consequence of Fed credibility loss

### Think tanks he cites
- [[Ember]] — British energy think tank, maps global renewable investment
- Net Zero Industrial Policy Lab — tracks Chinese green investment flows

### Key concepts
- [[Electrostate]] — electrification as governance type (his framing)
