...
| Ticker | DASH |
| Market cap | ~$70B |
| US delivery share | **~65%** |
| Total orders | 600M+ quarterly |
| Focus | Food, grocery, retail delivery |
...
| Segment | Description |
|---------|-------------|
| **Marketplace** | Consumer orders |
| **DashPass** | Subscription (~$10/month) |
| **Drive** | White-label delivery |
| **Wolt** | International (acquired) |
...
| Subscribers | 15M+ |
| Price | ~$10/month |
| Benefits | Free delivery, reduced fees |
| Retention | Strong |
...
- DashPass subscription stickiness
- Grocery/retail expansion
- Wolt international growth
- Path to profitability improving

**Bear:**
- Low margins in delivery
- Uber Eats competition
- Regulatory risk (gig worker)
- Consumer discretionary exposure
- High valuation vs profits
