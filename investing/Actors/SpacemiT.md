...
|-------|------|--------|-------------------|
| **Series B** | Jan 2026 | 600M yuan ($86M) | Huaxia Hengtian Capital |
| Series A+ | Jan 2025 | Several hundred M yuan | Brizan Ventures (lead) |
| Earlier | 2021-2024 | Undisclosed | — |

### Series B investors (Jan 2026)
...
| Shipments | **150,000+ units** |
| Use cases | Industrial, robotics, edge, AI devices |

**Significance:** One of first Chinese RISC-V chips to reach meaningful production scale.
...
| Competitor | Focus |
|------------|-------|
| **Alibaba T-Head** | Server-grade XuanTie |
| **VeriSilicon/Nuclei** | RISC-V IP |
| **StarFive** | RISC-V SoCs |
| **Sophgo** | AI chips |

SpacemiT positioned in industrial/edge vs Alibaba's server focus.
...
| Risk | Detail |
|------|--------|
| **Private** | No public equity access |
| **Competition** | Alibaba, VeriSilicon better resourced |
| **Ecosystem** | RISC-V software still maturing |
| **Export risk** | US could restrict RISC-V tools |
...
- VeriSilicon — RISC-V IP, acquiring Nuclei
- StarFive — RISC-V SoCs
...
- Bloomberg: SpacemiT Series B (Jan 2026)
- Company statement
