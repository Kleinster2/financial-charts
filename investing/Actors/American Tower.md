...
aliases: [AMT]
---
#actor #company #reit #infrastructure #usa #public

**American Tower** — Largest global tower REIT. NYSE: AMT. 220K+ towers worldwide. 5G infrastructure play.
...
Largest tower company globally.
...
| Metric | Value |
|--------|-------|
| Tenancy ratio | ~1.9x (US) |
| Churn | ~2% |
| Escalators | 3% annually |
| AFFO yield | ~3% |
...
| Factor | Effect |
|--------|--------|
| Small cells | New revenue stream |
| Densification | More equipment per tower |
| Mid-band | Tower amendments |
...
### Peers
- Crown Castle — US peer
- SBA Communications — peer
