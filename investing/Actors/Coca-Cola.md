...
aliases: [KO, Coke]
---
#actor #beverage #consumer #usa #public

**Coca-Cola** — Global beverage leader. Coke, Sprite, Fanta. Bottler model. Dividend aristocrat.
...
| Dividend years | 62+ consecutive increases |
...
| Feature | Detail |
|---------|--------|
| Concentrate model | Sell syrup to bottlers |
| Bottler relationships | Coca-Cola Consolidated, etc. |
| Asset-light | High margins |
| Global distribution | Unmatched reach |
...
| Initiative | Status |
|------------|--------|
| Zero sugar variants | Growing |
| Smaller packages | Price/mix positive |
| Reduced sugar | Reformulation |
| Portfolio expansion | Beyond soda |
