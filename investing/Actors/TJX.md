---
aliases: [TJX Companies, TJ Maxx, Marshalls, HomeGoods]
---
...
| Ticker | TJX (NYSE) |
| Market cap | ~$130B |
| Revenue (FY25, ended Feb 2025) | $56.4B |
...
|--------|------|------|------|
| Revenue ($B) | 49.9 | 54.2 | 56.4 |
| Revenue growth | +3% | +9% | +4% |
| Comp store sales | +1% | +5% | +4% |
| Net income ($B) | 3.5 | 4.5 | 4.9 |
| EPS ($) | 3.00 | 3.86 | 4.26 |

Consistent comps, expanding margins, steady EPS growth.

---

## Store portfolio

| Banner | Stores | Geography | Category |
|--------|--------|-----------|----------|
...
| Advantage | Detail |
|-----------|--------|
| **Buying power** | Buys excess inventory from brands at 40-60% off |
| **Treasure hunt** | Changing inventory creates urgency, repeat visits |
| **Low marketing** | Word-of-mouth, no heavy ad spend |
| **Real estate flexibility** | Second-tier locations, low rent |
| **Inventory turn** | High velocity, low markdown risk |

**Why it works:** Brands need liquidation channels. Department stores declining means more excess inventory. Value-seeking consumers = secular tailwind.

---

## Competitive position

| Factor | TJX | Ross Stores | Burlington |
|--------|-----|-------------|------------|
| Revenue | $56B | $21B | $10B |
...
- Tariffs could reduce brand overproduction
