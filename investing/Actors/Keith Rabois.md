...
Rare: Both successful operator AND investor.
...
|-----------|-------------|
| **Operational** | Helps with execution |
| **Concentrated** | Fewer, deeper bets |
| **Board seats** | Active involvement |
| **Miami** | Moved, evangelizes |
...
|------|--------|
| Moved | 2020 |
| Advocacy | "Miami is the new SF" |
| Investments | Local startups |
| Impact | Part of tech migration |
...
|--------|-------|
| Net worth | ~$1B+ |
| Current | Founders Fund |
| Style | Operator-investor |
| Key wins | DoorDash, Affirm |
