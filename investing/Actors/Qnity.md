---
aliases: [Qnity Electronics, Q, DuPont Electronics]
---
 #actor #semiconductor #materials #usa #public #photoresist

**Qnity** — Pure-play electronics materials company spun from [[DuPont]] in November 2025. Trades as "Q" on NYSE. Two-thirds of portfolio tied to semiconductors.
...
|--------|-------|
| Ticker | Q (NYSE) |
| Spin-off date | November 1, 2025 |
| 2024 revenue | $5.93B (as DuPont Electronics) |
| 2024 EBITDA | $1.72B (29% margin) |
| Employees | 10,000+ |
| Manufacturing sites | 39 worldwide |
| TAM | >$30B |
...
| Product | Notes |
|---------|-------|
| **EUV photoresists** | Arizona facility for High-NA EUV |
| **ArF/KrF** | Mature but stable |
...
- Supports High-NA EUV ramp
- 300mm wafer line capacity

---

## 2024-2025 performance (as DuPont E&I)

| Metric | 2024 | YoY |
|--------|------|-----|
| Net sales | $5.93B | +11% |
| Operating EBITDA | $1.72B | +17% |
| EBITDA margin | 29.0% | +150bps |
| Semiconductor sales | — | +20%+ |

**Q4 2024:** $1.51B revenue, 30.3% EBITDA margin.
...
**Bull:**
- Pure-play post-spin (no DuPont conglomerate discount)
- US-based supply chain diversification value
- 29%+ EBITDA margins
...
- Currency headwinds (global operations)
- Cyclical semiconductor demand
- Competition from entrenched Japanese suppliers
- Post-spin execution risk

---

## DuPont residual

After the spin, DuPont (DD) retained:
- Water & Protection segment
- Industrial Solutions
- Corporate overhead

Qnity took the high-growth electronics business.

---

## Sustainability angle

**July 2025:** Launched bio-based solvent photoresists
- 40% carbon footprint reduction
- No performance compromise
- Targets automotive electronics initially
...
- Index fund rebalancing (added to S&P 500 day one)
- Small-cap effect (Q ~$6B vs DD ~$30B)
- Potential opportunity if undervaluation persists

| Date | Price | Notes |
|------|-------|-------|
| Nov 1, 2025 | ~$95 | Spin-off |
| Nov 15, 2025 | ~$75 | Post-spin low (-21%) |
| Jan 16, 2026 | ~$97 | Recovery |
