...
|-----------|-------------|
| **NCM 9½½** | High nickel, low cobalt |
| **NCM 811** | Standard high-performance |
| **LFP** | Developing for cost segment |

**Differentiator:** High-nickel chemistry leadership.
...
| Profitability | Losses (heavy investment phase) |
| IPO | Planned but delayed |
| Parent support | SK Innovation backing |
...
|---------|------------|----------|
| Georgia Commerce | $2.6B | Operating |
| Georgia Jackson County | $2.6B | Operating |
| BlueOval SK Kentucky | $5.8B | Operating |
| BlueOval SK Tennessee | $5.6B | 2025 |

Total US investment: ~$16B+
...
- Persistent losses
- Delayed IPO
- LG settlement overhang
- Execution risk on capacity buildout
...
- [[LG Energy Solution]] — Korean competitor
- [[Samsung SDI]] — Korean competitor
- [[Ford]] — BlueOval SK partner
- [[South Korea Tech]] — regional context
