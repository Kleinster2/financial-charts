...
**Series D investors:** [[Georgian Partners]] (lead), [[G Squared]], [[Prysm Capital]], [[Coatue]], [[a16z]], [[Craft Ventures]], [[Y Combinator]], [[Accenture]] Ventures, Okta Ventures, [[Databricks]] Ventures. Angels: Shaquille O'Neal, Jared Leto.
...
**Enterprise customers:** Zillow, Labcorp, Atlassian, PayPal, Adobe. Ranked among fastest-growing software platforms on Ramp (Mar 2026).
...
AI coding agent that builds full applications from prompts. Key differentiator vs [[Cursor]]: runs entirely in browser, no local setup. **Agent 4** (launched Mar 2026) combines design and code in a single environment — users move from concept to working software.
