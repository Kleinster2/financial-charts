---
aliases: [Global Atlantic Financial Group, GAFG]
---
#actor #finance #insurance #retirement #usa

**Global Atlantic** — [[KKR]]'s wholly-owned insurance and retirement services platform. One of the largest US fixed annuity providers, serving 2M+ policyholders. The Athene equivalent in KKR's ecosystem — permanent capital engine funding private credit deployment.

---

## Why Global Atlantic matters

| Metric | Value |
|--------|-------|
| Parent | [[KKR]] (100% owned since Jan 2024) |
| Total assets | >$200B (estimated, contributing to KKR's $1.3T AUM) |
| Annual originations | $36B (up from $17B at acquisition) |
| Operating earnings | >$1.2B annually |
| Policyholders | 2M+ |
| Products | Fixed rate annuities, fixed indexed annuities, life, reinsurance |
| HQ | Bermuda (Global Atlantic Financial Group Limited) |
...
| Jan 2024 | KKR acquired remaining 37% for $2.7B all-cash |
| 2025 | Contributing >$1.2B operating earnings to KKR |

---

## Strategic role within KKR

Same playbook as [[Athene]] for [[Apollo]]:
1. Global Atlantic collects long-duration insurance liabilities (annuity premiums, PRT)
2. KKR manages the float — deploying into [[Private credit]], infrastructure, real assets
...
- [[KKR]] — parent (100% owner since Jan 2024)
- [[Athene]] — direct peer and competitor (Apollo's platform)
- [[Reinsurance sidecars]] — capital structure enabling scale
- [[Private credit]] — primary asset class for deployed float
- [[Blackstone]] — competitor via F&G partnership
