...
Announced June 15, 2026: [[Fox Corporation]] agreed to acquire Roku in a definitive cash-and-stock merger. Both boards approved.

| Term | Detail |
|------|--------|
| Acquirer | [[Fox Corporation]] |
| Offer | $160.00/Roku share, ~28% premium to June 10 close |
| Cash component | $96.00/share |
| Stock component | 0.9693 FOXA (Class A) shares/Roku share (≈$64 at $66.03 FOXA 10-day VWAP, June 10) |
| Enterprise value | ~$22B |
| Equity value | ~$25B |
| Mix | ~60% cash / ~40% FOXA equity |
| Pro forma ownership | FOX holders ~73% / Roku holders ~27% of combined |
| Cost synergies | ~$400M run-rate; FCF/share accretive by 2nd full year post-close |
| Expected close | H1 2027 |
| Rationale | Fox gains Roku's CTV platform (44% of US connected-TV hours; 100M+ households) |

The ~$25B equity value reprices Roku from independent CTV platform to the distribution arm of a combined Fox-Roku media entity — projected \#3 in US television by share of viewing, ahead of [[Paramount Skydance]] and [[Netflix]]. Each Roku share converts to $96 cash plus 0.9693 FOXA shares, so ~40% of the consideration floats with the FOXA price — the realized value is not fixed at $160. [[Roku]] shares held roughly flat into the terms (they had run up on deal rumors the prior week), while [[Fox Corporation|Fox]] fell ~17–18% on debt-and-dilution concerns ($8.3B new debt + 152M new Class A shares) — a ~−10σ idiosyncratic move on near-zero market beta, the day's largest single-name dislocation (see [[Fox Corporation]]).
...
|--------|-------|
| Ticker | ROKU |
| Standalone equity value (pre-deal) | ~$12B |
| Streaming households | 100M+ (crossed April 2026) |
| Streaming hours | 38.7B (Q1 2026, +8% YoY) |
| Revenue (FY2025) | ~$4.6B |
| Revenue (Q1 2026) | $1.25B (+22% YoY) |
...
| Metric | Value |
|--------|-------|
| ARPU | ~$41/household (TTM, low-single-digit growth) |
| Platform revenue (Q1 2026) | $1.13B (+28% YoY) |
| Subscriptions revenue (Q1 2026) | $519M (+30% YoY), 41.1% gross margin |
...
|--------|-------|-----|
| Total net revenue | $1.25B | +22% |
| Platform revenue | $1.13B | +28% |
...
## Standalone dynamics (the break case)
...
|--------|-------|
| Ticker | ROKU |
| Status | Pending acquisition by [[Fox Corporation]] ($160/share, close H1 2027) |
| Streaming households | 100M+ |
| Model | Platform/ads + subscriptions |
| Key metric | Platform revenue growth (~28% YoY) |
...
- [[Netflix]] — content partner; combined Fox-Roku would rank ahead by US viewing share
...
- [Fox Corporation — press release: Fox to Acquire Roku, Inc. (2026-06-15)](https://www.foxcorporation.com/news/corp-press-releases/2026/fox-corporation-to-acquire-roku-inc/)
- [CNBC — Fox to buy Roku for $22 billion (2026-06-15)](https://www.cnbc.com/2026/06/15/fox-to-buy-roku.html)
- [Hollywood Reporter — Fox to Acquire Roku in $22 Billion Deal (2026-06-15)](https://www.hollywoodreporter.com/business/business-news/fox-acquires-roku-streaming-tech-deal-lachlan-murdoch-1236621853/)
- [Hollywood Reporter — Roku beats expectations after passing 100M streaming households (Q1 2026)](https://www.hollywoodreporter.com/business/business-news/roku-q1-2026-earnings-1236581264/)
