...
**Total raised:** ~$2.2B equity + $2B DOE loan = **$4B+ total capital**
...
|----------|----------|----------|
| **HQ + Campus** | Carson City, Nevada | 100 GWh target (2025) |
| **South Carolina** | Charleston | Under construction |

**2030 target:** 500 GWh capacity (enough for 5M EVs/year)
...
| Valuation | **$6B** (Oct 2025) |
| Total capital | ~$4B (equity + DOE loan) |
| Capacity target | 100 GWh (2025), 500 GWh (2030) |
| Recovery rate | 95%+ of critical minerals |
| IPO status | Private (expected eventual IPO) |
...
- [Bloomberg on $6B valuation](https://www.bloomberg.com/news/articles/2025-10-23/redwood-materials-tops-6-billion-valuation-in-new-funding-round)
- [Redwood Materials Series C announcement](https://www.redwoodmaterials.com/news/series-c-funding-700-million/)
- [Wikipedia](https://en.wikipedia.org/wiki/Redwood_Materials)
