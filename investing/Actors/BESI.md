---
aliases: [BE Semiconductor, BESI.AS]
---
...
| Metric | Value |
|--------|-------|
| Ticker | BESI.AS (Amsterdam) |
| Market cap | ~€15B |
| Focus | Die attach, bonding equipment |
| Revenue | ~€800M |
...
| Segment | Products |
|---------|----------|
| **Die Attach** | Flip chip, die bonding |
| **Packaging** | Molding, trim & form |
...
- No solder bumps needed
- Higher density interconnects
- Key for 3D stacking (HBM4+)

**BESI positioned for hybrid bonding wave.**
...
| Company | Focus |
|---------|-------|
| **BESI** | Die attach, hybrid bonding |
| [[ASE]], [[Amkor]] | OSAT (use BESI equipment) |
| ASMPT | Packaging equipment |
| Kulicke & Soffa | Wire bonding |
...
- Cyclical with packaging capex
- Competition from ASMPT
