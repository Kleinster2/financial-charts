...
**Deep AI infrastructure background:**
...
> "It happened in a very clear relationship you could fit with a physics equation, E equals MC squared kind of equation, a one-parameter equation."

Discovered deep learning systems scale predictably — foundational insight for modern AI scaling laws.

---

## MLPerf / MLCommons

**Co-founded MLPerf:** Industry standard benchmark for deep learning performance.

**MLCommons:** Engineering consortium creating standard benchmarks for AI models and hardware. Diamos co-founded.

**Impact:** Enables fair comparison of AI hardware/software — essential for enterprise procurement decisions.
