---
aliases: [LimeBike, Lime Micromobility]
---
#actor #micromobility #transport #pre-ipo
...
3. **City relationships** — Long-term permits in 280+ cities create a regulatory moat; new entrants face 1-2 year permitting cycles
...
| Year | Gross bookings | Net revenue | Adj. EBITDA | Rides | Fleet |
|------|---------------|-------------|-------------|-------|-------|
| 2021 | ~$350M | — | Negative | — | — |
| 2022 | $466M | — | $15M | — | — |
| 2023 | ~$620M | $520M | $94M | ~155M | ~225K |
| 2024 | $810M | $686M | $140M+ | 200M+ | 270K+ |
...
- Tracxn current estimate: $1.7B
- At 10x 2024 EBITDA ($140M): ~$1.4B
- At 15x EBITDA (growth premium for 30%+ topline): ~$2.1B
- At 3x revenue ($686M): ~$2.1B

**Bull case for IPO:** Only profitable micromobility company globally. 30%+ revenue growth with expanding margins. Proven operating model in 280 cities. Rides growing 30% YoY. Goldman's Ben Frost calls 2026 a "pivotal year" for IPOs — best pipeline since 2021.

**Bear case:** E-bike maintenance costs remain high (battery replacements). Regulatory risk (Paris banned shared scooters via referendum, 2023). Seasonal demand drops 50%+ in winter markets. Still private — limited financial transparency.
...
**Moat:** Regulatory permits + Uber integration + fleet density. New entrants face multi-year permitting in most major cities.
...
|------|----------|--------|
| **Regulatory bans** | High | Paris referendum banned scooters 2023; could spread |
| **E-bike maintenance** | Medium | Battery replacements + vandalism = high variable cost |
| **Seasonality** | Medium | Northern markets lose 50%+ ridership in winter |
| **Uber dependency** | Medium | Uber is both investor and demand channel — misaligned incentives possible |
| **IPO market** | Low-Medium | If 2026 IPO window closes, stuck private at unclear valuation |
...
- [[Micromobility]] — concept: shared model economics, boom-bust history
- [[Lyft]] — competitor in US bikes/scooters
- [[Uber]] — strategic investor, demand channel
