...
| Sector | Leaders | Constraint |
|--------|---------|------------|
| IT services | [[TCS]], [[Infosys]], Wipro | Talent retention |
| Pharma | Generic drug powerhouse | API dependence on [[China]] |
| Infrastructure | [[Larsen & Toubro]], cement, steel | Execution, funding |
...
Chip access as geopolitical tool — US controls 75% of AI supercomputing clusters, China 15% ([[Epoch AI]]). India's relationship with the US on chip access is critical to its AI ambitions.
