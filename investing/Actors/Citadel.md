...
|------|--------|
| Net worth | ~$40B |
| Started | Trading from dorm room |
| Politics | Major GOP donor |
| Real estate | $1B+ in properties |
| Miami | Moved HQ from Chicago |
...
|--------|-------|
| US equity share | ~25% |
| Options | Largest maker |
| Revenue (2022) | $7.5B |
| Employees | 2,500+ |

Executes ~40% of retail equity orders.
...
| Fund | Strategy |
|------|----------|
| Wellington | Flagship multi-strat |
| Tactical Trading | Rates, macro |
| Equities | L/S equity |
| Global Fixed Income | Rates |

Pod shop structure with strict risk limits.
