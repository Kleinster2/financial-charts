...
| Company | Focus |
|---------|-------|
| [[GoTo]] | Super-app (Gojek + Tokopedia) |
...
- Sea Group's SeaBank
- Akulaku
- Growing digital lending

Underbanked population opportunity.
...
Island nation benefits from LEO satellite.
...
|--------|-------|
| Population | 275 million |
| Key player | GoTo (GOTO.JK) |
| SWF | INA ($20B+) |
| DC status | All hyperscalers present |
