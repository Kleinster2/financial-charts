...
> LEN does not trade tightly with any sector ETF (max r = 0.49 with KRE).
...
LEN trades between Regional Banks and Real Estate without a tight sector fit.

---

## Why Lennar matters

Second largest US homebuilder:
...
- Entry-level to move-up
- "Everything's Included" pricing
- Land-light strategy
- Mortgage (Lennar Mortgage)
- Title insurance
...
| Financial Services | Lennar Mortgage, title |
| Multifamily | Apartment development |
| Lennar Other | Technology ventures |
...
**Executive Chairman:**
- Long-time CEO (now Executive Chairman)
- Miller family = founders
- Acquisitive strategy
- CalAtlantic merger (2018)

---

## Trump housing ban (Jan 7, 2026)

Stock dipped on Trump's institutional homebuying ban announcement:
- Lennar sells some homes to rental operators
- Net impact unclear
...
**Bear:**
- Rate sensitivity
- Florida insurance costs rising
