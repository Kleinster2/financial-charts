...
| Segment | Description |
|---------|-------------|
| **Meetings** | Core video conferencing |
| **Phone** | Cloud PBX |
...
| Period | Status |
|--------|--------|
| Pre-COVID | Growing SaaS |
| 2020-21 | Explosive growth, $100B+ market cap |
| 2022-24 | Normalization, competition |
| Now | Stable enterprise focus |

Stock down 85%+ from peak.
...
|------------|-------------|
| Zoom AI Companion | Meeting summaries, chat |
| Smart recordings | Searchable transcripts |
| Virtual agents | Contact center AI |
