...
**iShares MSCI EAFE ETF** — developed markets ex-US and Canada. Europe, Australasia, Far East.
...
[[Developed ex-US equities]] proxy. SPY vs [[EEM]] vs EFA in the dashboard compares the three major equity regions. EFA vs [[SPY]] spread shows US exceptionalism (or its reversal).

## Related

- [[Developed ex-US equities]] — the asset class
