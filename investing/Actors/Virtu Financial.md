...
| Ticker | VIRT (NYSE) |
| Business | Market making, execution |
| HQ | New York |
...
|------|--------|
| Net worth | ~$3B |
| Background | NYMEX chairman |
| NHL | Owns Florida Panthers |
| Politics | Trump cabinet nominee (withdrew) |
...
| Segment | Description |
|---------|-------------|
| Market making | Equities, options, FX, crypto |
| Execution services | Agency trading |
| Technology | Trading infrastructure |
...
| Asset classes | Equities, options, FX, crypto |
...
## IPO and track record

| Year | Event |
|------|-------|
| 2015 | IPO |
| Claim | Only 1 losing day (pre-IPO) |
| Reality | HFT volatility dependence |
