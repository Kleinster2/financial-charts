...
| **Malaysia** | 34M | $370B | Electronics, palm oil |
| **Singapore** | 6M | $400B | Finance, trade hub |
...
| Goal | Status |
|------|--------|
| Free flow of goods | Mostly achieved |
| Free flow of services | Partial |
| Free flow of investment | Partial |
| Free flow of capital | Partial |
| Free flow of skilled labor | Limited |

**Not a customs union:** Each member has own external tariffs.
...
| Concept | Meaning |
|---------|---------|
| **ASEAN centrality** | ASEAN at center of regional architecture |
| **ASEAN way** | Consensus, non-interference |
| **Convening power** | Hosts RCEP, ARF, EAS |

ASEAN punches above weight diplomatically — convenes larger powers.
...
| Country | Theme |
|---------|-------|
| **Vietnam** | Manufacturing, [[Nearshoring thesis]] |
...
| Challenge | Issue |
|-----------|-------|
| **Myanmar** | Coup, sanctions, ASEAN credibility |
| **South China Sea** | China claims vs members |
| **Development gaps** | Singapore ($65K GDP/cap) vs Cambodia ($1.7K) |
| **Integration limits** | Not customs union |
| **Consensus** | Slow decision-making |
...
- [[RCEP]] — ASEAN-centered mega-regional
- [[China-ASEAN FTA]] — key trade link
