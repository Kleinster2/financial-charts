...
aliases: [ASAN]
---
#actor #company #saas #productivity #usa #public

**Asana** — Work management platform. NYSE: ASAN. Founded by Facebook co-founder. Founded 2008.
...
Founded by Dustin Moskovitz (Facebook co-founder).
...
|------|-------------|
| **Basic** | Free tier |
| **Premium** | SMB ($11/user/mo) |
| **Business** | Mid-market ($25/user/mo) |
...
Controls company via dual-class shares.
...
| Issue | Detail |
|-------|--------|
| Growth slowdown | From 50%+ to 10%+ |
| Competition | Monday, Atlassian |
