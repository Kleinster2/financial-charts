#thesis #trade #infrastructure #datacenter

# Long Datacenter Infrastructure

**Status**: Active — AI capex cycle driving demand
**Created**: 2026-01-06
...
| REIT | Focus | Market cap | Edge |
|------|-------|------------|------|
| [[Equinix]] | Interconnection | ~$80B | Network density moat |
| [[Digital Realty]] | Hyperscale | ~$50B | Wholesale scale |
| [[Coresite]] (AMT) | Colocation | Subsidiary | Cloud on-ramps |
...
- [ ] Hyperscalers build in-house
- [ ] Interest rates spike (REIT pressure)
- [ ] Oversupply in key markets
- [ ] Power constraints ease faster than expected
...
*Review quarterly. Track leasing, power deals, and financing announcements.*
