#thesis #trade #energy #nuclear

# Long Nuclear

**Status**: Emerging — AI power demand validates nuclear
**Created**: 2026-01-06
...
Nuclear power is the only scalable, baseload solution for AI data center demand. Hyperscalers signing nuclear PPAs validates the thesis. 44GW power gap can't be closed without nuclear.

> "The grid left them on read" — hyperscalers turning to nuclear because utilities can't deliver.
...
- [ ] Nuclear PPAs cancelled or delayed
- [ ] Regulatory pushback on co-location
- [ ] SMR technology fails to scale
- [ ] Renewables + storage become cheaper than nuclear
- [ ] Grid expansion solves power gap faster than expected
...
|---------|--------------|
| [[Constellation Energy]] | Lower risk — existing fleet, contracted PPAs |
| [[Vistra]] | Medium risk — Texas exposure, nuclear + gas |
| [[Oklo]] | High risk — pre-revenue SMR play |
| [[Cameco]] | Medium risk — uranium commodity exposure |
...
*Review quarterly. Track PPA announcements and uranium prices.*

---

## Related

- [[Nuclear power for AI]] — mechanism (why nuclear for data centers)
