#thesis #trade #ai #agents #bullish
...
[[Agent harnesses]] are the layer where competitive moats form in the AI stack. As models commoditize, the harness — the infrastructure that makes agents actually work — captures the value.
...
**Key insight:** Better models make harnesses *more* important, not less. They let you rip out yesterday's "smart logic" and upgrade.
...
| [[Google]] | (building) | — | Windsurf team acqui-hire $2.4B |

**Pattern:** Every major AI lab now has a harness play. This is strategic, not optional.
...
- [x] Model providers launch harnesses (already happening)
- [x] Harness UX matters enough that users pay $200/mo extra to avoid official tools (OpenCode Black launch)

---

## What invalidates the thesis

- [ ] Models get good enough that harnesses unnecessary
- [ ] Framework layer captures value instead
- [ ] Open source harnesses emerge and win
- [ ] Agent adoption stalls
- [ ] Hyperscalers bundle harnesses free with cloud
...
**[[Long NVIDIA]]**: Harness adoption drives GPU demand.
