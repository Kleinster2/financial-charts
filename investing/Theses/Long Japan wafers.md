...
Every semiconductor starts as a silicon wafer:
- **Logic chips**: Cut from 300mm wafers
- **Memory**: Same 300mm wafers
- **Analog/automotive**: 200mm wafers
- **AI chips**: Larger dies = more wafer area per chip

No wafers = no chips. Period.
...
|---------|-------|--------|-------|
| [[Shin-Etsu]] | ~30% | 4063.T | Diversified (PVC, photoresists) |
| [[Sumco]] | ~25% | 3436.T | **Pure-play** |
| [[Siltronic]] | ~13% | WAF.DE | European, GlobalWafers bid blocked |
...
### AI chips consume more wafer area
...
- Servers +23% YoY
- Total wafer consumption +8% in 2025

### Fab buildout wave

Every new fab needs wafer supply:
- TSMC Arizona (2 fabs)
- Intel Ohio (2 fabs)
- Samsung Taylor
- [[Rapidus]] [[Japan]]
...
**Sumco**: Maximum leverage to wafer thesis, more volatile
**Shin-Etsu**: Diversified, also captures photoresist thesis, less volatile
...
- Shin-Etsu (4063.T) — wafers + photoresists + PVC hedge

**European alternative:**
- Siltronic (WAF.DE) — smaller, takeover optionality
...
| Scenario | Sumco (3436.T) | Upside |
|----------|----------------|--------|
| Base | ¥2,200 | +15% |
| Bull | ¥2,800 | +45% |
| Bear | ¥1,500 | -20% |

*Based on 12-15x forward earnings, wafer pricing trends*

---

## Related

- [[Sumco]] — primary pure-play vehicle
- [[Shin-Etsu]] — diversified alternative
- [[Siltronic]] — European player
- [[Semiconductor Materials]] — sector context
- [[Long Japan photoresists]] — complementary thesis
- [[Long WFE]] — equipment thesis
- [[Long memory]] — demand driver
- [[TSMC]], [[Samsung]], [[Intel]] — customers
- [[Japan Semiconductor Revival]] — national context

---

*Review quarterly. Update evidence log as wafer pricing and demand data come in.*
