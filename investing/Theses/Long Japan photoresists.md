...
- **Tacit knowledge**: 30+ years of R&D, process know-how
...
### EUV adoption accelerating

| Node | EUV layers | Status |
|------|------------|--------|
| 7nm | 5-10 | Production |
| 5nm | 10-15 | Production |
| 3nm | 20+ | Ramping |
| 2nm | 25-30+ | 2025-2026 |

More layers = more photoresist per wafer.

### High-NA EUV coming

- [[ASML]] shipping High-NA EUV tools (2024-2025)
- Requires new photoresist formulations
- Additional R&D moat for incumbents

### AI driving leading-edge demand

- Every AI chip ([[NVIDIA]] Blackwell, etc.) uses leading-edge nodes
- AI capex $300B+ annually from hyperscalers
- All flows through EUV lithography → photoresists

---

## The players

### Pure-play: Tokyo Ohka Kogyo (4186.T)

| Metric | Value |
|--------|-------|
| Market cap | ~¥500B (~$3.3B) |
| Global share | ~20-25% |
| EUV growth target | +35% (2024) |
| Valuation | ~15-18x forward earnings |
...
| Company | Ticker | Photoresist exposure | Other businesses |
|---------|--------|---------------------|------------------|
...
- [ ] EUV photoresist demand grows 20%+ annually
...
- Wafers + photoresists, double upstream exposure
- More liquid, larger cap (~$65B)
- PVC segment provides cyclical hedge

**US alternative**: Qnity (Q)
- USD-denominated
- Supply chain diversification angle
...
- Whoever wins needs photoresists
...
| Scenario | TOK (4186.T) | Upside |
|----------|--------------|--------|
| Base | ¥5,500 | +20% |
| Bull | ¥7,000 | +50% |
| Bear | ¥3,500 | -25% |

*Based on 18-22x forward earnings, 15-20% EPS growth*

---

## Related

- [[Tokyo Ohka Kogyo]] — primary vehicle
- [[JSR Corporation]] — market leader (private)
- [[Shin-Etsu]] — diversified alternative
- [[Qnity]] — US alternative
- [[Semiconductor Materials]] — sector context
- [[ASML]] — equipment chokepoint (complementary)
- [[Long WFE]] — related thesis
- [[Export controls]] — policy context
- [[Japan Semiconductor Revival]] — national strategy

---

*Review quarterly. Update evidence log as capacity expansions and demand data come in.*
