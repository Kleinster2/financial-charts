...
|--------|-------------|--------|
| Average price | $30-40K | $50-60K |
| Manufacturing cost | 30-50% lower | Baseline |
...
- Chinese OEM gets market access
...
Former US official warning: Ford JV would create "domino effect" forcing other US automakers into "forced marriage" with Beijing.

If Ford partners with Xiaomi:
- GM must respond (partner with BYD? Geely?)
...
|------|-------------|--------|
| Congressional legislation blocking JVs | Medium | High |
| National security review kills deals | Medium | High |
