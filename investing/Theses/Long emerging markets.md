...
**Long emerging markets** — EM supercycle thesis. Weak dollar, diversification demand, commodity stockpiling, new frontiers opening.
...
|--------|--------|
| Weak dollar | Present |
| Global growth | Benign |
| Diversification demand | Accelerating |
| Commodity stockpiling | New catalyst |
| New frontiers | Opening (Saudi, Venezuela) |

---

## Historical context

**Since 2010, EMs have not outperformed US for two consecutive years.**

2025 was stellar — but this pattern has held for 15 years. The thesis is that structural drivers are now different.
...
## Institutional backing: PIMCO

**Pramol Dhawan (PIMCO EM head):** "This is a playbook that will last for many years. We're not interested in taking chips off the table."

| Metric | Value |
|--------|-------|
| PIMCO EM fund 2025 return | **22%** (better than 90% of peers) |
...
**Fundamental shift:** Fiscal concerns rising in DM while EM showing discipline. Central bank independence questions now in US, not just EM.

---

## Catalyst 1: Commodity stockpiling

**Trump bellicosity → countries stockpile critical materials:**
...
## Catalyst 2: New frontiers opening

### Saudi Arabia market reforms (Jan 2026)
...
| Metric | Value |
|--------|-------|
| Current EM fund exposure | 60% |
| If 49% ownership limit removed | **$25B inflows** (most since 2019) |
...
| Current | Wall Street discussing restructuring |
| Post-Maduro | Regime change (Jan 2026) opens possibilities |

See [[Venezuela]] for full context.

---

## Catalyst 3: AI supply chain

**EM exposure to AI infrastructure:**
...
**EM as "bazaar" with something for everyone:**
...
| Type | Examples |
|------|----------|
| Broad EM | EEM, VWO, IEMG |
| Country-specific | EWZ (Brazil), ECH (Chile), EWY (Korea) |
| Frontier | FM, FRN |
| Commodity-linked | Individual miners |
...
- [[PIMCO]] — Institutional backer (22% return, $6.4B AUM)
- [[Venezuela]] — New frontier (debt restructuring potential)
- [[Saudi Arabia Tech]] — New frontier (market reforms)
- [[Chile]] — Commodity play (copper)
- [[Brazil]] — PIMCO favorite (local-currency bonds)
