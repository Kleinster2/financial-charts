...
- Sovereign AI avoiding US platform lock-in
- Acquirers needing decode capability

---

## Why Cerebras wasn't Groq'd

| Factor | Groq | Cerebras |
|--------|------|----------|
| Architecture | Many-chip rack | Wafer-scale (WSE) |
| NVLink fit | Easy integration | Harder — needs own rack |
| Benchmarks | Strong | Ahead of Groq (public) |

Cerebras's wafer-scale approach makes NVIDIA integration harder — which may preserve independence value.
...
- [ ] IPO prices at premium to private valuation
...
- [ ] Rubin SRAM outperforms significantly
- [ ] G42 concentration becomes liability
- [ ] IPO fails or prices poorly
- [ ] Wafer-scale yields disappoint
- [ ] No acquirer interest materializes
...
- Small position until liquidity event
- Watch IPO pricing closely
...
*Review at IPO. Watch for acquisition rumors and benchmark comparisons.*
