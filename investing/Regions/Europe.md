...
Regional hub for European markets.
...
- [[Dutch seizure of Nexperia]] — national security
- [[Export controls]] — ASML China restrictions
...
| Company | Sector |
|---------|--------|
| [[Siemens]] | Industrial automation, EDA |
...
| OEM | EV strategy |
|-----|-------------|
| VW | ID series, battery investments |
| BMW | iX, i-series |
| Mercedes | EQ lineup |

Challenge: [[BYD]] and Chinese EV competition.
...
|--------|-------|
| Market cap | ~$150B |
| Position | CPU architecture monopoly |
| AI angle | AI cores, edge compute |

See [[Arm Holdings]].

### Finance

London = global financial center, but post-Brexit challenges.
...
| Company | Focus |
|---------|-------|
| Dassault | Fighter jets, software |
...
LVMH, Hermès, Kering = global luxury dominance.
...
| Theme | Expression |
|-------|------------|
| Semiconductor equipment | ASML (monopoly) |
| European industrials | Siemens, Schneider |
| Defense spending | Dassault, Thales, Rheinmetall |
| Luxury | LVMH, Hermès |
| Green transition | Ørsted, Vestas, Northvolt |
...
| Challenge | Impact |
|-----------|--------|
| Energy costs | Industrial competitiveness |
| Regulation | Tech innovation slower |
| Demographics | Aging workforce |
| China exposure | German autos vulnerable |
| Defense underinvestment | NATO pressure |
