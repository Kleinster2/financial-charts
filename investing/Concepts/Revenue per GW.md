...
- [[OpenAI]]: $20B exit ARR at end-2025 on a 1.9 GW footprint — both company-disclosed (compute grew 0.2 GW 2023 → 0.6 GW 2024 → ~1.9 GW 2025) — gives $10.5B ARR/GW blended. Tang allocates the footprint ~60/40 inference/training, putting inference-allocated monetization at ~$22B/GW. Training capacity generates no revenue directly; whether that is overhead or the product depends on the slope of inference growth.
