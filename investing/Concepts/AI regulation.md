...
**AI regulation** — Emerging legal framework for AI systems. Three major laws effective 2026: EU AI Act (Aug), Colorado AI Act (Jun), California AI Transparency Act (Jan). Focus on high-risk systems, transparency, and disclosure.
...
| Aspect | EU AI Act | Colorado | California |
|--------|-----------|----------|------------|
| **Scope** | All AI systems | High-risk decisions | Content/transparency |
| **Approach** | Risk-based tiers | Consequential decisions | Disclosure-focused |
| **Penalties** | Up to 7% global revenue | TBD | $5K/day/violation |
| **Extraterritorial** | Yes (affects US companies) | State only | State only |
