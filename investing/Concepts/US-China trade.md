#concept #geopolitics #usa #china #trade #umbrella
...
| Category | US leverage | China leverage | Note |
|----------|-------------|----------------|------|
...
| **Minerals** | — | Ga, Ge, Sb, rare earths | [[Critical minerals]] |

Note: AI race ([[US-China AI race]]) is broader than trade — see Technology section in [[US-China relations]].

---

## Tariffs/policy

General tariff rates, Section 301 duties, trade deals.

| Current | Rate |
|---------|------|
| General rate | ~49% |
| Section 301 | 25-100% by product |
| Supreme Court | Ruling pending Jan 14 |
...
Export controls on chips, equipment, technology.

| US restricts | China response |
|--------------|----------------|
| EUV (total ban) | SMIC 7nm workarounds |
| AI chips (H100, Blackwell) | Stockpiling, Huawei Ascend |
| Design tools | Indigenous alternatives |
| VEU licenses | Case-by-case approval |
...
Fungible raw materials — US has weak cards.
...
Critical inputs — China has strong cards.

| Mineral | China share | Substitutes |
|---------|-------------|-------------|
| Gallium | 99% | Very limited |
| Germanium | 60% | Limited |
| Antimony | 48% | None (ammo) |
| Rare earths | 60%+ | Years to build |

See [[Critical minerals]], [[China retaliatory toolkit]].
