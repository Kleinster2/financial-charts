...
**AfCFTA** — African Continental Free Trade Area. World's largest FTA by country count. 1.3B people, 55 countries. In force 2021 but implementation slow.
...
| Metric | Value |
|--------|-------|
| Members | 54 of 55 AU countries (Eritrea out) |
| Population | 1.3B |
| Combined GDP | ~$3.4T |
| Signed | Mar 2018 |
| In force | Jan 2021 |
...
| Category | Treatment |
|----------|-----------|
| 90% of goods | Duty-free (phased) |
| Sensitive products | 7% excluded |
| LDCs | Longer phase-out |
...
| Approach | Detail |
|----------|--------|
| General rule | 40% value-added |
| Product-specific | Varying |
| Cumulation | Continental |
...
| Challenge | Reality |
|-----------|---------|
| **Infrastructure** | Poor roads, ports, rail connections |
| **Non-tariff barriers** | Customs delays, corruption, standards |
| **Capacity** | Weak institutions, limited resources |
| **Political will** | Varies by country |
| **Existing RECs** | ECOWAS, SADC, EAC overlap |

**Reality check:** Trading started 2021 but actual trade flows minimal.
...
| Optimist | Pessimist |
|----------|-----------|
| 1.3B consumer market | Poor infrastructure |
| Young demographics | Weak institutions |
| Commodity wealth | Non-tariff barriers persist |
| Leapfrog potential | Political instability |
...
| GDP | $3.4T | $26T | $17T |
| Intra-trade | 15% | 40%+ | 60%+ |
| Infrastructure | Poor | Good | Excellent |
| Implementation | Starting | Functioning | Deep |

AfCFTA = potential, not yet reality.
...
- [[Emerging markets]] — growth thesis
