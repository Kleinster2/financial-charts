#concept #technology #supply-chain

**Materials science** — the study of how atomic/molecular structure determines material properties. Underpins semiconductors, batteries, magnets, aerospace, and most deep tech. Often the bottleneck in technology roadmaps.

> **Key insight:** Software can iterate in days. Materials take decades. When a technology is "materials-limited," progress depends on chemistry breakthroughs, not engineering optimization.
...
**Frontier challenges:**
- EUV photoresists (metal oxide vs CAR)
- Low-k dielectrics for 2nm and beyond
...
| Electrolytes | Ion transport | Solvay, BASF |
| Separators | Safety layer | Asahi Kasei, Toray |

**Frontier challenges:**
- Solid-state electrolytes (oxide vs sulfide)
- Silicon anodes (expansion problem)
- Sodium-ion (lithium alternative)
- Lithium metal anodes

See [[Battery technology]], [[Lithium]], [[EV supply chain]].

### Magnets & rare earths

Critical for EVs, wind turbines, defense.
...
Enabling power electronics and RF.
...
Enabling screens from phones to TVs.
...
Increasingly critical as chips run hotter.
...
| Vapor chambers | High-power | Varies |

**AI relevance:** GPU/AI chip cooling is a materials problem. See [[NVIDIA]], [[Advanced packaging]].
...
### The materials bottleneck pattern

When demand outstrips materials supply:
1. Prices spike (see: lithium 2021-2022, palladium 2022)
2. Substitution R&D accelerates
3. New supply comes online (2-5 year lag)
4. Prices crash
5. Marginal producers exit
...
China dominates processing for:
- Rare earths (~90%)
- Graphite (~70%)
- Lithium refining (~60%)
- Polysilicon (~80%)
...
Some materials create durable competitive advantages:
...
- [[Semiconductor Materials]] — sector (wafers, gases, CMP)
- [[Photoresists]] — concept (EUV patterning)
- [[Advanced packaging]] — concept (substrates, interposers)
- [[Battery technology]] — concept (cell chemistry)
- [[Rare earths]] — concept (magnets, defense)
- [[MP Materials]] — actor (US rare earths)
- [[Applied Materials]] — actor (deposition, etch)
- [[Silicon carbide]] — concept (wide bandgap)
- [[Gallium nitride]] — concept (wide bandgap)
- [[China]] — actor (supply chain concentration)
- [[Japan]] — actor (materials dominance)
