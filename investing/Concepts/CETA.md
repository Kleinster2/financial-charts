...
| Country | Issue |
|---------|-------|
| **Belgium** | Wallonia regional opposition |
| **France** | Agricultural concerns |
| **Netherlands** | Climate concerns |
...
| Product | Quota | Notes |
|---------|-------|-------|
| Beef | 65,000 tons | Hormone-free only |
...
| Product | Benefit |
|---------|---------|
| Cheese | Duty-free 18,500 tons |
| Wine | Reduced duties |
| GIs | 143 protected names |
...
### Investment (controversial)

| Feature | Original | Modified |
|---------|----------|----------|
| ISDS | Included | Replaced by ICS |
...
|-------|--------|
| Federal | Full access |
| Provincial | First time (breakthrough) |
| Thresholds | Low (broad coverage) |

**Provincial access:** Major Canadian concession — first time in any FTA.
...
Examples: Roquefort, Prosciutto di Parma, Feta.

---

## Wallonia crisis (2016)
...
| Agricultural sensitivity | High | Very high |
| Services | Deep | Moderate |
| Ratification | 7+ years provisional | Unknown |
