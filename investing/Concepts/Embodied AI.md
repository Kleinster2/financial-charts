...
### Apr 2026: vehicles become embodied-AI platforms

The Apr 2026 [[Reuters]] [[Beijing]] Auto Show coverage adds cars to the embodied-AI map. [[Dongfeng Motor]] explicitly said it would build cars using embodied AI technology, while [[Xpeng]] and [[Xiaomi]] showed the consumer-facing version: vehicles interpreting intent, navigating physical spaces, and adjusting in-car environments through [[AI agents]].

This does not mean cars are humanoid robots. It means [[Automotive AI]] is an embodied-AI deployment path: sensors + local compute + vehicle controls + user intent, all operating in the physical world with safety constraints.
...
- [[Automotive AI]] — vehicle-based embodied AI deployment path
- [[Dongfeng Motor]] — state-owned automaker explicitly using embodied-AI language
