...
## Oil majors (March 2 verified closes)

| Ticker | Move | Notes |
|--------|------|-------|
| [[Exxon]] (XOM) | **+1.1%** | Verified close via yfinance |
| [[Chevron]] (CVX) | +1.5% | Verified close via yfinance |
| [[Shell]] (SHEL) | +0.9% | Verified close via yfinance |
| [[ConocoPhillips]] (COP) | +4.2% | Verified close via yfinance |

Integrated majors moved less than crude itself — market likely pricing duration uncertainty and demand destruction risk alongside supply disruption.

---

## Shipping/tankers (March 2)
...
## Saudi Aramco — Ras Tanura attack (Mar 2)

Two Iranian drones intercepted near [[Saudi Aramco]]'s Ras Tanura refinery (~500K bbl/day capacity). Debris caused fire, no casualties. Saudi Defense Ministry confirmed. Follows earlier strikes on Riyadh, Qatar refineries, Dukhan, Jebel Ali. GCC foreign ministers issued joint statement asserting "right to take all necessary measures to protect security and stability."

---

## Strait of Hormuz scenario

IRGC declared Hormuz closed. ~150 ships stalled. As of March 2, traffic effectively halted except 1-2 Iranian/Chinese-flagged vessels going eastbound (likely under Iranian indemnity). [[Maersk]] blocked all vessels from transiting. ~40M barrels disrupted over first 2 days ([[FGE]] estimate).

[[FGE]] energy consultant Iman Nasseri (CNN, Mar 2) identified three supply risk layers:
1. Iranian production at risk (2.5-2.6M bbl/day) if regime change succeeds
2. [[Strait of Hormuz]] closure — 20M+ bbl/day of oil + 5M bbl of product (>20% of global supply)
3. Regional infrastructure attacks escalating — Ras Tanura, Qatar LNG facilities, Dukhan, Jebel Ali
...
European gas +23% on March 2. ~25% of global [[LNG]] transits Hormuz. Qatar LNG production halted after direct Iranian strikes on facilities. ~4M tons/day of LPG and naphtha to Asian petrochemical sectors at risk. [[FGE]]: "Gas and LNG perhaps is not as easily replaceable if the situation prolongs." Asian petrochemical plants ([[China]], [[Japan]], [[South Korea]]) may shut in if supply disruption continues.
...
### Week 1 — stranded fleets, port pressure (March 5)

*Source: FT, Alice Hancock & Kana Inagaki, March 5, 2026*

![[ft-containership-hormuz-transits-mar2026.png]]
*Containership transits through the [[Strait of Hormuz]] collapsed from ~100-140K TEU (3-day average) to near zero by March 1-3. Source: [[Clarksons Research]] / FT. Data to March 3.*

90 container ships stuck in the Gulf out of 425 that were due to cross Hormuz. 100+ tankers also stranded. Most ships left seeking other ports after transshipment hubs [[Jebel Ali]] and [[Salalah]] (Oman) suspended operations due to strikes. Drone attacks on Gulf ports made discharging cargo there "off the cards" — [[Peter Sand]] ([[Xeneta]], Mar 5).

[[MSC]] invoked the Bills of Lading Act (1855) on Tuesday (Mar 4) — all containers to be taken to nearest available port and left for customers to collect at their own expense, plus an $800 per-container deviation fee.

Johan Sigsgaard ([[Maersk]] chief product officer, Mar 5): *"The first critical supply chain we need to deal with is refrigerated cargo because of the much shorter shelf life. Anywhere between the Gulf and going back to Latin America . . . we're looking for storage options."*

### Congestion spreading to secondary hubs

Pressure cascading to ports far from the Gulf:
...
13% of global air cargo capacity grounded ([[Flexport]]). Landing rights don't allow easy rerouting; airports lack space for extra cargo planes carrying perishables and healthcare products. [[Sanne Manders]] (Flexport president, Mar 5): *"It has a severe impact on air cargo capacity and you will see that in higher prices."* [[Turkish Airlines]] as winner — [[Istanbul]] hub not closed.

### DHL land bridge

[[Oscar de Bok]] ([[DHL]] Global Forwarding CEO, Mar 5): chartered "hundreds" of lorries to move shipments out of the region by land. Recovery math: *"To recover a week [of disruption] it will probably take four weeks. And if this is going to be four weeks, then we're talking about months to be recovered."*
...
Carriers are abandoning containers at whichever port is reachable:

| Original destination | Dumped at | Source |
|---------------------|-----------|--------|
| Middle East (general) | [[Nhava Sheva]], [[India]] | David Ozard, John Mason International |
| [[Saudi Arabia]] | [[Khor Fakkan]], [[UAE]] | David Ozard, John Mason International |

Ozard (Mar 18): *"At the moment it's a complete wild west. If we don't [pay], shipping lines put our accounts on hold and hold us to ransom."*

### Surcharges and fuel

All four major carriers added blanket fuel surcharges of $160–$400/TEU across all routes — not the usual route-by-route pricing.

[[Lars Jensen]] ([[Vespucci Maritime]], Mar 18): fuel surcharges are normally set by route, distance, and vessel size. The blanket application across all routes is unusual — it signals carriers are using the crisis to reprice structurally, not just covering incremental cost.

[[Hapag-Lloyd]]: surcharges cover war risk, fuel prices, and an additional "contingency surcharge" for Red Sea cargoes. [[Maersk]] cited "reshuffling in our fuel supply chain, rerouting of vessels and equipment shortage."

Charter rates for container ships at highest level since Covid ([[Clarksons Research]]) — rerouting absorbs vessel capacity.

### Jebel Ali fire and congestion

Debris from aerial strikes on Sunday (Mar 16) caused fire at [[Jebel Ali]] — [[Dubai]]'s main hub port, operated by [[DP World]] — triggering further cancellations and congestion at safer ports. ~3,200 vessels now stuck in the Gulf (up from ~700 on Mar 7, 90 container ships + 100 tankers on Mar 5).

### Fresh produce and halal meat

Philippe Binard ([[Freshfel]], Mar 18): March is peak month for European fresh produce exports to the Middle East. Refrigerated containers rerouted to [[Jeddah]], then overland — but border controls and competition for land transport add cost and delay. Fruit shipments require specific documents that must be reissued for alternate destinations. Margins in fresh produce are "extremely thin."

Halal meat supply chain disrupted — four livestock carriers heading for [[Jeddah]] port ([[S&P Global]]). Live animal transport is harder to reroute than dry cargo.

### CMA CGM partial workaround

[[CMA CGM]] has reopened Gulf bookings and is managing some logistics by truck from [[Jeddah]] and [[Oman]], including pharmaceutical goods. A person at the group (Mar 18): *"It's not as fast obviously."*

### Carrier oligarchy charge

[[Beko]] CEO [[Hakan Bulgurlu]] (Mar 18): shipping lines are *"pretty much an oligarchy"* and *"very opportunistic."* Beko insulated from immediate surcharges via long-term contracts, but the ripple effects through global supply chains create a *"whack-a-mole situation."*

### China summons carriers (March 10)

*Source: FT, March 10, 2026*
...
![[ft-gas-price-setting-hours-europe-2026.png]]
*Hours where the price of electricity was set by gas in 2026 (%). Source: [[Ember]] on Montel, GME, MIBGAS, ENTSO-E data. Data until March 10, 2026.*

![[ft-q2-electricity-prices-europe-2026.png]]
*Expected electricity prices for Q2 2026 (€/MWh). Source: FT.*

Gas prices have doubled since the start of 2026. But the impact on electricity prices is radically uneven across Europe — a function of energy mix, not geography.

| Country | Gas sets electricity price (% of hours, 2026 YTD) | Q2 2026 forecast (€/MWh) | Why |
|---------|---------------------------------------------------|-----------------------------|-----|
| [[Spain]] | 15% | ~€42 | Nuclear (20%), solar, wind, hydro — structural |
| [[France]] | Low (est. <15%) | ~€30 | Nuclear baseload dominant |
| [[Germany]] | ~40% | ~€90 | Post-nuclear phase-out; gas dependency |
| Netherlands | ~43% | — | Gas-heavy grid |
| [[Italy]] | 89% | ~€125 | No nuclear; gas-dependent |
| UK | ~66% | — | Intermittent renewables without nuclear baseload |

Spain's average electricity price for the remainder of 2026 forecast at ~€66/MWh — half Italy's level. [[Aurora Energy]] (consultancy): UK gas-fired plants set the electricity price ~2/3 of the time despite >50% of power from renewables and nuclear — illustrating that intermittent renewables alone don't decouple electricity from gas without nuclear or hydro baseload.

The political dimension: countries with lower electricity exposure face less pressure to engage militarily in [[Strait of Hormuz]] reopening. Spain's insulation bolsters its diplomatic independence — FT frames it as "one less reason to wade in."
...
## Gulf energy infrastructure attacks escalation (March 18-19)

Both sides ratcheted up strikes on energy facilities, marking the first direct attacks on Gulf state production infrastructure (vs earlier attacks on ports and shipping).

### Timeline (March 18)

| Target | Attacker | Detail |
|--------|----------|--------|
| South Pars gas field + Asaluyeh complex ([[Iran]]) | [[Israel]] | Israeli strike on Iran's domestic gas infrastructure — not export-relevant but crosses a new threshold: energy system as legitimate target |
| [[Ras Laffan]] LNG hub ([[Qatar]]) | [[Iran]] | Ballistic missile hit (1 of 5, 4 intercepted). "Extensive damage" to world's largest LNG export facility. Fires contained, no casualties. [[QatarEnergy]]: all personnel accounted for |
| Habshan gas plant + Bab field ([[UAE]]) | [[Iran]] | 13 ballistic missiles + 27 drones. UAE air defenses intercepted; debris caused facility shutdowns. Operations suspended at both sites. No injuries |
...
[[Qatar]] called the Israeli South Pars strike an "irresponsible step" — the diplomatic signal is clear: targeting each other's domestic energy infrastructure removes any remaining firewall between military operations and economic warfare.

The Iraq gas cutoff is a cascading second-order effect: Iraq depends on Iranian gas for ~30% of electricity generation. 3,100 MW offline affects millions of households immediately. This is the same transmission mechanism as the [[Nitrogen Trap]] (gas → ammonia → urea → food) but through the power grid instead of the fertilizer chain.

### Oil price impact (March 19)

Brent surged +5.8% to ~$113.54. Oil prices now up ~50% since the war started Feb 28. The [[Strait of Hormuz]] remains effectively closed; these attacks compound the supply picture by damaging the production facilities themselves — even if the Strait reopened tomorrow, Ras Laffan and Habshan need physical repair.

---

## European gas surge (March 19)

Post-attack gas market reaction (CNBC, Mar 19):

| Benchmark | Move (Mar 19) | Level |
|-----------|--------------|-------|
| Dutch TTF (front-month) | +21% (paring earlier gains) | €66.3/MWh ($75.9) |
| US Henry Hub | +4% | $3.19/MMBtu |
| Nymex RBOB gasoline (April) | +4.6% | $3.24/gal (near four-year high) |
| Brent (May delivery) | +8% | $116.2/bbl |
| WTI | +1.4% | $97.65 |

Earlier gas context (week of Mar 2-3): TTF +35% in one day, +76% on the week. [[Goldman Sachs]] estimated Qatar production pause would reduce near-term global LNG supply by ~19%. Goldman warned a monthlong halt to Hormuz flows risks driving TTF and JKM toward €74/MWh — the level that triggered demand destruction during the 2022 European energy crisis (which peaked at €345/MWh in August 2022).

Qatar context: world's second-largest LNG exporter after the US, accounting for ~20% of global shipments ([[Kpler]]). Qatar suspended LNG production Mar 2 after initial drone attacks; Mar 18 missile strikes inflicted "extensive damage" on Ras Laffan Industrial City, the world's largest LNG export facility.

[[Stifel]] analyst Chris Wheaton: "We are much more concerned about European gas prices than we are about oil prices." [[Omnis Investments]] CIO Patrick O'Donnell: LNG disruption "may have more negative implications for the European economy and the reindustrialization that the market has been hoping that we get to see."

Asia LNG exposure from Middle East ([[Invesco]] data):
- [[India]]: 58% of LNG imports from Middle East (~2% of primary energy)
- [[China]]: 26.6% of LNG imports from Middle East
- Singapore: 27% of LNG imports from Middle East
- Other Asia-Pacific: >37% of LNG from Middle East

[[BBH]] global head of markets strategy Elias Haddad: "A protracted conflict that leads to further disruption in energy production and shipping raises the risk of stagflation." Most vulnerable: [[Japan]], [[India]], South Africa, Turkey, Hungary, Malaysia. Least exposed: Norway, [[Canada]], Mexico.

*Source: CNBC, Mar 19 + Mar 3, 2026*
...
| Power grid stress | Countries dependent on oil/gas generation (Pakistan, Bangladesh, Myanmar) | Partially tracked: Iraq lost 3,100 MW after Iranian gas cutoff (Mar 18) — see Gulf infrastructure attacks section |
| SPR drawdown pace vs. refill | IEA 400M bbl release — how fast are buffers actually depleting? | IEA release tracked, pace not |
| Container shipping rates | Gulf-bound rates ~4x, blanket surcharges, containers dumped at alternative ports | Tracked — see Container shipping section above. Regional, not yet systemic |
