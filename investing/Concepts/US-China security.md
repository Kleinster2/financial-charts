...
|----------|-------------|--------|
| Status quo | Baseline | Tension but manageable |
| Blockade | Low-medium | Global chip crisis |
...
| Anti-ship | Tomahawk, LRASM | DF-21D "carrier killer" |
...
### Taiwan crisis hedges

| Play | Ticker | Rationale |
|------|--------|-----------|
| Defense primes | [[Lockheed Martin]], [[Northrop Grumman]], [[RTX]] | War production |
| Shipbuilders | HII, GD | Naval expansion |
| Missiles | [[RTX]], LMT | Precision munitions |
| Cyber/space | [[Palantir]], LMT, NOC | Modernization |
...
| Arms sales | Stable | Major Taiwan package |
| Rhetoric | Diplomatic contact | "Reunification" timelines |
| Military | No mobilization | Reserve activations |
