...
>
> OOS (formal, 40 post-definition obs, 2026-07-02 capstone pass): the picture sharpened in an instructive way. The June preliminary read (OOS-WEAKENED, "the seven continue to decohere") did NOT survive fuller data — at 40 obs the cohort grades OOS-CONFIRMED (post-definition intra 0.331 vs in-sample 0.310, ratio 1.06, beats random baskets at p 0.0021 on the verified clean pool). So the seven DO co-move weakly and stably out of sample. The falsification as a TRADABLE BASKET is unchanged and never rested on co-movement absence: intra ~0.31-0.33 is far below the 0.50 floor, the names remain singletons at the cut, and the intra-advantage vs QQQ/SPY stays negative — weak, stable, market-explained co-movement is exactly what "essentially leveraged QQQ" predicts. Falsified as a factor; confirmed as a beta.
