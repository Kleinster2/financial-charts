---
aliases: [consumer AI, AI consumer products]
---
#concept #ai #consumer
...
## Why consumer AI matters

| Metric | Significance |
|--------|--------------|
| Volume | Billions of potential users |
| Data | Training signal from usage |
| Distribution | Winner-take-most dynamics |
| Brand | Mindshare matters |

---

## Key consumer AI products
...
| Approach | Vehicles |
|----------|----------|
| Platform winners | GOOGL, META, MSFT |
| Pure-play | AAPL (if AI succeeds) |
