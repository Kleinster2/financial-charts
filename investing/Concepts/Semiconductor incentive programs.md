#concept #policy #subsidies #geopolitics

**Semiconductor incentive programs** — Global race to subsidize chip manufacturing and AI infrastructure. $200B+ committed worldwide. Reshaping where chips get made.

---

## The subsidy race

Every major economy now has chip incentives:
...
**Status**: Funding flowing, projects underway in Arizona, Ohio, Texas.
...
| Aspect | Details |
|--------|---------|
| Total | $470B (public + private to 2042) |
| Tax credits | 25% for large firms, 35% for SMEs |
| Focus | Memory ([[SK Hynix]], [[Samsung]]), foundry |
| Key clusters | Yongin, Pyeongtaek |

**Advantage**: Building on existing dominance, not starting from scratch.
...
|--------|---------|
| Total | $10B |
| Focus | Assembly, packaging, displays |
...
| Aspect | Details |
|--------|---------|
| Threshold | $200M+ foreign investment |
| Benefits | Import tax breaks, FX benefits, 30-year stability |
| Focus | Data centers, AI infrastructure |
| Key project | [[Project Stargate]] ($25B) |

See [[Argentina]] for context.
...
**Winners from subsidy race:**
- Equipment makers ([[ASML]], [[Applied Materials]], [[Lam Research]]) — sell to all
- Construction/infrastructure — building everywhere
- Local suppliers in recipient regions
...
Subsidies don't create capability overnight:

| What subsidies can do | What they can't do |
|-----------------------|-------------------|
