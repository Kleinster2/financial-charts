...
## Why dysprosium is the chokepoint
...
| Low volume, high impact | 20-60g per EV, but irreplaceable |

**The physics**: Dysprosium's f¹⁰ electron configuration allows it to maintain magnetic properties at high temperatures. This is a fundamental atomic property — no other element replicates it.

---

## The temperature problem

NdFeB magnets (neodymium-iron-boron) are the strongest permanent magnets. But they weaken with heat:

| Dy content | Strength loss at 150°C |
|------------|------------------------|
| 0% | 50% loss |
| 6% | 15% loss |

EV traction motors operate at 150-180°C. Without dysprosium, the magnets fail.

**No workaround**: You can't cool the motor enough. You can't use weaker magnets (range/performance suffers). You need dysprosium.
...
| Date | Action |
|------|--------|
| Apr 4, 2025 | Dy added to export license requirement |
| Oct 9, 2025 | Controls tightened further |
| Dec 1, 2025 | Military buyers denied entirely |
...
**Most vulnerable:**
- [[Tesla]], [[GM]] — EV motors
- [[Lockheed Martin]], [[Anduril]] — defense systems (now blocked entirely)
- European automakers — no domestic supply

**Relatively advantaged:**
- [[BYD]] — Chinese, domestic supply access
- Companies reducing Dy content per motor
