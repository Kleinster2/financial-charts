#concept #trade #eu #china

**EU-China trade** — Trade relationship between EU and China. Managed friction approach — tariffs with negotiated carve-outs, unlike US decoupling.
...
| Issue | Status | Note |
|-------|--------|------|
| **EV imports** | Minimum price mechanism (Jan 2026) | [[EU-China EV tariffs]] |
| **Solar panels** | Anti-dumping duties | Phased out 2018 |
| **Steel** | Safeguard measures | Ongoing |
| **Subsidies** | Anti-subsidy investigations | Multiple sectors |
...
| Dimension | EU | US |
|-----------|----|----|
| **Strategy** | Managed trade | Decoupling |
| **EV tariffs** | 7.8-35.3% → price floors | 100% (blocked) |
| **Tech restrictions** | Limited (follows US on semis) | Aggressive (Entity List) |
| **Investment screening** | Growing | CFIUS |
| **Tone** | "De-risking not decoupling" | Confrontational |

**Key difference:** EU preserves market access with conditions. US blocks entry.
