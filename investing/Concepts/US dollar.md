---
aliases: [USD, DXY, dollar, greenback]
---
...
| **Risk-on environment** | Money flows to EM, commodities |

---

## Dollar smile theory

USD tends to strengthen in two scenarios:

```
Strong USD          Weak USD           Strong USD
    |                  |                   |
    v                  v                   v
[Risk off]  <---> [Goldilocks] <---> [US outperformance]
 (flight to          (carry to           (growth
...
| Currency | % of reserves | Trend |
|----------|---------------|-------|
| USD | ~58% | Slowly declining |
| EUR | ~20% | Stable |
| JPY | ~5% | Stable |
| GBP | ~5% | Stable |
...
- Weaponization of dollar (sanctions)
...
|---------|--------|-------|
| Invesco DB USD Index | UUP | Long USD vs basket |
| WisdomTree USD Bullish | USDU | Long USD |
| Short USD via FXE, FXY | — | Long EUR or JPY |
...
- [[Fed independence]] — current crisis
...
- [[Chinese yuan]] — challenger narrative
