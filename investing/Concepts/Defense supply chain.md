#concept #defense #supplychain #materials

**Defense supply chain** — Munitions production ramp and critical materials constraints. Ukraine depleted stockpiles; now the West is rebuilding at industrial scale, hitting material bottlenecks.
...
- Army investing $5B in new munitions plants
- Goal: 13x increase in 155mm production (93K → 1.2M/yr)
...
**Scale problem:** At 1.2M shells/yr, US alone needs 600+ tonnes of copper annually just for artillery. Add missiles, electronics, naval vessels — defense copper demand is structurally rising into a supply-constrained market.

See [[Copper]] for broader supply constraints.
...
| Constraint | Impact |
|------------|--------|
| **Propellant** | Single-source suppliers (BAE Radford plant) |
| **Machine tools** | Multi-year lead times for specialty lathes |
| **Skilled labor** | Workforce atrophied since Cold War |
| **Testing/certification** | 12-18 month qualification cycles |
| **Sub-tier suppliers** | Many sole-source, no surge capacity |

**Propellant bottleneck:** The US has effectively one major propellant plant (BAE's Radford, VA). Single point of failure for entire munitions industrial base.

---

## Missile production

Missiles are even more constrained than shells:

| Missile | Annual production | Backlog |
|---------|------------------|---------|
| Javelin | ~2,400/yr (target 4K) | Years |
| Stinger | Restarting (closed 2022) | — |
| HIMARS rockets | Ramping | 18+ months |
| Patriot (PAC-3) | ~500/yr | Years |

**L3Harris spinoff:** Spinning out missile business as public company (2026). DoD investing $1B. Signals government priority on missile production capacity.
