#concept #batteries #supplychain

# Battery Supply Chain

Upstream to downstream value chain for lithium-ion batteries.
...
```
Mining → Processing → Components → Cells → Packs → End Use → Recycling
```
...
|-----------|----------|-------------|
| **Cathode** | Positive electrode | CATL, Umicore, BASF |
| **Anode** | Negative electrode | BTR, Showa Denko |
| **Separator** | Prevents short circuit | Asahi Kasei, SK IE |
| **Electrolyte** | Ion transport | Tianqi, Soulbrain |
...
**Economics:** Recycled materials approaching virgin cost parity.
...
- [[Batteries]] — overview hub
- [[Lithium]] — key material
- [[CATL]] — supply chain anchor
- [[LG Energy Solution]] — Korean leader
- [[Export controls]] — trade war implications
