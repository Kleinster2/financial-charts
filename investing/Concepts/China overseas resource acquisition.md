...
| Driver | Details |
|--------|---------|
| **Resource security** | Reduce dependence on Western-controlled supply chains |
| **Industrial policy** | Feed domestic manufacturing (EVs, batteries, chips) |
| **De-dollarization** | Physical assets vs dollar reserves |
| **Sanctions hedging** | Diversify away from US-controlled systems |
| **First-mover advantage** | Lock up reserves before Western competition |
...
| Period | Trend |
|--------|-------|
| 2015-2018 | Peak BRI era — infrastructure + resources |
| 2019-2021 | COVID slowdown |
| 2022-2024 | Resumed — record commodity prices |
| **2025-2026** | **Accelerating — $10B+ in mining deals** |

**2026 so far:** Zijin-Allied ($4B) is largest Chinese overseas mining deal in years.
...
- [[Zijin-Allied Gold acquisition]] — largest recent deal
- [[China-Africa trade]] — continent-level relationship
- [[Gold mining consolidation]] — sector trend
- [[De-dollarization]] — strategic driver
- [[CMOC Group]] — cobalt/copper focus
- [[Tianqi Lithium]] — lithium focus
- [[Kamoa-Kakula]] — Zijin's flagship copper JV
- [[Belt and Road Initiative]] — broader infrastructure context
