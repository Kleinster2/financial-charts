...
| Metric | Value |
|--------|-------|
| Total investment | €43B (~$47B) |
| Public funding | €11B |
| Private mobilization | €32B target |
| Timeline | 2023-2030 |
...
| Pillar | Focus | Funding |
|--------|-------|---------|
| **Chips for Europe** | R&D, design capabilities | €3.3B |
| **Supply security** | Fabs, production capacity | €6B+ |
| **Monitoring & crisis** | Supply chain coordination | Regulatory |
...
**Beneficiaries:**
- [[ASML]] — Equipment for any European fabs
- [[STMicro]] — French/Italian champion, subsidies
- [[Infineon]] — German power semi leader
- Construction/infrastructure — Fab buildouts

**Risks:**
- Intel project delays hurt sentiment
- Subsidies may not translate to competitiveness
- Still dependent on TSMC for leading edge
...
- [[ASML]] — European equipment champion
- [[STMicro]] — European fab champion
- [[Infineon]] — German power semis
