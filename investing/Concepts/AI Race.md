---
aliases: [AI Race, AI race, artificial intelligence race]
tags: [concept, ai, index]
---
#concept #ai #index #MOC
...
- [[Foundry Wars]] — supply-side counterpart for AI chip, memory, packaging, and foundry capacity
- [[AI infrastructure financing]] — funding channel for the compute buildout
- [[Model lab economics]] — frontier-lab burn, revenue, and margin structure
- [[Inference economics]] — deployment-cost curve and margin pressure
- [[Power constraints]] — physical constraint on AI compute deployment
- [[NVIDIA]] — dominant GPU supplier anchoring the current infrastructure cycle
