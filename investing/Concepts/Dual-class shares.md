---
aliases: [dual-class stock, multi-class shares, super-voting shares, dual class structure]
---
#concept #governance #ipo

**Dual-class shares** — a stock structure where different classes of common stock carry unequal voting rights. Founders/insiders hold "super-voting" shares (typically 10 votes per share) while public investors get standard shares (1 vote each). Allows founders to maintain corporate control despite minority economic ownership.
...
|-------|---------------|-----------------|-----------------|
| Class A | Public investors | 1 | Equal |
| Class B | Founders/insiders | 10 (sometimes 20) | Equal |
| Class C (rare) | Issued later | 0 | Equal |

A founder with 15% economic ownership but 100% Class B shares can hold >60% of total votes.

---

## Notable cases

### Tech founders (modern wave)

| Company | IPO year | Structure | Founder control | Sunset |
|---------|----------|-----------|-----------------|--------|
| [[Google]] | 2004 | 3-class (A/B/C), 10:1 | [[Larry Page]], [[Sergey Brin]] ~51% votes | None |
| [[Meta]] | 2012 | 10:1 Class B | [[Mark Zuckerberg]] ~58% votes | None |
| [[Snap]] | 2017 | Zero-vote Class A | Spiegel/Murphy 90%+ votes | None |
| [[Palantir]] | 2020 | 3-class (A/B/F), variable | [[Peter Thiel]], Karp, Cohen 49.99% via Class F | None |
...
| Company | IPO year | Sunset | Notes |
|---------|----------|--------|-------|
| [[Klaviyo]] | 2023 | 7 years | — |
| [[Reddit]] | 2024 | Ownership-based (8% threshold) | No time-based sunset |
| [[Rubrik]] | 2024 | 10 years | — |
| ServiceTitan | 2024 | 15 years + ownership (20% threshold) | — |
| Tempus AI | 2024 | 20 years | Longest modern sunset |

Prevalence: 32% of all IPOs in 2021, 26% in 2023. Among tech IPOs specifically: 46% in 2021, 44% in 2023.

### Legacy/non-tech

| Company | Structure | Control holder |
|---------|-----------|---------------|
| [[Berkshire Hathaway]] | Class A (1 vote) vs Class B (1/200th vote) | [[Warren Buffett]] — enabled decades of reinvestment over dividends |
| [[Ford]] | 40% family voting via Class B | Ford family — since 1956 IPO |
| [[Nike]] | Class A (non-voting) / Class B (voting) | Knight family |
| [[Comcast]] | Super-voting Class B | Roberts family |
...
- Insulates founders from short-term shareholder pressure
- Enables bold long-term moves (e.g. [[Meta]]'s $1B [[Instagram]] acquisition in 2012, initially controversial)
- US study (1980-2022): dual-class tech companies outperformed single-class peers
- Protects against hostile takeovers

## Arguments against

- Reduced accountability — entrenches management regardless of performance
...
Some dual-class IPOs include time-based or event-based conversion clauses:
- Shares convert to single class after fixed period (7-10 years)
- Convert on founder death/departure
- Convert if founder's ownership drops below threshold

Not universal — [[Google]], [[Meta]], and [[Snap]] have no mandatory sunsets.
...
- [[SpaceX]] — considering dual-class for 2026 IPO
- [[SpaceX xAI merger]] — combined entity governance
- [[Elon Musk]] — would retain ~79% voting control
- [[Palantir]] — Class F variable-vote structure (49.99% in perpetuity)
- [[DoorDash]] — 20:1, co-founders proxy all votes to CEO
