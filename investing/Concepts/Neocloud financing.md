...
- "Channel stuffing" with extra steps
- Revenue quality questionable
- Bear case for [[Long NVIDIA]]
...
1. **Neoclouds serve real demand** — hyperscalers can't meet all AI compute needs
2. **Microsoft contract is real** — CoreWeave has $65B contracted revenue
3. **Financing is normal** — strategic investments are standard in tech
4. **GPU shortage is real** — if demand was fake, prices would fall
...
**For [[NVIDIA]]:**
- Revenue quality question — how much is "real" vs orchestrated?
- Insider selling signal — $496M out, zero in (Nov 2025)
- When cycle turns, demand could evaporate faster than expected

**For neoclouds:**
- Existential risk if NVIDIA stops supporting
- [[CoreWeave]] CDS spread (773 bps) reflects this
- Competition with hyperscalers is brutal long-term
