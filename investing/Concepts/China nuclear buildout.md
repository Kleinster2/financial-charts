...
| Metric | Value |
|--------|-------|
| Reactors operating | 55+ |
| Reactors under construction | 20+ |
| Global share of new builds | >50% |
| Flagship reactor | Hualong One (indigenous) |

---

## Zhangzhou Nuclear Base

World's largest nuclear base using single domestic reactor design:

| Metric | Value |
|--------|-------|
| Location | Fujian Province |
| Reactor type | Hualong One (indigenous 3rd-gen PWR) |
| Total units | 6 planned |
| Completed | Unit 1 (Jan 2025), Unit 2 (Jan 2026) |
| Annual output (6 units) | 60 billion kWh |
| CO2 avoided | ~50 million tons/year |

Unit 2 passed 168-hour full-power test on January 1, 2026.
...
Major projects beyond Zhangzhou:

| Site | Reactors | Status |
|------|----------|--------|
| Zhangzhou | 6 Hualong One | 2 operating, 4 building |
| Taipingling | 6 Hualong One | Building |
| Sanmen | 4 AP1000 | 2 operating, 2 building |
| Haiyang | 4 AP1000 | 2 operating, 2 building |
| Various | CAP1400 (upscaled AP1000) | Building |

---

## Why nuclear + solar

| Power type | Strength | Weakness |
|------------|----------|----------|
...
Nuclear provides the baseload that solar can't:

| Requirement | Solar | Nuclear |
|-------------|-------|---------|
| AI training (24/7) | Needs storage | Native fit |
...
- [[China solar buildout]] — complementary (intermittent capacity)
- [[Nuclear power for AI]] — US equivalent (slower, different approach)
- [[Power constraints]] — contrast (US struggling)
