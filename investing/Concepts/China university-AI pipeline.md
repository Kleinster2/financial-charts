...
The epicenter of China AI talent:

| Spinoff/Alumni | Category | Valuation |
|----------------|----------|-----------|
| Zhipu AI | AI models (GLM) | $3B+ |
| Moonshot AI | AI models (Kimi) | $3B+ (founder) |
| SenseTime | Computer vision | Public (HK) |
...
- Government encourages commercialization

---

## Peking University (北京大学)

Strong in theory, growing in applied AI:

| Spinoff/Alumni | Category |
|----------------|----------|
...
[[Hangzhou]]'s talent engine:

| Connection | Category |
|------------|----------|
| [[Alibaba]] | E-commerce, cloud (talent pipeline) |
| [[DeepSeek]] | AI models (researchers) |
| [[Unitree]] | Robotics |
| MiniMax | AI models |
...
| University | Location | Strength | Notable |
|------------|----------|----------|---------|
| Shanghai Jiao Tong | Shanghai | AI, robotics | Strong industry ties |
| USTC | Hefei | Fundamental research | iFlytek connection |
| Fudan | Shanghai | NLP | Research focus |
| Harbin Institute | Harbin | Engineering | Defense/industrial |
| [[NUDT]] | Changsha | Military AI | Tianhe supercomputers |

---

## Hong Kong universities

Bridge between China and international AI research:

| University | Strength | Notable |
|------------|----------|---------|
| HKUST | AI/ML research | SenseTime co-founders |
...
The US → China talent pipeline accelerated China's AI rise:

| Returnee | US training | China role |
|----------|-------------|------------|
| [[Kai-Fu Lee]] | CMU, Apple, Google | 01.AI founder |
| [[Wang Xiaochuan]] | Tsinghua → US exposure | Baichuan founder |
| Andrew Ng | Stanford | Baidu Chief Scientist (2014-17) |
...
China now leads in AI publication volume:

| Metric | China | US |
|--------|-------|-----|
| AI papers (2023) | ~40% of global | ~15% of global |
...
```
University lab → Spinoff company → VC funding → Scale
     ↓                                    ↓
Faculty advisors            Government support
...
| IP transfer | Complex, slow | Fast, encouraged |
| Government role | Grants, indirect | Direct investment, contracts |
| Time to $1B | 5-10 years typical | 2-3 years for AI |
...
- Beijing (Tsinghua/PKU) vs Hangzhou (ZJU) as rival hubs
...
| Risk | Details |
|------|---------|
| Brain drain | Top talent may emigrate |
| Overproduction | Too many AI PhDs, not enough jobs |
| Quality concerns | Quantity over quality pressure |
| Politicization | Academic freedom constraints |
...
- [[China AI Tigers]] — output (Tsinghua spinoffs)
- [[Hangzhou]] — hub (ZJU connection)
- [[DeepSeek]] — example (ZJU researchers)
- [[ByteDance]] — example (Tsinghua founder)
- [[Alibaba]] — example (ZJU pipeline)
- [[Kai-Fu Lee]] — returnee (01.AI founder)
- [[Wang Xiaochuan]] — returnee (Baichuan founder)
