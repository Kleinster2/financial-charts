---
aliases: [Dutch TTF, Title Transfer Facility, TTF natural gas, European gas benchmark, TTF gas]
...
|------|-------|------|
| Pre-conflict | ~€33/MWh | — |
| Mar 2-3 | — | +35% in one day, +76% on week (post-Ras Laffan attack) |
| Mar 7 | $16.65/MMBtu | +55% from pre-conflict |
...
- [[Henry Hub]] — US gas benchmark (insulated from TTF spikes)
- [[LNG]] — supply mechanism linking Gulf to Europe
- [[Ras Laffan]] — world's largest LNG export facility (offline)
- [[QatarEnergy]] — force majeure on European contracts
- [[Iran conflict European impact]] — full European energy analysis
