...
Fastest-growing digital region:

| Country | Population | Tech Strategy |
|---------|------------|---------------|
| [[Singapore Tech]] | 6M | Hub, SWFs |
...
- Grab (GRAB)
- GoTo (GOTO.JK)
- Singapore banks (DBS, UOB, OCBC)
- Equipment makers in region
