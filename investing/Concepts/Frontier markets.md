...
| Factor | Frontier | Emerging |
|--------|----------|----------|
| Market cap | Smaller | Larger |
| Liquidity | Lower | Higher |
| Foreign access | Limited | Better |
| Volatility | Higher | High |
| Correlation | Lower to DM | Moderate |

---

## Major frontier markets
...
| Factor | Description |
|--------|-------------|
| Demographics | Young, growing populations |
| Low correlation | Diversification benefit |
| Undiscovered | Less analyst coverage |
| Growth potential | Early stage development |
...
| Risk | Impact |
|------|--------|
| Liquidity | Hard to exit positions |
| Currency | Volatile, controls |
| Political | Instability, policy changes |
| Custody | Settlement issues |
...
### Concepts
- [[Emerging markets]] — larger category
- [[China+1]] — supply chain shift

### Regions
- [[Africa]] — many frontier markets
