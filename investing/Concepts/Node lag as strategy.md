...
| Deploying bleeding edge overseas | Risk |
|----------------------------------|------|
| Process still immature | Yield problems |
| Engineers learning on-the-job | Quality issues |
| Suppliers unfamiliar | Supply chain hiccups |
| Customers exposed | Product delays |

**Deploying N-2 overseas:**
...
| Decision | Risk level |
|----------|------------|
| Started as 4nm fab | Medium |
| Pivoted to 2nm mid-construction | Extreme |
| Deploying unproven GAA in new geography | Very high |
| Leapfrogging TSMC's sequencing | Maximum risk |
...
| Lower risk | Product launches on schedule |
