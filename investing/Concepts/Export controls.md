#concept #policy #usa #china #geopolitics

U.S.-led restrictions on semiconductor technology exports to [[China]]. Central constraint shaping industry capex, supply chains, and geopolitical risk.
...
### Entity List
- Restricts exports to specific Chinese companies ([[Huawei]], SMIC, etc.)
- Requires license for controlled items
- De facto ban for leading-edge

### Foreign Direct Product Rule (FDPR)
- Extraterritorial reach: items made with US tools/IP anywhere in world
- Forces non-US companies to comply
- [[TSMC]], [[Samsung]], [[ASML]] all affected

### Validated End User (VEU)
- Expedited licensing for trusted fabs
- Revoked Dec 31, 2025 for Korea/[[Taiwan]] fabs in China
- Now case-by-case approval required (1-year terms, no expansion)
...
| [[Qualcomm]] | ~60% |
| Applied Materials | Significant |
| Lam Research | Significant |
| [[ASML]] | DUV ongoing |
...
### Memory (Samsung, SK Hynix China fabs)
- VEU revoked — no more blanket authorization
- New policy: 1-year approvals (can operate, can't expand/upgrade)
- Effect: Caps China memory supply, supports DRAM/NAND pricing
- SK Hynix: 30-35% DRAM, 40-45% NAND from China

### Foundry (TSMC, etc.)
- N-2 rule — [[Taiwan]] restricts TSMC from leading edge overseas
...
- Higher profits fund other bets ([[Advanced packaging]], foundry)
...
- Memory profits fund packaging/foundry expansion
- Policy tailwind, not headwind
...
As of June 19, the ban holds — Fable 5 and [[Claude Mythos|Mythos 5]] remain offline a week on, with Anthropic and [[Donald Trump|Trump]]-administration officials negotiating a restoration (The Globe and Mail) and Anthropic's MD International [[Chris Ciauri]] saying access should return "in the coming days" (June 17, Seoul). The trigger sharpens the model-access-governance read: the Washington Post (June 15) named the firm as [[SK Telecom]] — an Anthropic investor and [[Project Glasswing]] [[Claude Mythos|Mythos]]-access partner — flagged over suspected [[China]] ties (historical: parent [[SK Group]]'s China Unicom stake until 2009; SK Telecom denies them). That is the distillation-memo fear in concrete form — not a chip crossing a border, but a controlled model reachable by an end user with adversary exposure — so the control lands on the model and its allied user base rather than on the hardware. By June 20 the fight had escalated to the question of causation and to the G7: an FT analysis quantified Anthropic's risk-forward messaging (≈5 risk-related words per 1,000 vs [[OpenAI]]'s 0.6) as critics ([[Yann LeCun]], [[David Sacks]]) argued the company's own doomerism invited the ban, while Macron called it a test of "non-cooperation among democracies" and the US and EU opened talks on allied model access; [[JPMorgan Chase]] cut Anthropic access for its Hong Kong staff. Full debate in [[Anthropic#Jun 20 — did Anthropic talk its way into the ban?|Anthropic]].
