...
**AI could add $1.1-1.7T annually to Latin America** (WEF/McKinsey, Jan 2026):

| Source | Annual value |
|--------|--------------|
| Analytical AI | $0.6-1.0T (~60%) |
| Generative AI | $0.5-0.7T (~40%) |
| **Total** | **$1.1-1.7T** |
...
**Headline:** Broad adoption, minimal value capture.

| Metric | Value | Implication |
|--------|-------|-------------|
| Organizations generating any AI value | 23% | Most see no ROI |
| Organizations with >5% EBIT impact | **6%** | Meaningful impact rare |
| SMEs with zero AI value | 59% | SMEs left behind |
| AI strategy linked to business strategy | 10% | Misaligned execution |
| Leaders feel regulatory environment unclear | 58% | Governance gaps |

**Value capture by size:**

| Size | Positive EBIT impact | No impact |
|------|---------------------|-----------|
| Very large ($1B+) | 24% | 37% |
| Large ($100M-$1B) | 25% | 33% |
| SMEs (<$100M) | **18%** | **59%** |

SMEs are 99.5% of Latin American businesses. Their exclusion is a major drag on regional competitiveness.

---

## Where AI is actually deployed

### Analytical AI (at scale)

| Domain | At scale | Use cases |
|--------|----------|-----------|
| Customer service | 27% | Behavioral routing, agent scheduling |
| Fraud/debt analytics | 22% | Fraud prediction, compliance |
| Personalization | 21% | Segmented retention, upsell |
| Digital marketing | 18% | Ad optimization, lead gen |

**Untapped:** IT automation (16%), people analytics (4%), procurement (3%).

### Generative AI (at scale)

| Domain | At scale | Use cases |
|--------|----------|-----------|
| Software engineering | **22%** | Code generation, architecture docs |
| Customer service | 15% | Chatbots, call transcripts |
| Corporate IT | 12% | Internal tools |
| Personalization | 10% | Dynamic content |

**Untapped:** Manufacturing/supply chain (4%), talent analytics (4%), finance (2%).

---

## Why adoption isn't translating to value
...
| Operating model | 30 | 56 | 26 |
| Data | 39 | 61 | 22 |
| Technology | 37 | 67 | 30 |
| Strategy | 37 | 64 | 27 |

**Talent is the widest gap.** Organizations struggle with:
- Role-based skill development
- Clear AI career paths
- Recruiting/retention vs multinationals
...
Compare to world:
- Global productivity CAGR 2015-2024: **+1.3%**
- Latin America: **-0.3%**

**The demographic dividend is fading:** By 2053, 25%+ of Latin America's population will be 60+. Workforce expansion won't compensate for weak productivity.
...
| Metric | Value |
|--------|-------|
| Households without fixed broadband | 15-17% |
| Rural vs urban internet gap | **30+ percentage points** |
| Rural household internet access | 42% |
| Urban household internet access | 74% |

The urban-rural divide threatens AI as a democratizing force.
...
**Latin America = 1.6% of global AI investment** despite 6.3% of global GDP.
...
AI can amplify Latin America's existing competitive advantages:
...
## Regional models ([[CENIA]]'s Latam-GPT)
...
Plans to migrate from AWS to solar-powered Atacama Desert data center.

---

## 10-point roadmap (WEF/McKinsey)
...
5. **Adapt frontier AI to local needs** — fine-tune open-source with local data
...
**Risks:**
- 58% regulatory uncertainty
- Urban-rural digital divide
- Talent competition from multinational tech centers
- SME exclusion (59% no AI value)
