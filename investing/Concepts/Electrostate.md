#concept #energy #governance

# Electrostate

A society that consumes a high proportion of its energy in electrical form, regardless of how that electricity is generated. Coined/popularized by [[Adam Tooze]] to describe the emerging divide in global energy systems between electrified economies (China) and fossil-dependent ones (US as "petrostate").

---

## The framing

The electrostate concept separates two dimensions of energy transition:
...
China is the paradigmatic electrostate:

| Metric | Figure |
|--------|--------|
| EV penetration | Near-universal in cities like Chengdu |
| Solar panel production | 1,200 GW/year capacity (vs US 250 GW total installed) |
| Urban buildout | 90% of habitations built since 1990—all electrified from start |
| Grid infrastructure | Ultra-high voltage transmission from west to east |

Tooze's visceral description: Standing at a Chengdu crosswalk, ~100 vehicles pass in 30 seconds without him noticing—all electric, producing only tire noise. "Like a silent disco."

---

## US as "petrostate"

The US is framed as an electrostate's opposite—not because it lacks electricity, but because:
...
- [[Adam Tooze]] — coined/popularized the framing
- [[China]] — electrostate archetype
- [[Ember]] — maps electrification vs decarbonization globally
- [[NVIDIA]] — AI chips driving new electricity demand
- [[De-dollarization]] — related structural shift in global order

---

## Sources

- Adam Tooze, LRB Lecture (2025)
- [Ember: Electrification vs Decarbonization framework](https://ember-energy.org/)
