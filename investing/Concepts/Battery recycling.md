#concept #batteries #supplychain #circulareconomy
...
| Method | Process | Recovery rate | Players |
|--------|---------|---------------|---------|
| **Hydrometallurgical** | Chemical leaching | 95%+ | Redwood, Li-Cycle |
| **Pyrometallurgical** | Smelting | 70-80% | Umicore |
| **Direct recycling** | Preserve cathode structure | Highest | Early stage |
...
| Metric | Value |
|--------|-------|
| Black mass value | $5-15/kg (varies with commodity prices) |
| Lithium recovery cost | Lower than mining (at scale) |
| Cobalt recovery | 95%+ from hydro process |
| IRA benefit | Domestic content = tax credit eligibility |
