---
aliases: [Snapback mechanism, Snapback sanctions, JCPOA snapback]
---
...
A safeguard built into the 2015 Iran nuclear deal (JCPOA):

```
Iran violates JCPOA commitments
    → Participant state notifies Security Council
        → 30 days to adopt resolution continuing sanctions relief
            → If no resolution passes → sanctions automatically reimpose
...
**Iran's nuclear violations (as of Sep 2025):**

| Metric | JCPOA limit | Actual |
|--------|-------------|--------|
| Enriched uranium stockpile | 202.8 kg | 8,400+ kg (**41x limit**) |
| Enrichment level | 3.67% | Up to 60% |
| IAEA monitoring | Full access | Largely blocked |
| High-enriched uranium (HEU) | 0 | 10 "significant quantities" |

> "Iran holds a quantity of enriched uranium which is 48 times the JCPOA limit, with the stockpile entirely outside of IAEA monitoring." — IAEA report, Sep 4, 2025

---

## Security Council vote

**Draft resolution to continue sanctions relief:**
...
**E3/US position:**
- Snapback is self-executing by design
...
**After snapback:** Multilateral UN sanctions, EU legally bound
...
| Factor | Detail |
|--------|--------|
| Iran breakout time | Estimated weeks, not months |
| HEU stockpile | Weapons-grade material accumulating |
| IAEA blocked | No monitoring of enrichment |
| Diplomacy exhausted | No progress in 2024-2025 talks |
| JCPOA expiring | Use it or lose it (Oct 18, 2025 deadline) |
...
**Previous snapback threat:**
- Trump administration attempted in 2020
- Disputed whether US had standing after withdrawing from JCPOA
- Most countries ignored 2020 attempt

**2025 difference:**
- E3 remained JCPOA participants
...
- [[Iran]] — target country
- [[Iranian economic collapse]] — snapback as accelerant
- [[US Sanctions]] — primary sanctions framework
- [[Secondary sanctions]] — enforcement mechanism
- [[EU]] — E3 members triggered snapback
- [[IAEA]] — monitoring body (if note exists)

---

## Sources

- [E3 Joint Statement on Snapback Activation](https://www.gov.uk/government/news/e3-joint-statement-on-iran-activation-of-the-snapback)
- [Security Council Report: Snapback Vote](https://www.securitycouncilreport.org/whatsinblue/2025/09/iran-vote-on-a-draft-resolution-regarding-the-snapback-of-un-sanctions.php)
- [UN Press: Security Council Vote](https://press.un.org/en/2025/sc16181.doc.htm)
