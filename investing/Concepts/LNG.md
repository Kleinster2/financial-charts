---
aliases: [liquefied natural gas, natural gas, natgas]
---
#concept #energy #commodity

**LNG** - Liquefied natural gas. Natural gas cooled to -260°F for shipping. Enables global gas trade. Key fuel for AI data center power.

---

## Why LNG matters for AI thesis

| Connection | Description |
|------------|-------------|
| Data center power | Gas turbines for baseload/peaker plants |
| Faster than nuclear | Gas plants built in 2-3 years vs 10+ for nuclear |
| Cleaner than coal | ~50% less CO2, bridge fuel |
| [[Crusoe Energy]] model | Stranded gas → compute |
| Hyperscaler backup | Gas for grid reliability |
...
Why liquefy? Gas volume shrinks 600x, enabling ocean transport.

---

## Global LNG trade (~400 MTPA)
...
| [[Air Products]] | Industrial gases, LNG tech |
...
| Metric | Value |
|--------|-------|
| Export capacity | ~14 Bcf/d (~90 MTPA) |
| Under construction | ~6 Bcf/d |
| Proposed | ~20+ Bcf/d |
...
### Apr 17 reopening did not fix LNG

The Apr 17 "Hormuz is open" headline mattered far less for [[LNG]] than for crude. Oil can reprice on a diplomatic headline because futures mostly need a path for tanker flows. LNG needs physical liquefaction, loading, shipping slots, and regas capacity to come back in sequence.

That is why the gas complex kept its structural-damage logic even as oil sold off. [[QatarEnergy]] was still in force majeure, [[Ras Laffan]] damage still pointed to a longer outage, and Europe was already entering restocking season with low inventories. A partial reopening of shipping lanes can help over time, but it does not rebuild lost Qatari export capacity or erase the Atlantic-versus-Pacific scramble for cargoes.

The practical readthrough is that Apr 17 shifted the market debate from "is Hormuz shut?" to "how long does the LNG deficit last?" For Europe in particular, the answer still runs through storage, diverted US cargoes, and how quickly non-Gulf supply can fill a hole that crude headlines alone cannot solve. See [[Iran conflict European impact]] for the policy response and [[2026 Strait of Hormuz crisis]] for the broader transmission-channel map.
...
Bear:
- Overbuild risk (too much capacity)
...
## LNG for data centers

Direct connection:

| Factor | Description |
|--------|-------------|
| Gas peakers | Backup for renewables intermittency |
| Combined cycle | Baseload power, high efficiency |
| Speed | Faster to build than nuclear |
| Reliability | Dispatchable, grid stability |

Players:
- [[Crusoe Energy]] - gas-to-data-center
- Utilities adding gas capacity
- Hyperscalers contracting gas backup
