---
aliases: [UK FTAs, UK trade deals, Global Britain]
---
...
| Signed | Dec 2021 |
| In force | May 2023 |
| First new FTA | Post-Brexit |

| Sector | Terms |
|--------|-------|
| Beef | Quota → full liberalization (15 yr) |
| Lamb | Quota → full liberalization (10 yr) |
| Wine | Duty-free |
| Services | Strong access |
| Mobility | Youth mobility scheme |

**Controversy:** UK farmers opposed beef/lamb opening.

### UK-New Zealand FTA (2023)
...
|--------|-------|
| Signed | Dec 2020 |
| Type | Basic FTA, not single market |
| Goods | Zero tariffs, zero quotas |
...
| Issue | Status |
|-------|--------|
| Biden priority | Low (no interest) |
| Trump interest | Higher but transactional |
| NHS | UK red line |
| Chlorinated chicken | UK red line |
| Prospects | Uncertain |
