...
| Factor | Significance |
|--------|--------------|
| Russian submarine activity | Increased since 2014 |
| Arctic opening | More traffic through northern routes |
| NATO expansion | Finland/Sweden add Baltic dimension |
| Undersea cables | Critical infrastructure passes through |
...
| System | Function |
|--------|----------|
| SOSUS (legacy) | Underwater acoustic arrays |
| IUSS | Integrated undersea surveillance |
| P-8 Poseidon | Maritime patrol aircraft |
| Satellites | Surface vessel tracking |
...
|--------------------|---------------|
| SSBNs (ballistic missile subs) | Detection priority |
| SSNs (attack subs) | ASW patrols |
| Increased activity post-2014 | Renewed GIUK focus |

**Severodvinsk-class:** Russia's newest SSNs — quieter, harder to detect. Challenge for legacy sensors.
...
**Beneficiaries:**
- [[Northrop Grumman]] — maritime surveillance
- [[Raytheon]] — sonar systems
- [[Boeing]] — P-8 Poseidon
...
- [[Arctic]] — regional context
- [[Greenland]] — eastern anchor (Pituffik base)
- [[Iceland]] — central position
- [[NATO]] — primary operator
- [[Russia]] — adversary (Northern Fleet)
- [[Northern Sea Route]] — Arctic access Russia seeks
