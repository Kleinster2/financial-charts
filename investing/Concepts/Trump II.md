#concept #geopolitics #trump #policy #2026 #hub

**Trump II** — Second Trump administration (2025-). Themes: shows of force, tariffs as leverage, immigration enforcement, deregulation, "America First" maximalism.
...
|--------|-------|----------|
| **Force** | Shows of US "can do" | Maduro capture, Greenland threats, Panama |
...
| Target | Rhetoric | Action |
|--------|----------|--------|
| **Venezuela** | "We'll run it" | Maduro captured |
| **Greenland** | "We need it" | Threats, no action yet |
| **Panama** | "Give it back" | Threats, no action yet |
| **Cuba** | (Rubio's target) | Pending — see [[Cuba-Venezuela axis]] |
| **Mexico** | Cartels as terrorists | Border deployment |
...
| Policy | Status |
|--------|--------|
| TPS terminations | Venezuela (2021, 2023) terminated |
| Deportation flights | Ramping up |
| "Safe country" strategy | Venezuela = safe → deport |
| Travel ban | Expanded |

See [[Venezuela repatriation strategy]].
...
| Actor | Domain |
|-------|--------|
| **Trump** | All — final authority |
| **Rubio** (State) | Force, Cuba focus |
| **Miller** (WH) | Immigration |
| **Bessent** (Treasury) | Tariffs, China |
| **Hegseth** (DoD) | Military action |
| **Noem** (DHS) | Border, deportations |
| **Homan** | Border czar |
...
### Actions
- [[Maduro capture 2026]]
- [[WH oil executives Venezuela meeting 2026-01-09]]
- [[Venezuela repatriation strategy]]

### Trade
- [[US-China trade]] — tariff umbrella
- [[US-China tariffs]] — tariff detail
- [[US-China relations]] — broader context
