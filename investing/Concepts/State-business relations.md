#concept #politicaleconomy #governance #investing

**State-business relations** — The spectrum of how governments and private enterprise interact. Ranges from arm's-length regulation to full state ownership. Understanding where a country/sector sits on this spectrum is critical for investment analysis.
...
State actively promotes sectors/firms it deems strategic.
...
Agencies meant to regulate industry instead serve it.
...
See [[Banking concentration]] for how Brazilian banking regulation preserves oligopoly (capture without corruption).

---

### 4. Development banking

State-owned banks provide subsidized credit.
...
Government owns and operates firms directly.
...
State directs economy systematically while maintaining private ownership.
...
Political connections determine business success. Extraction at public expense.
...
**Sub-patterns:**
- [[Crony capitalism]] — the broad pattern
- [[Bank cronyism]] — banks as extraction vehicles
- [[Brazilian cronyism]] — democratic variant
- [[Iranian banking]] — authoritarian variant

**The distinction:** Industrial policy says "we'll help firms in sector X." Cronyism says "we'll help firms owned by person Y."
...
|----------|-----------------|
| How did this firm get its license/contract? | Merit or connection? |
| Who owns it? | Political family? State-linked? |
| Are competitors harassed? | Level playing field? |
| Do loans get repaid? | Economic or political lending? |
| What happens when patron loses power? | Political dependency? |
| Are regulators independent? | Capture risk? |
| Is there rule of law? | Contract enforcement? |
...
| Mode | Implication |
|------|-------------|
| **Arm's-length** | Fundamentals matter most |
| **Industrial policy** | Identify which sectors favored; policy durability? |
| **Regulatory capture** | Incumbents protected; disruption risk lower |
| **State capitalism** | Political risk high; minority shareholder risk |
| **Cronyism** | Avoid or price in regime risk |

**The framework:** Before analyzing a company's fundamentals, understand where it sits in the state-business relationship. A "cheap" stock in a crony system may be cheap for good reason.
...
### Types
- [[Crony capitalism]] — extraction pattern
- [[Bank cronyism]] — banks as vehicles
- [[Banking concentration]] — regulatory capture example

### Country patterns
- [[Brazilian cronyism]] — democratic cronyism
- [[Iranian banking]] — authoritarian capture
- [[China]] — state capitalism

### Actors
- [[TSMC]] — industrial policy success
- [[Petrobras]] — SOE capture example
