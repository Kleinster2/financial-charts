...
US investor in EFA faces FX risk:

| Scenario | Impact on EFA (USD) |
|----------|---------------------|
| Dollar weakens 10% | +10% currency tailwind |
| Dollar strengthens 10% | -10% currency headwind |
| Local returns +5%, USD +5% | ~0% USD return |

2022: EFA local returns ~flat, but USD strength → -14% in USD terms.
...
## When to own international

| Environment | International equities |
|-------------|------------------------|
| Dollar weakening | Good (currency tailwind) |
| Dollar strengthening | Bad |
| Value outperforming | Good (EFA is value-heavy) |
| Growth outperforming | Bad (less tech) |
| Global synchronized growth | Good |
| US exceptionalism | Bad |
...
### Regions
- [[Japan]] — largest EAFE weight
- [[EU]] — European component
- [[UK]] — post-Brexit dynamics
- [[Germany]] — fiscal shift
