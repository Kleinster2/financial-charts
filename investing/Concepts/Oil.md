...
**Oil** — World's most traded commodity. Primary transport fuel, petrochemical feedstock. AI relevance via power generation and energy costs.

---

## Why oil matters for AI thesis

| Connection | Description |
|------------|-------------|
| Power generation | Natural gas (oil byproduct) fuels peaker plants |
| Energy costs | Oil prices affect electricity prices |
| Petrochemicals | Data center materials (plastics, cooling fluids) |
| Macro | Oil shocks affect capex budgets |
...
| Spread | Brent-WTI typically $2-5 |

---

## Global supply (~100M bpd)
...
| Type | Gravity | Sulfur | Premium | Example |
|------|---------|--------|---------|---------|
