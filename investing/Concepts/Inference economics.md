...
This note synthesizes inference pricing and deflation data from multiple external sources ([[Epoch AI]], [[OpenRouter]], The Information, Martin Alderson) rather than a single DB price series; the quantitative detail lives in the pricing and deflation tables above. (Chart data not applicable as a single series.)
