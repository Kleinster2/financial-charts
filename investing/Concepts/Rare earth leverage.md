...
**Rare earth leverage** — [[China]]'s dominance in rare earth elements and critical minerals gives it asymmetric power in technology conflicts. A key tool in [[China retaliatory toolkit]].
...
The bull case for sustained Chinese monopoly pricing requires Western replication to stall (Iluka/MP/Arafura delays, repeat of the [[Li-Cycle]] scale-up failure pattern) AND phosphogypsum extraction to stay sub-commercial — both have to underperform simultaneously. The bear case is the opposite — the 2026 commissioning wave integrates into reliable supply chains by 2028 AND Uberaba proves the phosphogypsum economics at scale.

**Forecast spread — the premium prices one point in it, not all of it:**

- "Monopoly entrenched" camp (CSIS-adjacent hawks, Pentagon procurement planners): Chinese chokepoint holds 2030+ despite Western commissioning; weaponization events recur
- "Chokepoint erodes gradually" camp (industry consensus around 2026 commissioning wave): Chinese share drops to 60-70% by 2030 as parallel tracks come online; weaponization power diminishes at margin
- "Technology unlock breaks the model" camp (phosphogypsum maximalists, chromatography/solvent-extraction believers): mining chokepoint bypassed by 2028-2030 as extraction technology matures; Chinese premium collapses

The current post-April-2025 dysprosium pricing embeds the "monopoly entrenched" premium — limited discount for the parallel-replication scenario, minimal weight on technology-unlock.

**Defensible reframe:** The rare-earth premium prices the "monopoly entrenched" forecast — which weights the Vietnam-refinery-style fragility of non-Chinese capacity heavily and assumes the 2026 commissioning wave will disappoint. The "chokepoint erodes gradually" scenario, which the actual procurement-diversification capex supports, implies a lower steady-state premium. The claim is: the premium is priced closer to the high-durability end of the monopoly-erosion spread, with limited credit for the parallel national tracks the US, Australia, and Japan have actively funded.
...
|-------|-------------|---------------|
| Mining | ~70% | [[Australia]], Myanmar, US |
| Processing | ~90% | Minimal alternatives |
| Magnet production | ~90% | [[Japan]] (small) |
...
**Deng Xiaoping (1992):** "The Middle East has oil, [[China]] has rare earths."

The processing bottleneck is the real chokepoint. Even ore mined elsewhere often goes to [[China]] for refining.

---

## Myanmar: The hidden chokepoint

**Myanmar = 3rd largest rare earth source, critical for heavy REEs:**
...
- Rebel group captured Pangwa (major mining area) **Oct 2024**
- Now controls **nearly all** Myanmar rare earth mines
- No capacity to process — must ship to [[China]]
- [[China]] closed border after capture → imports dropped **90%**
- Rebounded **April 2025** (~5,000 tons) — suggests [[China]]-KIA deal

**Supply chain exposure (Global Witness):**
- [[Ford]], [[Hyundai]], [[Siemens]], [[Tesla]], Vestas, VW all linked to Myanmar rare earth supply chains
- Only [[Siemens]] responded with due diligence claims
...
**Nabeel Mancheri (ex-Global Rare Earth Industry Association):** Chinese magnet manufacturers "always say, 'No, we are not using any heavy rare earths coming from Myanmar.' That is a lie and cannot be possible. You don't have any other option."

**Implication:** Even if US builds domestic light REE capacity (MP Materials), heavy REEs (Dy, Tb) flow through Myanmar → [[China]]. No alternative path exists.

---

## Key elements

| Element | Use case | [[China]] control |
|---------|----------|---------------|
| Neodymium | EV motors, wind turbines | ~90% |
| [[Dysprosium]] | High-temp magnets | ~99% |
| [[Terbium]] | Solid-state devices | ~90% |
| [[Gallium]] | [[Semiconductors]], [[5G]] | ~98% |
| [[Germanium]] | Fiber optics, IR | ~60% |
...
[[China]] cut rare earth exports to [[Japan]] during Senkaku Islands dispute:
- Prices spiked 10x
- [[Japan]] scrambled for alternatives
- Triggered long-term diversification efforts

### [[Gallium]]/germanium controls (2023)

In response to [[Export controls]] on semiconductors:
- Export licenses required for gallium, germanium
...
| **June 2025** | Framework agreement — [[China]] said would "review and approve eligible export applications" |
| Oct 2025 | First Chinese use of FDPR — **0.1% threshold**: products overseas need [[China]] approval if ≥0.1% value from controlled REEs |
...
**[[Ford]] Chicago shutdown (May 2025):** [[Ford]] closed Chicago plant for several days — couldn't get rare earth magnets for electric motors. First major US production disruption from REE controls.

**[[EU]] impact:** European firms reported several production stoppages from rare earth constraints.
...
### Asymmetric power
- West needs rare earths for clean energy transition
- EVs, wind turbines, defense systems all depend on them
- **F-35 requires 900 lbs rare earths** per aircraft
- No short-term substitutes

### Time advantage
- Western mines take 10-15 years to develop
- Processing capacity takes even longer
- [[China]] can impose costs faster than West can adapt

### Escalation risk
- Full embargo would be economic warfare
- But partial restrictions create uncertainty
- Market anticipates and front-runs
...
## Trump administration response (2025-2026)

**Early 2025 actions:**

| Date | Action |
|------|--------|
| **March 2025** | Executive order — wartime emergency powers for critical minerals |
| **April 2025** | Commerce probe launched (270 days to report) |
| **April 2025** | Ukraine critical minerals deal signed |

**National security proclamation (Jan 15, 2026):**

| Policy | Detail |
|--------|--------|
| **Minimum price guarantees** | Government floor prices for US producers |
| **Allied coordination** | Working with partners on alternative supply chains |
| **Supply chain directive** | Part of broader critical minerals push |

---

## US venture capital surge (2025)

**Record $628M invested in US rare earth startups:**

| Metric | Value |
|--------|-------|
| 2025 VC investment | **$628M** |
| Share of global | **90%** |
| vs 2024 | **+2,900%** |

*Source: PitchBook*

**Notable deals (not counting government):**
- [[MP Materials]] — $400M DoD equity (July 2025), $500M [[Apple]] deal
- [[Phoenix Tailings]] — $76M Series B (recycling, zero [[China]] reliance)
- [[Alta Resource Technologies]] — [[DCVC]]-backed (AI + biochemistry separation)

**Key investors:**

| Investor | Focus |
|----------|-------|
| [[DCVC]] | Backed 2 rare earth startups |
| [[Builders Vision]] | [[Phoenix Tailings]] backer (Lukas Walton) |
| [[Khosla Ventures]] | Passed — early stage, high valuations |

**Zachary Bogue ([[DCVC]]):** "Rare earths are top of mind right now. There's geopolitical tensions. The US can no longer rely on [[China]] for rare earths and critical minerals."

---

## Allied coordination (late 2025)

**Trump administration ally deals:**

| Partner | Deal | Timing |
|---------|------|--------|
| **[[Australia]]** | $1B initial + up to $8.5B total potential | Oct 2025 (Trump-PM meeting) |
| **Saudi Arabia** | Pentagon-financed processing site | Nov 2025 |

**Gracelin Baskaran (CSIS):** "It's clear we can't go it alone. The only way to do this is by leaning on our allies."

**Reality:** US geological endowment insufficient — must partner with allies for heavy REEs.

**James Lindsay ([[Builders Vision]]):** Compared to US oil/gas 2005→2015 transformation — "a 15-year cycle has been done before."
...
|---------|-------|--------|
| [[MP Materials]] | Mining, magnets | Only US mine at scale |
| [[Phoenix Tailings]] | Recycling | NH refinery (200 tons/yr), zero [[China]] inputs |
| [[Alta Resource Technologies]] | AI-assisted separation | Targeting cost-competitive by 2027 |

**[[Phoenix Tailings]]:** Producing terbium and dysprosium metals for defense — heavy REEs that US has no other domestic capacity for.
...
- Non-[[China]] rare earth miners
- Processing technology companies
- Recycling and urban mining
- Magnet alternatives research
