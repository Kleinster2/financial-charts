---
aliases: [West Texas Intermediate, WTI crude, NYMEX WTI, CL futures]
...
| Typical spread vs [[Brent crude]] | $2-5 discount |

---

## Why WTI matters politically

[[Robin J. Brooks]] (March 23, 2026) identified WTI — not [[Brent crude|Brent]] or [[Dubai crude|Dubai]] — as the price to watch during the Iran conflict. Reason: US gasoline prices track WTI, not international benchmarks. [[Iran]]'s strategy is to spike oil high enough to erode American domestic support for the war. US energy independence (largest producer at ~13M bpd, net exporter) insulates WTI from Gulf disruptions more than any other benchmark.

As of March 21: WTI +46% since hostilities began — significantly less than Brent (+64%) and Dubai (+123%). US gasoline +32%, still below $4/gallon, well below the $5 peak in 2022. This gap is the US energy independence dividend.
...
| Date | Level | Move |
|------|-------|------|
| Pre-conflict (~Feb 27) | ~$65/bbl | — |
| Mar 6 | >$90/bbl | +31% on week |
