...
Returnees receive significant support:
...
**The pitch:** "Come back, we'll fund your research, you'll be a star."
...
**Controversy:**
- Some prosecutions were overreach (racial profiling concerns)
- Chilling effect on legitimate collaboration
- Program went "underground" — renamed, less visible

---

## Current status

The program officially "doesn't exist" anymore:
...
- [[China university-AI pipeline]] — context (returnee integration)
- [[Kai-Fu Lee]] — example (prominent returnee)
- [[China AI Tigers]] — output (returnee-founded companies)
- [[Export controls]] — context (US response)
- [[Sovereign AI race]] — context (talent competition)
