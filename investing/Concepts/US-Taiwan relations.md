#concept #geopolitics #usa #taiwan

**US-Taiwan relations** — Unofficial but substantive. The US does not formally recognize Taiwan but maintains deep economic, defense, and political ties under the Taiwan Relations Act framework.
...
Passed after US switched recognition to PRC. Key provisions:
...
Reagan's private commitments to Taiwan:

1. No date for ending arms sales
2. No consultation with PRC on arms sales
3. No mediation between Taipei and Beijing
4. No revision of TRA
5. No change in sovereignty position
...
| Package | Year | Value | Key items |
|---------|------|-------|-----------|
| F-16V upgrade | 2019 | $8B | 66 fighters |
| Harpoon missiles | 2020 | $2.4B | 400 coastal defense |
| HIMARS | 2020 | $436M | 11 systems |
...
| Activity | Status |
|----------|--------|
| US troops in Taiwan | Small number (~30), training role |
| Joint exercises | Informal, unannounced |
| National Guard partnerships | Michigan, Hawaii |
| Officer exchanges | Ongoing |
...
See [[TSMC Arizona expansion]] for details.

### Investment

| Direction | Flow |
|-----------|------|
| Taiwan → US | TSMC Arizona, manufacturing |
| US → Taiwan | Tech, services |
| FDI stock | ~$20B each direction |
...
| Aspect | Detail |
|--------|--------|
| Function | De facto embassy |
| Status | Private nonprofit (legally) |
| Staff | State Dept employees on "leave" |
| Headquarters | Taipei + DC |
| New compound | Opened 2019, $250M |

### Taiwan representation

| In US | Taipei Economic and Cultural Representative Office (TECRO) |
|-------|-----------------------------------------------------------|
| Status | No diplomatic privileges |
| Locations | DC + 12 other cities |
| Functions | Visas, trade, outreach |
...
| Position | Support |
|----------|---------|
| Oppose PRC use of force | Near-universal |
| Maintain TRA | Near-universal |
...
| Admin | Approach |
|-------|----------|
| Trump | More transactional, called Taiwan president |
| Biden | "Strategic clarity" statements, CHIPS coordination |
| Trump 2.0 | Unclear; tariff rhetoric, "pay for defense" |
...
| Element | Detail |
|---------|--------|
| Tariff rate | Cut to 15% on Taiwan goods |
| Chip investment | $500B total commitment |
| → Direct investment | $250B from Taiwan chip/tech companies |
| → Credit guarantees | $250B from Taiwan government |
| TSMC expansion | Bought land adjacent to Arizona site |

Commerce Secretary Lutnick: TSMC "just bought hundreds of acres adjacent to their property."
...
### Context
- [[US-China relations]] — broader framework
- [[US-China security]] — Taiwan as flashpoint
- [[Taiwan concentration risk]] — why Taiwan matters

### Actors
- [[Taiwan]] — country actor
- [[TSMC]] — semiconductor linchpin
- [[US Government]] — policy maker

### Key concepts
- [[CHIPS Act]] — reshoring driver
- [[TSMC Arizona expansion]] — de-risking investment
- [[Export controls]] — aligned policy

### Events
- [[TSMC Arizona expansion]] — $40B investment
