...
- `audit_note_taxonomy.py` - Flag source-person notes tagged analyst/strategist/commentator that still live in `investing/Actors/` instead of `investing/Analysts/`, plus stale actor markers inside `Analysts/`
